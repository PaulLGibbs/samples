...
var s = class {
  constructor(t2, i4, s2, h3, e3, r4, c2, a4, n3, p3) {
    this.graphic = t2, this.allGraphics = i4, this.index = s2, this.x = h3, this.y = e3, this.dx = r4, this.dy = c2, this.totalDx = a4, this.totalDy = n3, this.viewEvent = p3, this.defaultPrevented = false, this.type = "graphic-move-start";
  }
  preventDefault() {
...
var h2 = class {
  constructor(t2, i4, s2, h3, e3, r4, c2, a4, n3, p3) {
    this.graphic = t2, this.allGraphics = i4, this.index = s2, this.x = h3, this.y = e3, this.dx = r4, this.dy = c2, this.totalDx = a4, this.totalDy = n3, this.viewEvent = p3, this.defaultPrevented = false, this.type = "graphic-move";
  }
  preventDefault() {
    this.defaultPrevented = true;
  }
...
var e2 = class {
  constructor(t2, i4, s2, h3, e3, r4, c2, a4, n3, p3) {
    this.graphic = t2, this.allGraphics = i4, this.index = s2, this.x = h3, this.y = e3, this.dx = r4, this.dy = c2, this.totalDx = a4, this.totalDy = n3, this.viewEvent = p3, this.defaultPrevented = false, this.type = "graphic-move-stop";
  }
  preventDefault() {
    this.defaultPrevented = true;
  }
...
var E = class extends i.EventedAccessor {
  ...
  _clickHandler(i4) {
    const t2 = this._findTargetGraphic(n(i4));
    if (t2) {
  ...
  _pointerDownHandler(i4) {
    ...
    if (t2) {
      ...
      const { x: e3, y: s2 } = i4, r4 = new a3(t2, this.graphics.indexOf(t2), e3, s2, i4);
  ...
  _pointerUpHandler(i4) {
    if (this._activeGraphic) {
      const { x: t2, y: e3 } = i4, s2 = this.graphics.indexOf(this._activeGraphic), r4 = new n2(this._activeGraphic, s2, t2, e3, i4);
  ...
  _pointerMoveHandler(i4) {
    ...
    if (t2) {
      ...
      if (this._hoverGraphic) {
        ...
        const r5 = this.graphics.indexOf(this._hoverGraphic), h4 = new c(this.graphics[r5], r5, e3, s2, i4);
    ...
    if (this._hoverGraphic) {
      const { x: t3, y: e3 } = i4, s2 = this.graphics.indexOf(this._hoverGraphic), r4 = new c(this.graphics[s2], s2, t3, e3, i4);
  ...
  _dragHandler(i4) {
    ...
    const { action: t2, x: s2, y: r4 } = i4, h3 = this.graphics.indexOf(this._activeGraphic), o = this._dragEvent ? s2 - this._dragEvent.x : 0, a4 = this._dragEvent ? r4 - this._dragEvent.y : 0, c2 = s2 - i4.origin.x, n3 = r4 - i4.origin.y, l = "start" === t2 ? this._activeGraphic.geometry : this._initialDragGeometry, d3 = i2(l, c2, n3, this.view);
    if (this._activeGraphic.geometry = d3, this.enableMoveAllGraphics && this.graphics.forEach((i5) => {
      i5 !== this._activeGraphic && (i5.geometry = i2(i5.geometry, o, a4, this.view));
    }), this._dragEvent = i4, "start" === t2) {
      this._initialDragGeometry = a(l);
      const t3 = new s(this._activeGraphic, this.graphics, h3, s2, r4, o, a4, c2, n3, i4);
      ...
      const t3 = new h2(this._activeGraphic, this.graphics, h3, s2, r4, o, a4, c2, n3, i4);
      ...
      const t3 = new e2(this._activeGraphic, this.graphics, h3, s2, r4, o, a4, c2, n3, i4);
...
//# sourceMappingURL=chunk-AFLYCON2.js.map
