import {
  u
} from "./chunk-Z4U2OWSC.js";
import {
  c
} from "./chunk-CKFFKJJ3.js";
import {
  C
...
var k = v = class extends S.JSONSupportMixin(m2) {
  ...
  load(e) {
    const t = this.portal ?? (this.portal = C.getDefault()), i = t.load(e).then(() => this.sourceJSON ? this.sourceJSON : this.id && this.itemUrl ? t.request(this.itemUrl, { signal: null != e ? e.signal : null, query: { token: this.apiKey } }) : {}).then((e2) => {
      this.sourceJSON = e2, this.read(e2);
    });
    return this.addResolvingPromise(i), Promise.resolve(this);
  }
  async addRating(e) {
    const t = { method: "post", query: {} }, i = e instanceof c ? e.rating : e;
    return null == i || isNaN(i) || "number" != typeof e || (t.query.rating = i), this.portal ? (await this.portal.request(this.itemUrl + "/addRating", t), new c({ rating: i, created: /* @__PURE__ */ new Date() })) : null;
  }
  clone() {
  ...
  async copy(e) {
    ...
    await t.signIn();
    const { copyResources: o2, folder: s2, tags: a3, title: n2 } = e || {}, l2 = { method: "post", query: { copyPrivateResources: "all" === o2, folder: "string" == typeof s2 ? s2 : s2 == null ? void 0 : s2.id, includeResources: !!o2, tags: a3 == null ? void 0 : a3.join(","), title: n2 } }, { itemId: p } = await t.request(`${r2}/copy`, l2);
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-YPTW5OXR.js");
    return i(this, e, t);
  }
  async addResource(e, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-YPTW5OXR.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r2 } = await import("./resourceUtils-YPTW5OXR.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-YPTW5OXR.js");
    return t(this, e);
  }
  resourceFromPath(e) {
    return new u({ portalItem: this, path: e });
  }
  toJSON() {
    var _a, _b;
...
//# sourceMappingURL=chunk-TY42MOB7.js.map
