...
var styles = css`:host{display:block}:host(:focus){outline:2px solid transparent;outline-offset:2px}:host([hidden]){display:none}[hidden]{display:none}`;
...
@esri/calcite-components/dist/components/calcite-tree/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=calcite-tree-3E2YS4EB.js.map
