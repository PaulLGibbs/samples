...
import {
  ...
  nt,
  w as w2
} from "./chunk-QW5ASOGQ.js";
import {
  f as f4
} from "./chunk-76QFM6NC.js";
import {
  a as a5,
  r as r4
...
import {
  m as m4
} from "./chunk-LEDABT7T.js";
import {
  b
} from "./chunk-AHTGTURI.js";
import {
  e as e3,
  r as r3
} from "./chunk-ANTOHX4N.js";
import {
  c as c5
} from "./chunk-DPBBU4V6.js";
import {
  e as e2
...
function o4(e5, r5) {
  return e5.isGeographic || e5.isWebMercator && (r5 ?? true);
}
function t4(o5, t5, i2, a7) {
  if (void 0 !== a7) {
    p(o5(), "option: geographic", { replacement: "Use mesh `vertexSpace` and spatial reference to control how operations are performed instead.", version: "4.30", warnOnce: true });
    const c9 = "local" === t5.type;
    if (!t2(t5) || a7 === c9) return i2.isGeographic || i2.isWebMercator && a7;
    o5().warnOnce(`Specifying the 'geographic' parameter (${a7}) for a Mesh vertex space of type "${t5.type}" is not supported. This parameter will be ignored.`);
  }
  switch (t5.type) {
    case "georeferenced":
...
function u5(e5, t5, r5) {
  ...
  const { vertexSpace: i2 } = e5, o5 = (r5 == null ? void 0 : r5.origin) ?? e5.origin, n7 = t4(g4, i2, o5.spatialReference, r5 == null ? void 0 : r5.geographic);
  t2(i2) ? x(e5, t5, o5) : n7 ? v2(e5, t5, o5) : R2(e5, t5, o5);
}
function x(e5, o5, s5) {
  const { vertexSpace: c9 } = e5;
  if (!t2(c9)) return;
  const f7 = h4, m8 = b2;
  if (!c5(o5, m8, e5.spatialReference)) return void F(g4(), o5.spatialReference, e5.spatialReference, O2);
  if (!c5(s5, f7, e5.spatialReference)) {
    const t5 = e5.origin;
...
function v2(e5, t5, r5) {
  const i2 = r2(r5.x, r5.y, r5.z ?? 0), n7 = B(e5, new a4({ origin: i2 }));
  if (!n7) return;
  const a7 = r2(t5.x, t5.y, t5.z ?? 0), f7 = B({ vertexAttributes: n7, spatialReference: e5.spatialReference, vertexSpace: new a4({ origin: a7 }) }, n5.absolute);
  if (!f7) return;
...
function R2(e5, t5, r5) {
  const i2 = h4, o5 = b2;
  if (c5(t5, o5, e5.spatialReference)) {
    if (!c5(r5, i2, e5.spatialReference)) {
      const t6 = e5.origin;
      return i2[0] = t6.x, i2[1] = t6.y, i2[2] = t6.z, void F(g4(), r5.spatialReference, e5.spatialReference, O2);
    }
    j4(e5.vertexAttributes.position, o5, i2), e5.vertexAttributesChanged();
  } else F(g4(), t5.spatialReference, e5.spatialReference, O2);
}
function j4(e5, t5, r5) {
  if (e5) for (let i2 = 0; i2 < e5.length; i2 += 3) for (let o5 = 0; o5 < 3; o5++) e5[i2 + o5] += t5[o5] - r5[o5];
}
var b2 = n3();
var h4 = n3();
var A2 = n3();
...
function l2(r5) {
  ...
  if (t2(l3) && r5.transform && r4(g7, g7, r5.transform.localMatrix), "georeferenced" === l3.type) {
    const r6 = l3.origin;
    return r6 && a5(g7, g7, r6), c2(m2(g7), f7);
  }
  const y3 = a3(f7), B3 = l3.origin;
  if (!L2(y3, f7)) {
    const [r6, t5, e5] = B3;
    return new w({ xmin: r6, ymin: t5, zmin: e5, xmax: r6, ymax: t5, zmax: e5, spatialReference: f7 });
  }
  return m4(f7, B3, x2, y3), r4(g7, g7, x2), o(g7, y3, 0, g7, f7, 0), c2(m2(g7), f7);
}
var x2 = e();
var u6 = t(24);
...
async function c7(e5, n7, r5) {
  const { source: o5 } = n7, { loadGLTFMesh: i2 } = await h(import("./loadGLTFMesh-XTFIJC47.js"), r5), l3 = await f5(o5, r5);
  s2(r5);
...
async function m6(e5, t5) {
  const { parts: n7, assetMimeType: r5, assetName: o5 } = e5;
  if (1 === n7.length) return new v3(n7[0].partUrl);
  const i2 = await e5.toBlob(t5);
  return s2(t5), v3.fromBlob(i2, x3(o5, r5));
}
function p5(e5) {
...
function j5(t5) {
  ...
  let n7 = null, r5 = null;
  for (const e5 of t5) {
    const { source: t6, name: o6 } = e5;
    n7 ?? (n7 = T(e5)), "ESRI3DO_NORM.glb" === o6 && (r5 = T(e5)), s5.set(o6, t6.url), t6.files.forEach((e6, t7) => s5.set(t7, e6));
  }
  const o5 = r5 ?? n7;
  if (null == o5) throw new s("mesh-load-external:missing-files", "Missing files to load external mesh source");
  return new v3(o5.url, () => t5.forEach(({ source: e5 }) => e5.dispose()), s5, o5.type);
}
var v3 = class _v {
  constructor(e5, t5 = () => {
...
var a6 = class extends a2 {
  ...
  set displaySource(e5) {
    ...
    this._explicitDisplaySource = e5, e5 && this.externalSources.every((r5) => !h3(r5, e5)) && this.externalSources.add(e5);
  }
  clearSources() {
    this.externalSources.removeAll();
  }
  getExternalSourcesOnService(e5) {
    return this.externalSources.items.filter((r5) => m5(r5, e5));
  }
...
function c8() {
  const { faceDescriptions: t5, faceVertexOffsets: e5, uvScales: r5 } = F2, n7 = 4 * t5.length, o5 = new Float64Array(3 * n7), s5 = new Float32Array(3 * n7), a7 = new Float32Array(2 * n7), i2 = new Uint32Array(2 * t5.length * 3);
  ...
  for (let h7 = 0; h7 < t5.length; h7++) {
    ...
    for (let t6 = 0; t6 < 4; t6++) {
      ...
      for (let t7 = 0; t7 < 3; t7++) 0 !== n8.axis[t7] ? (o5[l3++] = 0.5 * n8.axis[t7], s5[c9++] = n8.axis[t7]) : (o5[l3++] = 0.5 * e6[i3++], s5[c9++] = 0);
    }
  }
  return { position: o5, normal: s5, uv: a7, faces: i2 };
}
function f6(t5, e5) {
  const r5 = t5.components[0], n7 = r5.faces, s5 = b4[e5], a7 = 6 * s5, i2 = new Array(6), l3 = new Array(n7.length - 6);
  let c9 = 0, f7 = 0;
  for (let o5 = 0; o5 < n7.length; o5++) o5 >= a7 && o5 < a7 + 6 ? i2[c9++] = n7[o5] : l3[f7++] = n7[o5];
...
function u8(t5 = 0) {
  const e5 = Math.round(8 * 2 ** t5), r5 = 2 * e5, n7 = (e5 - 1) * (r5 + 1) + 2 * r5, o5 = new Float64Array(3 * n7), s5 = new Float32Array(3 * n7), a7 = new Float32Array(2 * n7), i2 = new Uint32Array(3 * ((e5 - 1) * r5 * 2));
  let l3 = 0, c9 = 0, f7 = 0, u9 = 0;
  for (let h7 = 0; h7 <= e5; h7++) {
    ...
    for (let v5 = 0; v5 <= w6; v5++) {
      ...
      for (let e6 = 0; e6 < 3; e6++) o5[l3] = 0.5 * O3[e6], s5[l3] = O3[e6], ++l3;
...
function h6(t5 = 0) {
  const e5 = 5, r5 = Math.round(16 * 2 ** t5), n7 = (e5 - 1) * (r5 + 1) + 2 * r5, o5 = new Float64Array(3 * n7), s5 = new Float32Array(3 * n7), a7 = new Float32Array(2 * n7), i2 = new Uint32Array(3 * (4 * r5));
  ...
  for (let p7 = 0; p7 <= e5; p7++) {
    ...
    for (let v5 = 0; v5 <= w6; v5++) {
      ...
      for (let t7 = 0; t7 < 3; t7++) o5[l3++] = O3[t7], s5[c9++] = n8 ? 2 === t7 ? p7 <= 1 ? 1 : -1 : 0 : 2 === t7 ? 0 : O3[t7] / A4;
...
function m7(t5) {
  const e5 = A3.facingAxisOrderSwap[t5], r5 = A3.position, n7 = A3.normal, o5 = new Float64Array(r5.length), s5 = new Float32Array(n7.length);
  let a7 = 0;
  for (let i2 = 0; i2 < 4; i2++) {
    const t6 = a7;
    for (let i3 = 0; i3 < 3; i3++) {
      const l3 = e5[i3], c9 = Math.abs(l3) - 1, f7 = l3 >= 0 ? 1 : -1;
      o5[a7] = r5[t6 + c9] * f7, s5[a7] = n7[t6 + c9] * f7, a7++;
    }
  }
  return { position: o5, normal: s5, uv: new Float32Array(A3.uv), faces: new Uint32Array(A3.faces), isPlane: true };
}
var w5 = 1;
var v4 = 2;
var g6 = 3;
...
function B2(t5, e5, r5) {
  ...
  const { spatialReference: o5, vertexSpace: i2 } = t5, n7 = (r5 == null ? void 0 : r5.origin) ?? t5.origin, s5 = r5 == null ? void 0 : r5.geographic, a7 = t4(O4, i2, o5, s5);
  c6(t5) ? G3(t5, e5, n7) : a7 ? H(t5, e5, n7) : I2(t5, e5, n7);
}
function G3(t5, e5, r5) {
  ...
  else if (!k(d5, r5, t5)) return void F(O4(), r5.spatialReference, f7, O2);
  b(Z, w3(e5), z2(e5));
  const y3 = D(N3, Z, _, s3, d5), { localMatrix: T3 } = c9, U = c3(N3, y3, T3);
  c9.scale = O(n3(), U), f2(U, U, z(K, c9.scale));
  const z4 = c9.rotationAxis;
  c9.rotation = k2(U), 0 === c9.rotationAngle && (c9.rotationAxis = z4), c9.translation = I(n3(), U);
}
function H(t5, r5, o5) {
  const i2 = t5.spatialReference, n7 = a3(i2), s5 = Y;
  if (!c5(o5, s5, n7) && (F(O4(), o5.spatialReference, n7, "Falling back to mesh origin"), !c5(t5.origin, s5, n7))) return void F(O4(), t5.origin.spatialReference, n7);
  ...
  m4(n7, s5, W, n7), n4(X, W);
  const u9 = Q;
  N(w3(Q), w3(r5), X), u9[3] = r5[3], g3(a7, i2, m8, n7) && (null == l3 || null == f7 || E2(l3, a7, i2, m8, n7, f7)) && (null == c9 || null == p7 || w2(c9, a7, i2, m8, n7, p7)) ? (J(m8, u9, 3, s5), h2(m8, n7, a7, i2) && (null == l3 || null == f7 || (J(f7, u9, 3), R(f7, a7, i2, m8, n7, l3))) && (null == c9 || null == p7 || (J(p7, u9, 4), G2(p7, a7, i2, m8, n7, c9))) ? t5.vertexAttributesChanged() : F(O4(), n7, i2)) : F(O4(), i2, n7);
}
function I2(t5, e5, r5) {
  const o5 = Y;
  if (!c5(r5, o5, t5.spatialReference)) {
    const e6 = t5.origin;
    return o5[0] = e6.x, o5[1] = e6.y, o5[2] = e6.z, void F(O4(), r5.spatialReference, t5.spatialReference, O2);
  }
  J(t5.vertexAttributes.position, e5, 3, o5), J(t5.vertexAttributes.normal, e5, 3), J(t5.vertexAttributes.tangent, e5, 4), t5.vertexAttributesChanged();
}
function J(t5, e5, r5, o5 = _) {
  if (null != t5) {
    p3(W, z2(e5), w3(e5));
    for (let e6 = 0; e6 < t5.length; e6 += r5) {
      for (let r6 = 0; r6 < 3; r6++) K[r6] = t5[e6 + r6] - o5[r6];
      E(K, K, W);
      for (let r6 = 0; r6 < 3; r6++) t5[e6 + r6] = K[r6] + o5[r6];
    }
  }
}
var K = n3();
...
function q(e5, t5, r5) {
  var _a;
  if (!((_a = e5.vertexAttributes) == null ? void 0 : _a.position)) return;
  const { vertexSpace: o5, spatialReference: i2 } = e5, n7 = (r5 == null ? void 0 : r5.origin) ?? e5.origin, s5 = r5 == null ? void 0 : r5.geographic, a7 = t4(k3, o5, i2, s5);
  c6(e5) ? z3(e5, t5, n7) : a7 ? L3(e5, t5, n7) : M2(e5, t5, n7);
}
function z3(e5, s5, f7) {
  ...
  x5.rotation = k2(z4), 0 === x5.rotationAngle && (x5.rotationAxis = L4), x5.translation = I(n3(), z4);
}
function L3(e5, t5, r5) {
  const o5 = e5.spatialReference, i2 = a3(o5), n7 = E3;
  if (!c5(r5, n7, i2) && (F(k3(), r5.spatialReference, i2, "Falling back to mesh origin"), !c5(e5.origin, n7, i2))) return void F(k3(), e5.origin.spatialReference, i2);
  ...
  g3(s5, o5, c9, i2) && (null == a7 || null == f7 || E2(a7, s5, o5, c9, i2, f7)) && (null == l3 || null == m8 || w2(l3, s5, o5, c9, i2, m8)) ? (P(c9, t5, n7), h2(c9, i2, s5, o5) && (null == a7 || null == f7 || R(f7, s5, o5, c9, i2, a7)) && (null == l3 || null == m8 || G2(m8, s5, o5, c9, i2, l3)) ? e5.vertexAttributesChanged() : F(k3(), i2, o5)) : F(k3(), o5, i2);
}
function M2(e5, t5, r5) {
  const o5 = E3;
  if (!c5(r5, o5, e5.spatialReference)) {
    const t6 = e5.origin;
    return o5[0] = t6.x, o5[1] = t6.y, o5[2] = t6.z, void F(k3(), r5.spatialReference, e5.spatialReference, O2);
  }
  P(e5.vertexAttributes.position, t5, o5), e5.vertexAttributesChanged();
}
function P(e5, t5, r5 = _) {
  if (e5) for (let o5 = 0; o5 < e5.length; o5 += 3) {
    for (let t6 = 0; t6 < 3; t6++) T2[t6] = e5[o5 + t6] - r5[t6];
    g2(T2, T2, t5);
    for (let t6 = 0; t6 < 3; t6++) e5[o5 + t6] = T2[t6] + r5[t6];
  }
}
var T2 = n3();
var V2 = n3();
...
var J2 = { base: null, key: "type", defaultKeyValue: "georeferenced", typeMap: { georeferenced: n5, local: a4 } };
var Q2 = H2 = class extends m3.LoadableMixin(p2.EsriPromiseMixin(n2)) {
  constructor(e5) {
    super(e5), this.components = null, this.vertexSpace = new n5(), this.transform = null, this.metadata = new a6(), this.hasZ = true, this.hasM = false, this.vertexAttributes = new p4(), this.type = "mesh";
  }
  initialize() {
  ...
  rotate(e5, t5, r5, o5) {
    return d2(e5, t5, r5, X2), B2(this, X2, o5), this;
  }
  offset(e5, t5, r5) {
    if (!this._checkIfLoaded("offset()")) return this;
    const { vertexSpace: o5, vertexAttributes: s5 } = this, n7 = s5 == null ? void 0 : s5.position;
    if (!n7) return this;
    if (t2(o5)) {
      const [s6, n8, i2] = o5.origin;
      o5.origin = r2(s6 + e5, n8 + t5, i2 + r5);
    } else {
      for (let o6 = 0; o6 < n7.length; o6 += 3) n7[o6] += e5, n7[o6 + 1] += t5, n7[o6 + 2] += r5;
  ...
  cloneAndModifyVertexAttributes(e5, t5, r5) {
    ...
    if (this.components) {
      ...
      o5 = this.components.map((r6) => r6.cloneWithDeduplication(e6, t6));
    }
    const s5 = { components: o5, spatialReference: this.spatialReference, vertexAttributes: e5, vertexSpace: t5, transform: ((_a = this.transform) == null ? void 0 : _a.clone()) ?? null, metadata: (r5 == null ? void 0 : r5.preserveMetadata) ? this.metadata.clone() : new a6() };
    return new H2(s5);
  }
  cloneShallow() {
  ...
  async toBinaryGLTF(e5) {
    const [{ toBinaryGLTF: t5 }] = await Promise.all([import("./gltfexport-GEESKLV4.js"), this.load(e5)]);
  ...
  static createPlane(e5, t5) {
    ...
    const r5 = (t5 == null ? void 0 : t5.facing) ?? "up", o5 = p6(r5, t5 == null ? void 0 : t5.size);
    return new H2(x4(m7(r5), e5, { ...t5, size: o5 }));
  }
  static createFromPolygon(e5, t5) {
    if (!(e5 instanceof j2)) return q2().error(".createFromPolygon()", n6), null;
    const r5 = f4(e5);
    return new H2({ vertexAttributes: new p4({ position: r5.position }), components: [new f3({ faces: r5.faces, shading: "flat", material: (t5 == null ? void 0 : t5.material) ?? null })], spatialReference: e5.spatialReference, vertexSpace: new n5() });
  }
  static async createFromGLTF(e5, t5, r5) {
    ...
    const { loadGLTFMesh: o5 } = await h(import("./loadGLTFMesh-XTFIJC47.js"), r5);
    return new H2(await o5(e5, t5, r5));
  }
  static createWithExternalSource(e5, t5, r5) {
    var _a;
    const o5 = (r5 == null ? void 0 : r5.extent) ?? null, { spatialReference: s5 } = e5, n7 = ((_a = r5 == null ? void 0 : r5.transform) == null ? void 0 : _a.clone()) ?? new N2(), i2 = l(e5, r5), a7 = r5 == null ? void 0 : r5.unitConversionDisabled, c9 = { source: t5, extent: o5, unitConversionDisabled: a7 }, p7 = new a6();
  ...
  static createIncomplete(e5, r5) {
    var _a;
    const { spatialReference: o5 } = e5, s5 = ((_a = r5 == null ? void 0 : r5.transform) == null ? void 0 : _a.clone()) ?? new N2(), n7 = l(e5, r5), i2 = new H2({ transform: s5, vertexSpace: n7, spatialReference: o5 });
...
//# sourceMappingURL=chunk-MP44T6V6.js.map
