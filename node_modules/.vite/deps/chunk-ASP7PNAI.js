...
var L = { setAppUrl: (t3) => U = t3, setAppBaseUrl: (t3) => q = t3, restoreUrls: () => {
  U = O, q = R;
} };
function I(t3) {
  if (!t3) return null;
...
function W(t3, n3) {
  ...
  t3 = N(t3), n3 = N(n3);
  const e2 = s3(t3), r2 = s3(n3);
  return null != e2 && null != r2 && e2.portalHostname === r2.portalHostname;
}
function J(t3, n3) {
...
function at(t3, n3) {
  ...
  if (!("download" in e2)) return false;
...
function gt(t3) {
  return pt(t3) ? `http:${t3}` : t3.replace(h, "http:");
}
function $t(t3) {
...
//# sourceMappingURL=chunk-ASP7PNAI.js.map
