...
var l = class extends t2 {
  constructor(e, t3, i, s3, n2) {
    super(e, t3, i), this._sceneVelocity = s3, this.direction = n2;
  }
  value(e) {
...
var c = class {
  constructor(e = 300, t3 = 12, i = 0.84) {
    this._minimumInitialVelocity = e, this._stopVelocity = t3, this._friction = i, this.enabled = true, this._time = new t(0.6), this._screen = [new t(0.4), new t(0.4)], this._scene = [new t(0.6), new t(0.6), new t(0.6)], this._tmpDirection = n();
  }
  add(e, t3, i) {
    if (this.enabled) {
      ...
      this._screen[0].update(e[0]), this._screen[1].update(e[1]), this._scene[0].update(t3[0]), this._scene[1].update(t3[1]), this._scene[2].update(t3[2]), this._time.update(i);
    }
  }
  reset() {
  ...
  evaluateMomentum() {
    ...
    const e = this._screen[0].filteredDelta, t3 = this._screen[1].filteredDelta, i = null == e || null == t3 ? 0 : Math.sqrt(e * e + t3 * t3), s3 = this._time.filteredDelta, n2 = null == s3 || null == i ? 0 : i / s3;
...
var s = class {
  constructor(t3 = 2.5, i = 0.01, s3 = 0.95, l2 = 12) {
    this._minimumInitialVelocity = t3, this._stopVelocity = i, this._friction = s3, this._maxVelocity = l2, this.enabled = true, this.value = new t(0.8), this.time = new t(0.3);
  }
  add(t3, e) {
...
//# sourceMappingURL=chunk-OQTNYA2F.js.map
