...
function a() {
  ...
  return c2.uniforms.add(new s2("highlightTexture", (e2) => e2.highlightTexture), new s2("highlightOptionsTexture", (e2) => e2.highlightOptionsTexture), new s("pixelRatio", (e2) => e2.pixelRatio), new s("occludedIntensityFactor", (e2) => e2.occludedFactor), new e("maxHighlightLevel", (e2) => e2.highlights.length - 1)), c2.constants.add("pixelSampleScale", "float", 1), a2.include(l), c2.code.add(n`const float pascal17[9] = float[9](12870.0, 11440.0, 8008.0, 4368.0, 1820.0, 560.0, 120.0, 16.0, 1.0);
...
//# sourceMappingURL=chunk-UFY2JO3L.js.map
