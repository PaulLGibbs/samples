...
import {
  ...
  w,
  y
} from "./chunk-27ISRESK.js";
import {
  l
} from "./chunk-7FMDFQ4Q.js";
import {
  s
} from "./chunk-V67AJJBP.js";
import {
  Bt,
  Ee,
  Fe,
...
function se2(e2, t) {
  var i2 = C(true), s2 = null, a2 = ee, o4 = null, n = S(r2);
  function r2(r3) {
    var l2, h, d, c = (r3 = J2(r3)).length, u = false;
    for (null == s2 && (o4 = a2(d = n())), l2 = 0; l2 <= c; ++l2) !(l2 < c && i2(h = r3[l2], l2, r3)) === u && ((u = !u) ? o4.lineStart() : o4.lineEnd()), u && o4.point(+e2(h, l2, r3), +t(h, l2, r3));
...
function ae2(e2, t, i2) {
  var s2 = null, a2 = C(true), o4 = null, n = ee, r2 = null, l2 = S(h);
  function h(h2) {
    var d2, c, u, g2, p, m = (h2 = J2(h2)).length, _3 = false, b = new Array(m), x = new Array(m);
    for (null == o4 && (r2 = n(p = l2())), d2 = 0; d2 <= m; ++d2) {
      if (!(d2 < m && a2(g2 = h2[d2], d2, h2)) === _3) if (_3 = !_3) c = d2, r2.areaStart(), r2.lineStart();
      else {
        for (r2.lineEnd(), r2.lineStart(), u = d2 - 1; u >= c; --u) r2.point(b[u], x[u]);
        r2.lineEnd(), r2.areaEnd();
      }
      _3 && (b[d2] = +e2(g2, d2, h2), x[d2] = +t(g2, d2, h2), r2.point(s2 ? +s2(g2, d2, h2) : b[d2], i2 ? +i2(g2, d2, h2) : x[d2]));
    }
    if (p) return r2 = null, p + "" || null;
  }
  function d() {
    return se2().defined(a2).curve(n).context(o4);
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? te : C(+e2), t = "function" == typeof t ? t : C(void 0 === t ? 0 : +t), i2 = "function" == typeof i2 ? i2 : void 0 === i2 ? ie : C(+i2), h.x = function(t2) {
    ...
    return arguments.length ? (n = e3, null != o4 && (r2 = n(o4)), h) : n;
  }, h.context = function(e3) {
    return arguments.length ? (null == e3 ? o4 = r2 = null : r2 = n(o4 = e3), h) : o4;
  }, h;
}
...
var oe = class extends hi {
  setupDefaultRules() {
    ...
    d("CategoryDateAxis").setAll({ markUnitChange: true, gridIntervals: j(c), dateFormats: W(u), periodChangeDateFormats: W(g2) }), d("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: true, startLocation: 0, endLocation: 1, markUnitChange: true, groupData: false, groupCount: 500, gridIntervals: j(c), dateFormats: W(u), periodChangeDateFormats: W(g2), tooltipDateFormats: p, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (e3) => {
      ...
      if (t) {
        const i2 = e3.component, s2 = e3.get("value"), a2 = e3.get("endValue"), o4 = i2.intervalDuration(), n = i2.getPrivate("baseInterval"), r2 = i2.getPrivate("gridInterval", n);
...
var ne = class extends V {
  ...
  handleWheel(e2) {
    ...
    o4 = true;
    const n = s2.toLocal(e2.point), r2 = this.get("wheelStep", 0.2), l2 = a2.deltaY / 100, h = a2.deltaX / 100, d = this.get("wheelZoomPositionX"), c = this.get("wheelZoomPositionY");
    "zoomX" !== t && "zoomXY" !== t || 0 == h || this.xAxes.each((e3) => {
      if (e3.get("zoomX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a3 = e3.fixPosition(n.x / s2.width());
        null != d && (a3 = d);
      ...
      if (e3.get("zoomY")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a3 = e3.fixPosition(n.y / s2.height());
        null != c && (a3 = c);
      ...
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * r2 * (i3 - t2) * h, a3 = t2 + s3, n2 = i3 + s3, l3 = this._fixWheel(a3, n2);
        a3 = l3[0], n2 = l3[1], a3 == t2 && n2 == i3 && (o4 = false), this._handleWheelAnimation(e3.zoom(a3, n2));
      }
    }), "panX" !== i2 && "panXY" !== i2 || 0 == l2 || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * r2 * (i3 - t2) * l2, a3 = t2 + s3, n2 = i3 + s3, h2 = this._fixWheel(a3, n2);
        a3 = h2[0], n2 = h2[1], a3 == t2 && n2 == i3 && (o4 = false), this._handleWheelAnimation(e3.zoom(a3, n2));
      }
    ...
    if (i2) {
      ...
      if (a2) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.xAxes.each((e4) => {
          if (e4.get("panX")) {
            e4._isPanning = true;
            let a3 = e4._panStart, o5 = e4._panEnd, n = (o5 - a3) * (i2.x - s2.x) / t.width();
            e4.get("renderer").get("inversed") && (n *= -1);
            let r2 = a3 + n, l2 = o5 + n;
      ...
      if (o4) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.yAxes.each((e4) => {
          if (e4.get("panY")) {
            e4._isPanning = true;
            let a3 = e4._panStart, o5 = e4._panEnd, n = (o5 - a3) * (i2.y - s2.y) / t.height();
            e4.get("renderer").get("inversed") && (n *= -1);
            let r2 = a3 - n, l2 = o5 - n;
            l2 - r2 < 1 + 2 * e4.get("maxDeviation", 1) && (e4.set("start", r2), e4.set("end", l2));
          }
  ...
  _handlePinch() {
    ...
    if (U(e2._downPoints, (e3, a2) => {
      ...
      let o4 = i2[0], n = i2[1], r2 = s2[0], l2 = s2[1];
      if (o4 && n && r2 && l2) {
        if (r2 = e2.toLocal(r2), l2 = e2.toLocal(l2), o4 = e2.toLocal(o4), n = e2.toLocal(n), this.get("pinchZoomX")) {
          const e3 = this._downStartX, i3 = this._downEndX;
          if (null != e3 && null != i3) {
            o4.x > n.x && ([o4, n] = [n, o4], [r2, l2] = [l2, r2]);
            let s3 = e3 + o4.x / t2 * (i3 - e3), a3 = e3 + n.x / t2 * (i3 - e3), h = e3 + r2.x / t2 * (i3 - e3), d = e3 + l2.x / t2 * (i3 - e3), c = Math.max(1e-3, a3 - s3) / Math.max(1e-3, d - h), u = e3 * c + s3 - h * c, g2 = i3 * c + a3 - d * c;
            this.xAxes.each((e4) => {
        ...
        if (this.get("pinchZoomY")) {
          ...
          if (null != e3 && null != t3) {
            o4.y < n.y && ([o4, n] = [n, o4], [r2, l2] = [l2, r2]);
            let i3 = e3 + (1 - o4.y / a2) * (t3 - e3), s3 = e3 + (1 - n.y / a2) * (t3 - e3), h = e3 + (1 - r2.y / a2) * (t3 - e3), d = e3 + (1 - l2.y / a2) * (t3 - e3), c = Math.max(1e-3, s3 - i3) / Math.max(1e-3, d - h), u = e3 * c + i3 - h * c, g2 = t3 * c + s3 - d * c;
            this.yAxes.each((e4) => {
    ...
    if (e2) {
      ...
      if (e2._downPoint && (i2 = void 0), i2 && t) {
        ...
        if (P(a2, (e3) => {
          ...
          if (i3) {
            let a3 = 0;
            a3 = "x" == s2 || "x!" == s2 ? Math.abs(t.x - i3.x) : "y" == s2 || "y!" == s2 ? Math.abs(t.y - i3.y) : Math.hypot(t.x - i3.x, t.y - i3.y), a3 < n && (n = a3, o4 = e3);
          }
        }), P(i2, (e3) => {
  ...
  _handleScrollbar(e2, t, i2, s2) {
    e2.each((e3) => {
      let a2 = e3.fixPosition(t), o4 = e3.fixPosition(i2), n = e3.zoom(a2, o4, void 0, s2);
      const r2 = "updateScrollbar";
      e3.setPrivateRaw(r2, false), n ? n.events.on("stopped", () => {
  ...
  arrangeTooltips() {
    ...
    let n = e2._display.toGlobal({ x: 0, y: 0 }), r2 = e2._display.toGlobal({ x: t, y: i2 });
    const l2 = [];
    ...
    if (this.series.each((e3) => {
      ...
      if (t2 && !t2.get("forceHidden")) {
        ...
        if (s3) {
          ...
          this.inPlot(this._tooltipToLocal(s3)) && t2.dataItem ? i3 || (c += s3.y) : i3 = true, i3 || e3.isHidden() || e3.isHiding() ? t2.hide(0) : (t2.show(), l2.push(t2), _3.push(e3));
        }
      }
    }), this.setPrivate("tooltipSeries", _3), this.get("arrangeTooltips")) {
      const e3 = this._root.tooltipContainer, t2 = l2.length;
      if (c / t2 > i2 / 2 + n.y) {
        l2.sort((e4, t4) => Ee(t4.get("pointTo").y, e4.get("pointTo").y));
        let t3 = r2.y;
        if (P(l2, (i3) => {
          let s3 = i3.height(), a2 = i3.get("centerY");
          a2 instanceof e && (s3 *= a2.value), s3 += i3.get("marginBottom", 0), i3.set("bounds", { left: n.x, top: n.y, right: r2.x, bottom: t3 }), i3.setPrivate("customData", { left: n.x, top: n.y, right: r2.x, bottom: t3 }), t3 = Math.min(t3 - s3, i3._fy - s3), i3.parent == e3 && e3.children.moveValue(i3, 0);
        }), t3 < 0) {
          l2.reverse();
          let e4 = t3;
          P(l2, (i3) => {
            ...
            if (s3) {
              let a2 = s3.top - t3, o5 = s3.bottom - t3;
              a2 < e4 && (a2 = e4, o5 = a2 + i3.height()), i3.set("bounds", { left: s3.left, top: a2, right: s3.right, bottom: o5 }), e4 = s3.bottom - t3 + i3.get("marginBottom", 0);
            }
          });
        }
      } else {
        l2.reverse(), l2.sort((e4, t4) => Ee(e4.get("pointTo").y, t4.get("pointTo").y));
        let t3 = 0;
        if (P(l2, (i3) => {
          let a2 = i3.height(), o5 = i3.get("centerY");
          o5 instanceof e && (a2 *= o5.value), a2 += i3.get("marginBottom", 0), i3.set("bounds", { left: n.x, top: t3, right: r2.x, bottom: Math.max(n.y + s2, t3 + a2) }), i3.parent == e3 && e3.children.moveValue(i3, 0), t3 = Math.max(t3 + a2, i3._fy + a2);
        }), t3 > s2) {
          l2.reverse();
          let e4 = s2;
          P(l2, (i3) => {
            ...
            if (a2) {
              let o5 = a2.top - (s2 - t3), n2 = a2.bottom - (s2 - t3);
              n2 > e4 && (n2 = e4, o5 = n2 - i3.height()), i3.set("bounds", { left: a2.left, top: o5, right: a2.right, bottom: n2 }), e4 = n2 - i3.height() - i3.get("marginBottom", 0);
            }
          });
        }
      }
...
Object.defineProperty(ne, "className", { enumerable: true, configurable: true, writable: true, value: "XYChart" }), Object.defineProperty(ne, "classNames", { enumerable: true, configurable: true, writable: true, value: V.classNames.concat([ne.className]) });
...
var le = class extends ai {
  ...
  handleMove(e2, t, i2) {
    ...
    this._movePoint = e2;
    let o4 = this._display.toLocal(e2), n = this.chart;
    if (n && (this._inPlot(o4) || this._downPoint)) {
      if (n._movePoint = e2, this.isHidden()) {
        this.show();
      ...
      if (r2 = m.x, l2 = m.y, n.xAxes.each((e3) => {
      ...
      this._updateLines(r2, l2), n.arrangeTooltips();
...
var ce = class extends w {
  ...
  _makeFieldNames() {
    const e2 = this.get("xAxis"), t = this.get("yAxis"), i2 = e2.getPrivate("name"), s2 = Bt(i2), a2 = t.getPrivate("name"), o4 = Bt(a2), n = e2.get("renderer").getPrivate("letter"), r2 = t.get("renderer").getPrivate("letter"), l2 = "open", h = "low", d = "high", c = "Show";
    "ValueAxis" === e2.className ? (this._xField = this.get(i2 + n + c), this._xOpenField = this.get(l2 + s2 + n + c), this._xLowField = this.get(h + s2 + n + c), this._xHighField = this.get(d + s2 + n + c)) : (this._xField = i2 + n, this._xOpenField = l2 + s2 + n, this._xLowField = h + s2 + n, this._xHighField = d + s2 + n), "ValueAxis" === t.className ? (this._yField = this.get(a2 + r2 + c), this._yOpenField = this.get(l2 + o4 + r2 + c), this._yLowField = this.get(h + o4 + r2 + c), this._yHighField = this.get(d + o4 + r2 + c)) : (this._yField = a2 + r2, this._yOpenField = l2 + o4 + r2, this._yLowField = h + o4 + r2, this._yHighField = d + o4 + r2);
  }
  _fixVC() {
  ...
  _prepareChildren() {
    ...
    if (this.isDirty("stacked") && (o4 ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = true, o4 && this._stack(), P(this.dataItems, (i3) => {
      ...
      if (o5 > 0 && i2 && (i2.get("renderer").axisLength() / (a3 - s3) > o5 ? this._showBullets = true : this._showBullets = false), (this._psi != s3 || this._pei != a3 || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
        ...
        const o6 = this.get("vcx", 1), n = this.get("vcy", 1), r2 = this.get("stacked", false), l2 = this.getPrivate("outOfSelection");
        ...
        else for (let e3 = s3; e3 < a3; e3++) this.processYSelectionDataItem(this.dataItems[e3], n, r2);
  ...
  _stackDataItems() {
    ...
    let n = this._couldStackTo.length, r2 = 0;
    const l2 = this.get("stackToNegative");
    this._reallyStackedTo = {}, P(this.dataItems, (e3) => {
      for (let t2 = 0; t2 < n; t2++) {
        let i3 = this._couldStackTo[t2], n2 = i3.dataItems[r2], h = e3.get(s2);
        if (n2) {
          let t3 = n2.get(s2);
          if (l2) {
            if (!_(h)) break;
            if (_(t3)) {
              if (h >= 0 && t3 >= 0) {
                e3.setRaw(o4, n2), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
                break;
              }
              if (h < 0 && t3 < 0) {
                e3.setRaw(o4, n2), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
  ...
  _positionBullet(e2) {
    let t = e2.get("sprite");
    if (t) {
      let i2 = t.dataItem, s2 = e2.get("locationX", i2.get("locationX", 0.5)), a2 = e2.get("locationY", i2.get("locationY", 0.5)), o4 = this.get("xAxis"), n = this.get("yAxis"), r2 = o4.getDataItemPositionX(i2, this._xField, s2, this.get("vcx", 1)), l2 = n.getDataItemPositionY(i2, this._yField, a2, this.get("vcy", 1)), h = this.getPoint(r2, l2), d = i2.get("left", h.x), c = i2.get("right", h.x), u = i2.get("top", h.y), g2 = i2.get("bottom", h.y), p = 0, m = 0, _3 = c - d, b = g2 - u;
      if (this._shouldShowBullet(r2, l2)) {
        t.setPrivate("visible", !e2.getPrivate("hidden"));
        let o5 = e2.get("field");
        const n2 = this.get("baseAxis"), c2 = this.get("xAxis"), u2 = this.get("yAxis");
        if (null != o5) {
          let e3;
          n2 == c2 ? ("value" == o5 ? e3 = this._yField : "open" == o5 ? e3 = this._yOpenField : "high" == o5 ? e3 = this._yHighField : "low" == o5 && (e3 = this._yLowField), e3 && (l2 = u2.getDataItemPositionY(i2, e3, 0, this.get("vcy", 1)), h = u2.get("renderer").positionToPoint(l2), m = h.y, p = d + _3 * s2)) : ("value" == o5 ? e3 = this._xField : "open" == o5 ? e3 = this._xOpenField : "high" == o5 ? e3 = this._xHighField : "low" == o5 && (e3 = this._xLowField), e3 && (r2 = c2.getDataItemPositionX(i2, e3, 0, this.get("vcx", 1)), h = c2.get("renderer").positionToPoint(r2), p = h.x, m = g2 - b * a2));
        } else p = d + _3 * s2, m = g2 - b * a2;
        const x = e2.get("stacked");
        if (x) {
          const e3 = this.chart;
          if (n2 == c2) {
            ...
            if (i3) {
              ...
              m = s3.top, "down" == x ? m = s3.bottom - a3.top : "auto" == x ? e3 && (o6 < e3.plotContainer.height() / 2 ? m = s3.bottom - a3.top : m += a3.bottom) : m += a3.bottom;
            }
            ...
            if (i3) {
              ...
              p = s3.right, "down" == x ? p = s3.left - a3.right : "auto" == x ? e3 && (o6 < e3.plotContainer.width() / 2 ? p = s3.left - a3.right : p -= a3.left) : p -= a3.left;
            }
            this._bullets[r2 + "_" + l2] = t;
          }
        }
        t.isType("Label") && (t.setPrivate("maxWidth", Math.abs(_3)), t.setPrivate("maxHeight", Math.abs(b))), t.setAll({ x: p, y: m });
  ...
  hideDataItem(e2, t) {
    ...
    return o(this, void 0, void 0, function* () {
      ...
      const n = o4.get("stateAnimationEasing", this.get("stateAnimationEasing")), r2 = this.get("xAxis"), l2 = this.get("yAxis"), h = this.get("baseAxis"), d = this.get("stacked");
      if (h !== r2 && h || P(this._valueYFields, (i3) => {
        let o5 = l2.getPrivate("min"), r3 = l2.baseValue();
        _(o5) && o5 > r3 && (r3 = o5), d && (r3 = 0), null != e2.get(i3) && s2.push(e2.animate({ key: i3 + "Working", to: r3, duration: t, easing: n }).waitForStop());
      }), h === l2 || !h) {
        let i3 = r2.getPrivate("min"), o5 = r2.baseValue();
        _(i3) && i3 > o5 && (o5 = i3), d && (o5 = 0), P(this._valueXFields, (i4) => {
          null != e2.get(i4) && s2.push(e2.animate({ key: i4 + "Working", to: o5, duration: t, easing: n }).waitForStop());
        });
      }
      yield Promise.all(s2);
    });
  ...
  showDataItemTooltip(e2) {
    ...
    if (t) if (!this.isHidden() && this.get("visible")) {
      if (t._setDataItem(e2), e2) {
        ...
        const n = this.get("xAxis"), r2 = this.get("yAxis"), l2 = this.get("vcx", 1), h = this.get("vcy", 1), d = n.getDataItemPositionX(e2, this._tooltipFieldX, this._aLocationX0 + (this._aLocationX1 - this._aLocationX0) * a2, l2), c = r2.getDataItemPositionY(e2, this._tooltipFieldY, this._aLocationY0 + (this._aLocationY1 - this._aLocationY0) * o4, h), u = this.getPoint(d, c);
        let g2 = true;
...
var ue2 = class extends _2 {
  ...
  zoom(e2, t, i2, s2) {
    if (this.get("zoomable", true)) if (this._updateFinals(e2, t), this.get("start") !== e2 || this.get("end") != t) {
      let o4 = this._sAnimation, n = this._eAnimation, r2 = this.get("maxDeviation", 0.5) * Math.min(1, t - e2);
      ...
      if ((o4 && o4.playing && o4.to == e2 || this.get("start") == e2) && (n && n.playing && n.to == t || this.get("end") == t)) return;
      if (i2 > 0) {
  ...
  _createAssets(e2, t, i2) {
    ...
    if (l2) {
      ...
      i2 ? -1 == (null == a3 ? void 0 : a3.indexOf(r2)) && (o5 = true) : -1 != (null == a3 ? void 0 : a3.indexOf(r2)) && (o5 = true), o5 && (null === (s2 = l2.parent) || void 0 === s2 || s2.children.removeValue(l2), n.makeLabel(e2, t), l2.dispose(), n.labels.removeValue(l2));
    } else n.makeLabel(e2, t);
    const h = e2.get("grid");
    if (h) {
      let s3 = h.get("themeTags"), o5 = false;
      i2 ? -1 == (null == s3 ? void 0 : s3.indexOf(r2)) && (o5 = true) : -1 != (null == s3 ? void 0 : s3.indexOf(r2)) && (o5 = true), o5 && (null === (a2 = h.parent) || void 0 === a2 || a2.children.removeValue(h), n.makeGrid(e2, t), h.dispose(), n.grid.removeValue(h));
    } else n.makeGrid(e2, t);
    const d = e2.get("tick");
    if (d) {
      let s3 = false, a3 = d.get("themeTags");
      i2 ? -1 == (null == a3 ? void 0 : a3.indexOf(r2)) && (s3 = true) : -1 != (null == a3 ? void 0 : a3.indexOf(r2)) && (s3 = true), s3 && (null === (o4 = d.parent) || void 0 === o4 || o4.children.removeValue(d), n.makeTick(e2, t), d.dispose(), n.ticks.removeValue(d));
    } else n.makeTick(e2, t);
    i2 || e2.get("axisFill") || n.makeAxisFill(e2, t), this._processBullet(e2);
  }
  _processBullet(e2) {
...
var ge = class extends ue2 {
  ...
  _prepareAxisItems() {
    ...
    if (_(e2) && _(t)) {
      ...
      let n = s2 - i2, l2 = 1, h = e2;
      if (t2) {
        if (n = this._minLogAdjusted, n < s2) for (; n < s2; ) n += i2;
        h = n, h <= 0 && (h = 1, i2 < 1 && (h = _(this._minRealLog) ? this._minRealLog : Math.pow(10, -50))), l2 = Math.log(o4 - i2) * Math.LOG10E - Math.log(h) * Math.LOG10E, l2 > 2 && (n = Math.pow(10, Math.log(h) * Math.LOG10E - 50));
      }
      ...
      let _3 = i2 / m, x = 0, f = 0, v = -1 / 0;
      for (; n < o4; ) {
        let e3;
        this.dataItems.length < x + 1 ? (e3 = new g(this, void 0, {}), this._dataItems.push(e3), this.processDataItem(e3)) : e3 = this.dataItems[x], this._createAssets(e3, []), this._toggleDataItem(e3, true), e3.setRaw("value", n);
        const s3 = e3.get("label");
        s3 && s3.set("text", this._formatText(n)), this._prepareDataItem(e3);
        let a2 = n;
        if (t2 && l2 > 2 ? a2 = Math.pow(10, Math.log(h) * Math.LOG10E + x - 50) : a2 += i2, u) {
          let e4 = n + _3;
          if (t2) {
            if (l2 > 2) {
              _3 = this._adjustMinMax(n, a2, 10).step;
            }
            e4 = n + _3;
          }
          for (; e4 < a2 - 1e-11 * i2; ) {
            ...
            i3 && (c ? i3.set("text", this._formatText(e4)) : i3.setPrivate("visible", false)), this._prepareDataItem(t3), e4 += _3, f++;
          }
        }
        if (n = a2, v == n) break;
      ...
      for (let e3 = x; e3 < this.dataItems.length; e3++) this._toggleDataItem(this.dataItems[e3], false);
  ...
  _prepareDataItem(e2, t) {
    let i2 = this.get("renderer"), s2 = e2.get("value"), o4 = e2.get("endValue"), n = this.valueToPosition(s2), r2 = n, l2 = this.valueToPosition(s2 + this.getPrivate("step"));
    _(o4) && (r2 = this.valueToPosition(o4), l2 = r2), e2.get("isRange") && null == o4 && (l2 = n);
    let h = r2, d = e2.get("labelEndValue");
    null != d && (h = this.valueToPosition(d)), i2.updateLabel(e2.get("label"), n, h, t);
    const c = e2.get("grid");
    if (i2.updateGrid(c, n, r2), c && (s2 == this.get("baseValue", 0) ? (c.addTag("base"), c._applyThemes()) : c.hasTag("base") && (c.removeTag("base"), c._applyThemes())), i2.updateTick(e2.get("tick"), n, h, t), i2.updateFill(e2.get("axisFill"), n, l2), this._processBullet(e2), i2.updateBullet(e2.get("bullet"), n, r2), !e2.get("isRange")) {
          ...
          if (i2) for (let e3 = t; e3 < a2; e3++) {
            ...
            P(this.series, (i3) => {
              if (!i3.get("excludeFromTotal")) {
                let n = i3.dataItems[e3];
                if (n) {
                  let e4 = n.get(o4) * i3.get(s2);
                  o2(e4) || (t2 += e4, a3 += Math.abs(e4));
                }
              }
            }), P(this.series, (n) => {
              if (!n.get("excludeFromTotal")) {
                let r2 = n.dataItems[e3];
                if (r2) {
                  let e4 = r2.get(o4) * n.get(s2);
  ...
  _getSelectionMinMax() {
    ...
    let o4 = this.get("extraMin", 0), n = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o4 = 0.1), null == this.get("extraMax") && (n = 0.2));
    ...
    if (_(e2) && _(t)) {
      ...
      let g2 = c, p = u, m = u - c;
      c -= m * o4, u += m * n;
      let _3 = this._adjustMinMax(c, u, l2);
      c = _3.min, u = _3.max, c = pe(c, e2, t), u = pe(u, e2, t), _3 = this._adjustMinMax(c, u, l2, true), d || (c = _3.min, u = _3.max);
      const x = this.get("syncWithAxis");
      if (x && (_3 = this._syncAxes(c, u, _3.step, x.getPrivate("selectionMinFinal", x.getPrivate("minFinal", 0)), x.getPrivate("selectionMaxFinal", x.getPrivate("maxFinal", 1)), x.getPrivate("selectionStepFinal", x.getPrivate("step", 1))), _3.min < e2 && (_3.min = e2), _3.max > t && (_3.max = t), c = _3.min, u = _3.max), d && (_(i2) && (c = Math.max(c, i2)), _(s2) && (u = Math.min(u, s2))), h && (c = g2 - (p - g2) * o4, u = p + (p - g2) * n), d) {
      ...
      this.setPrivateRaw("selectionMinFinal", c), this.setPrivateRaw("selectionMaxFinal", u), this.setPrivateRaw("selectionStepFinal", _3.step), this.zoom(v, y2);
    }
  }
  _getMinMax() {
    let e2 = this.get("min"), t = this.get("max"), i2 = 1 / 0, s2 = -1 / 0, o4 = this.get("extraMin", 0), n = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o4 = 0.1), null == this.get("extraMax") && (n = 0.2));
    let l2 = 1 / 0;
    if (P(this.series, (e3) => {
      if (!e3.get("ignoreMinMax")) {
    ...
    this._minRealLog = i2, _(c) && (i2 = c), _(u) && (s2 = u), i2 = this._fixMin(i2), s2 = this._fixMax(s2), s2 - i2 <= 1 / Math.pow(10, 15) && (s2 - i2 != 0 ? this._deltaMinMax = (s2 - i2) / 2 : this._getDelta(s2), i2 -= this._deltaMinMax, s2 += this._deltaMinMax), i2 -= (s2 - i2) * o4, s2 += (s2 - i2) * n, this.get("logarithmic") && (i2 < 0 && h >= 0 && (i2 = 0), s2 > 0 && d <= 0 && (s2 = 0)), this._minReal = i2, this._maxReal = s2;
    let g2 = this.get("strictMinMax"), p = this.get("strictMinMaxSelection", false);
    p && (g2 = p);
    let m = g2;
    _(t) && (m = true);
    let _3 = this.get("renderer").gridCount(), x = this._adjustMinMax(i2, s2, _3, m);
    if (i2 = x.min, s2 = x.max, x = this._adjustMinMax(i2, s2, _3, true), i2 = x.min, s2 = x.max, g2) {
  ...
  _adjustMinMax(e2, t, i2, s2) {
    ...
    let o4 = e2, n = t, l2 = t - e2;
    0 === l2 && (l2 = Math.abs(t));
    let h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h));
    d /= 10;
    let c = d;
    s2 && (c = 0), s2 ? (e2 = Math.floor(e2 / d) * d, t = Math.ceil(t / d) * d) : (e2 = Math.ceil(e2 / d) * d - c, t = Math.floor(t / d) * d + c), e2 < 0 && o4 >= 0 && (e2 = 0), t > 0 && n <= 0 && (t = 0), h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h)), d /= 100;
    ...
    let _3 = 0;
    g2 < 1 && (_3 = Math.round(Math.abs(Math.log(Math.abs(g2)) * Math.LOG10E)) + 1, u = de(u, _3));
    let b, x = Math.floor(e2 / u);
    return e2 = de(u * x, _3), b = s2 ? Math.floor(t / u) : Math.ceil(t / u), b === x && b++, (t = de(u * b, _3)) < n && (t += u), e2 > o4 && (e2 -= u), u = this.fixSmallStep(u), { min: e2, max: t, step: u };
  }
  getTooltipText(e2, t) {
    const i2 = this.get("tooltipNumberFormat", this.get("numberFormat")), s2 = this.getNumberFormatter(), a2 = this.get("extraTooltipPrecision", 0), o4 = this.getPrivate("stepDecimalPlaces", 0) + a2, n = de(this.positionToValue(e2), o4);
    return i2 ? s2.format(n, i2) : s2.format(n, void 0, o4);
  }
  getSeriesItem(e2, t) {
    let i2, s2, a2 = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), o4 = this.positionToValue(t);
    if (P(e2.dataItems, (e3, t2) => {
      const n = Math.abs(e3.get(a2) - o4);
      (void 0 === i2 || n < s2) && (i2 = t2, s2 = n);
  ...
  _syncAxes(e2, t, i2, s2, o4, n) {
    if (this.get("syncWithAxis")) {
      let r2 = Math.round(o4 - s2) / n, l2 = Math.round((t - e2) / i2), h = this.get("renderer").gridCount();
      if (_(r2) && _(l2)) {
        let s3 = false, a2 = 0, o5 = 0.01 * (t - e2), n2 = e2, l3 = t, d = i2;
        for (; 1 != s3; ) if (s3 = this._checkSync(n2, l3, d, r2), a2++, a2 > 500 && (s3 = true), s3) e2 = n2, t = l3, i2 = d;
        else {
          a2 / 3 == Math.round(a2 / 3) ? (n2 = e2 - o5 * a2, e2 >= 0 && n2 < 0 && (n2 = 0)) : (l3 = t + o5 * a2, l3 <= 0 && l3 > 0 && (l3 = 0));
          let i3 = this._adjustMinMax(n2, l3, h, true);
          n2 = i3.min, l3 = i3.max, d = i3.step;
        }
      }
    }
...
Object.defineProperty(me, "className", { enumerable: true, configurable: true, writable: true, value: "AxisTick" }), Object.defineProperty(me, "classNames", { enumerable: true, configurable: true, writable: true, value: N.classNames.concat([me.className]) });
var _e = class extends Ye {
  ...
  toggleVisibility(e2, t, i2, s2) {
    let a2 = this.axis;
    const o4 = a2.get("start", 0), n = a2.get("end", 1);
    t < o4 + (n - o4) * (i2 - 1e-4) || t > o4 + (n - o4) * (s2 + 1e-4) ? e2.setPrivate("visible", false) : e2.setPrivate("visible", true);
  }
...
var be = class extends _e {
  ...
  _updatePositions() {
    ...
    if (i2) {
      ...
      const n = e2.parent;
      n && (o4 -= n.get("paddingLeft", 0)), s2.children.length > 0 ? (a2 = e2.axisHeader.width(), e2.set("marginLeft", a2 + 1)) : s2.set("width", a2), s2.setAll({ x: o4, y: -1, height: t2.height() + 2 });
    }
  }
  processAxis() {
    super.processAxis();
  ...
  updateTick(e2, t, s2, o4) {
    if (e2) {
      _(t) || (t = 0);
      let n = 0.5;
      n = _(o4) && o4 > 1 ? e2.get("multiLocation", n) : e2.get("location", n), _(s2) && s2 != t && (t += (s2 - t) * n), e2.set("x", this.positionToCoordinate(t));
  ...
  updateLabel(e2, t, s2, o4) {
    if (e2) {
      let n = 0.5;
      n = _(o4) && o4 > 1 ? e2.get("multiLocation", n) : e2.get("location", n), _(t) || (t = 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? r2 ? (e2.set("position", "absolute"), e2.set("y", 0)) : (e2.set("position", "relative"), e2.set("y", r)) : r2 ? (e2.set("y", 0), e2.set("position", "absolute")) : (e2.set("y", void 0), e2.set("position", "relative")), _(s2) && s2 != t && (t += (s2 - t) * n), e2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  updateBullet(e2, t, i2) {
    if (e2) {
      ...
      if (s2) {
        ...
        _(i2) && i2 != t && (t += (i2 - t) * o4);
        let n = this.axis.roundAxisPosition(t, o4), r2 = this.axis._bullets[n], l2 = -1;
        if (this.get("opposite") && (l2 = 1), e2.get("stacked")) if (r2) {
          let e3 = r2.get("sprite");
          e3 && s2.set("y", e3.y() + e3.height() * l2);
        } else s2.set("y", 0);
        this.axis._bullets[n] = e2, s2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(s2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    ...
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.x, o4 = 0, n = this.axisLength(), r2 = i2, l2 = "up";
    this.get("opposite") ? t ? (l2 = "up", o4 = s2.y, r2 = i2) : (l2 = "down", o4 = s2.y - i2, r2 = i2) : t ? (l2 = "down", o4 = s2.y - i2, r2 = i2) : (l2 = "up", o4 = s2.y, r2 = i2);
    const h = { left: a2, right: a2 + n, top: o4, bottom: o4 + r2 }, d = e2.get("bounds");
...
var xe = class extends _e {
  ...
  updateLabel(e2, t, i2, s2) {
    if (e2) {
      ...
      const n = this.get("opposite"), r2 = e2.get("inside", this.get("inside", false));
      n ? (e2.set("x", 0), r2 ? e2.set("position", "absolute") : e2.set("position", "relative")) : r2 ? (e2.set("x", 0), e2.set("position", "absolute")) : (e2.set("x", void 0), e2.set("position", "relative")), _(i2) && i2 != t && (t += (i2 - t) * o4), e2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  updateTick(e2, t, i2, s2) {
    if (e2) {
      ...
      let n = e2.get("length", 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? (e2.set("x", 0), r2 && (n *= -1)) : r2 || (n *= -1), e2.set("draw", (e3) => {
        e3.moveTo(0, 0), e3.lineTo(n, 0);
      }), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateBullet(e2, t, i2) {
    if (e2) {
      ...
      if (s2) {
        ...
        this.axis._bullets[n] = e2, s2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(s2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    const t = this.get("inside"), i2 = 1e5;
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.y, o4 = 0, n = this.axisLength(), r2 = i2, l2 = "right";
    this.get("opposite") ? t ? (l2 = "right", o4 = s2.x - i2, r2 = i2) : (l2 = "left", o4 = s2.x, r2 = i2) : t ? (l2 = "left", o4 = s2.x, r2 = i2) : (l2 = "right", o4 = s2.x - i2, r2 = i2);
    const h = { left: o4, right: o4 + r2, top: a2, bottom: a2 + n }, d = e2.get("bounds");
    Vt(h, d) || (e2.set("bounds", h), e2.set("pointerOrientation", l2));
  }
  _updateLC() {
    const e2 = this.axis, t = e2.parent;
...
var fe = class extends ce {
    ...
    if (e2.inited && t.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
        ...
        for (let l2 = e3 - 1; l2 >= 0; l2--) {
          let n2 = this.dataItems[l2], r3 = true, h = n2.dataContext;
          if (t2 && h[t2] && (s2 = true), i2 && h[i2] && (o4 = true), P(this._valueFields, (e4) => {
            _(n2.get(e4)) || (r3 = false);
          }), r3 && s2 && o4) {
            e3 = l2;
            break;
          }
        }
        let n = this.dataItems.length, r2 = this.endIndex();
        if (r2 < n) {
          r2++;
          for (let e4 = r2; e4 < n; e4++) {
  ...
  _startSegment(e2) {
    ...
    const s2 = this.get("autoGapCount"), a2 = this.get("connect"), o4 = this.makeFill(this.fills), n = this._fillTemplate, r2 = this.fills.template;
    n && n != r2 && (o4.template = n), o4.setPrivate("visible", true);
    ...
    let d = this.get("xAxis"), c = this.get("yAxis"), u = this.get("baseAxis"), g2 = this.get("vcx", 1), p = this.get("vcy", 1), m = this._xField, _3 = this._yField, b = this._xOpenField, x = this._yOpenField;
    ...
    let I = false;
    (y2 || f || v) && (I = true);
    const j2 = { points: k2, segments: D, stacked: y2, getOpen: I, basePosX: w2, basePosY: P2, fillVisible: F, xField: m, yField: _3, xOpenField: b, yOpenField: x, vcx: g2, vcy: p, baseAxis: u, xAxis: d, yAxis: c, locationX: S2, locationY: O2, openLocationX: C2, openLocationY: X2, minDistance: Y };
    let V2 = this._strokeTemplate, E = this._fillTemplate;
    for (L = e2; L < i2; L++) {
      this._dindex = L;
      const t2 = this._dataItems[L];
      let n2 = t2.get(m), r3 = t2.get(_3);
      if (null == n2 || null == r3 ? a2 || (k2 = [], D.push(k2), j2.points = k2) : this._getPoints(t2, j2), T2) {
    ...
    o4.setRaw("userData", [e2, L]), l2.setRaw("userData", [e2, L]), L === t && this._endLine(k2, D[0][0]), l2 && this._drawStroke(l2, D), o4 && this._drawFill(o4, D), this.axisRanges.each((t2) => {
      ...
      const o5 = t2.strokes, n2 = this.makeStroke(o5);
      i3 && i3.children.push(n2), V2 && V2 != this.strokes.template && (n2.template = V2), E && E != this.fills.template && (a3.template = E), n2.setPrivate("visible", true), this._drawStroke(n2, D), a3.setRaw("userData", [e2, L]), n2.setRaw("userData", [e2, L]);
    });
  }
  _getPoints(e2, t) {
    let i2 = t.points, s2 = e2.get("locationX", t.locationX), a2 = e2.get("locationY", t.locationY), o4 = t.xAxis.getDataItemPositionX(e2, t.xField, s2, t.vcx), n = t.yAxis.getDataItemPositionY(e2, t.yField, a2, t.vcy);
    if (this._shouldInclude(o4)) {
      const s3 = this.getPoint(o4, n), a3 = [s3.x, s3.y];
      if (s3.x += this._x, s3.y += this._y, e2.set("point", s3), t.fillVisible) {
        ...
        if (t.baseAxis === t.xAxis ? s4 = t.basePosY : t.baseAxis === t.yAxis && (i3 = t.basePosX), t.getOpen) {
          ...
          if (null != a4 && null != o5) {
            ...
            if (t.stacked) {
              let n2 = e2.get("stackToItemX"), r3 = e2.get("stackToItemY");
              n2 ? (i3 = t.xAxis.getDataItemPositionX(n2, t.xField, a5, n2.component.get("vcx")), o2(i3) && (i3 = t.basePosX)) : i3 = t.yAxis === t.baseAxis ? t.basePosX : t.xAxis.getDataItemPositionX(e2, t.xOpenField, a5, t.vcx), r3 ? (s4 = t.yAxis.getDataItemPositionY(r3, t.yField, o6, r3.component.get("vcy")), o2(s4) && (s4 = t.basePosY)) : s4 = t.xAxis === t.baseAxis ? t.basePosY : t.yAxis.getDataItemPositionY(e2, t.yOpenField, o6, t.vcy);
      ...
      if (t.minDistance > 0) {
        const e3 = a3[0], s4 = a3[1], o5 = a3[2], n2 = a3[3], r2 = this._previousPoint, l2 = r2[0], h = r2[1], d = r2[2], c = r2[3];
        (Math.hypot(e3 - l2, s4 - h) > t.minDistance || o5 && n2 && Math.hypot(o5 - d, n2 - c) > t.minDistance) && (i2.push(a3), this._previousPoint = a3);
      } else i2.push(a3);
    }
  }
  _endLine(e2, t) {
...
//# sourceMappingURL=chunk-KLTQ32S3.js.map
