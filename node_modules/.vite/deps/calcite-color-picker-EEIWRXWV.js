...
import {
  ...
  toAlphaMode,
  toNonAlphaMode
} from "./chunk-2T35YN3N.js";
import "./chunk-TDUTDX7M.js";
import "./chunk-GMY5GE5X.js";
import "./chunk-XAHOIZ6A.js";
import "./chunk-ZRIDX7RZ.js";
import "./chunk-HSFIU36F.js";
import {
  clamp,
  closeToRangeEdge,
  remap
} from "./chunk-KMOWC2SY.js";
import "./chunk-IO23KAKR.js";
import "./chunk-3TDHAIWU.js";
import {
  repeat
} from "./chunk-IIQGM4B5.js";
import "./chunk-YYKH4IWR.js";
import "./chunk-XDE6FTUE.js";
import "./chunk-M3GXCJNK.js";
import "./chunk-7PVVYHUM.js";
import "./chunk-JTH7QURZ.js";
import "./chunk-X4JOBR43.js";
import "./chunk-K7PSKWDN.js";
import "./chunk-IAASJRDO.js";
import "./chunk-NLYRY4LW.js";
import "./chunk-QZJ4DBKL.js";
import {
  throttle_default
} from "./chunk-H42L74JV.js";
...
var styles = css`:host{display:block}.container{display:flex;inline-size:100%;flex-wrap:nowrap;align-items:center}.hex-input{flex-grow:1;text-transform:uppercase}.opacity-input{inline-size:100px;margin-inline-start:-1px}:host([hidden]){display:none}[hidden]{display:none}`;
...
var _ColorPicker = class _ColorPicker extends LitElement {
  constructor() {
    ...
    this.drawColorControls = throttle_default((type = "all") => {
    ...
    this.resizeCanvas = throttle_default((entries) => {
      if (!this.hasUpdated) {
        return;
      }
      const [first] = entries;
  ...
  async load() {
    ...
    const initialColor = willSetNoColor ? null : valueIsCompatible ? color_default(value) : color;
  ...
  handleValueChange(value, oldValue) {
    ...
    const color = isClearable && !value ? null : color_default(value != null && typeof value === "object" && alphaCompatible(this.mode) ? normalizeColor(value) : value);
...
@esri/calcite-components/dist/components/calcite-color-picker/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=calcite-color-picker-EEIWRXWV.js.map
