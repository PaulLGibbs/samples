...
var y = class _y {
  ...
  transposeInPlace() {
    ...
    return s.assignCopy(this), this.M = Mt(this.N, this.N = this.M), s.transpose(this), this;
  }
  transpose(t) {
    if (this !== t) {
...
var n2 = class extends y {
  constructor(t) {
    ...
    super(s, t.NN, t.MM), this.buffer = s, t.initializerList && Tt(this.buffer, t.initializerList, 0, 0, t.initializerList.length);
  }
  assignCopy(t) {
...
var x = class _x {
  ...
  initializeFromTwoPointsArray(t, o) {
    ...
    const i = ei.distance(t[0], t[1]), h = ei.distance(o[0], o[1]), r = h / i;
    this.scale(r, r);
    const a = t[1].sub(t[0]);
    a.divThis(i);
    const l = o[1].sub(o[0]);
  ...
  isIdentityTol(t) {
    const s = t * t;
    return !($(this.xd) + $(this.yd) > s) && (!($(this.xy + this.xd) + $(this.yy + this.yd - 1) > s) && !($(this.xx + this.xd - 1) + $(this.yx + this.yd) > s));
  }
  isReflective() {
  ...
  invertPreciseThis() {
    const t = Hs.constructDouble(this.xy), s = Hs.constructDouble(this.xx), o = s.mulDouble(this.yy).sub(t.mulDouble(this.yx));
    if (o.isZero()) return this.setZero(), this;
    const i = o.clone();
    i.invertThis();
    const e = Hs.constructDouble(this.xd), h = t.mulDouble(this.yd).sub(e.mulDouble(this.yy)).mul(i).toDouble(), a = e.mulDouble(this.yx).sub(s.mulDouble(this.yd)).mul(i).toDouble(), l = i.mulDouble(this.yy).toDouble(), y2 = i.mulDouble(-this.xy).toDouble(), n3 = i.mulDouble(-this.yx).toDouble(), x2 = i.mulDouble(this.xx).toDouble();
  ...
  calculateErrors(s, o, i, h) {
    ...
    let r = 0;
    for (let t = 0; t < s; ++t) {
      const s2 = this.transform(o[t]), a = ei.sqrDistance(i[t], s2);
...
function C(t, s, i, h, r) {
  const a = ei.average(i, s), l = ei.average(h, s), y2 = new n2({ NN: 2, MM: 2 });
  y2.setZero();
...
function f(s, i, h, r, a, l) {
  ...
  const y2 = ei.average(r, h), C2 = ei.average(a, h);
...
//# sourceMappingURL=chunk-AJBMH4BL.js.map
