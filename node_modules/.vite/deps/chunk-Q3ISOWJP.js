...
var d = class extends n2 {
  ...
  async _handshake(e = 1e4) {
    ...
    if (null == s2) return;
    const n3 = L(), i = s2.onmessage, { filter: c2, outFields: a3, spatialReference: l } = this._config;
...
var g2 = class extends d {
  ...
  async _fetchServiceDefinition(e) {
    const r3 = { f: "json", ...this._config.customParameters }, i = P(e.path, { query: r3, responseType: "json" }), o3 = (await i).data;
    return this._serviceDefinition = o3, o3;
  }
  _fetchWebSocketUrl(e, t) {
    const r3 = e[0], { urls: i, token: o3 } = r3, n3 = this._inferWebSocketBaseUrl(i);
  ...
  async _setFilter(e, t) {
    ...
    let a3 = false;
    const c2 = L(), u = () => {
      a3 || (this.destroyed || this._websocket !== s2 || n.getLogger(this).error(new s("geoevent-connection", "Server timed out when setting filter")), c2.reject());
    }, l = (e2) => {
      const t2 = JSON.parse(e2.data);
      t2.filter && (t2.error && (n.getLogger(this).error(new s("geoevent-connection", "Failed to set service filter", t2.error)), this._set("errorString", `Could not set service filter - ${t2.error}`), c2.reject(t2.error)), this._setWebSocketJSONParseHandler(s2), a3 = true, c2.resolve());
    };
    return s2.onmessage = l, s2.send(n3), setTimeout(u, h2), c2.promise;
  }
  ...
  async _queryBuddy(e) {
    var _a;
    const t = new (await import("./@arcgis_core_layers_FeatureLayer.js")).default({ url: e }), { capabilities: r3 } = await t.load(), i = r3.query.supportsMaxRecordCountFactor, o3 = r3.query.supportsPagination, s2 = r3.query.supportsCentroid, n3 = this._config.maxRecordCountFactor, c2 = t.capabilities.query.maxRecordCount, u = i ? c2 * n3 : c2, h3 = new b();
    if (h3.outFields = this._config.outFields ?? ["*"], h3.where = ((_a = this._config.filter) == null ? void 0 : _a.where) ?? "1=1", h3.returnGeometry = true, h3.returnExceededLimitFeatures = true, h3.outSpatialReference = g.fromJSON(this._config.spatialReference), s2 && (h3.returnCentroid = true), i && (h3.maxRecordCountFactor = n3), o3) return h3.num = u, t.destroy(), this._queryPages(e, h3);
  ...
  async _queryPages(e, t, r3 = [], i = 0) {
    ...
    return o3.exceededTransferLimit && i < (this._config.maxQueryDepth ?? 0) ? (o3.features.forEach((e2) => r3.push(e2)), this._queryPages(e, t, r3, i + 1)) : (r3.forEach((e2) => o3.features.push(e2)), o3);
  }
  _addRelatedFeatures(e) {
    const t = /* @__PURE__ */ new Map(), r3 = e.features, i = this._serviceDefinition.relatedFeatures.joinField;
    for (const o3 of r3) {
      const e2 = o3.attributes[i];
      t.set(e2, o3);
    }
...
function r2(r3, i, s2, c2, l, u, a3, m2, p) {
  const f2 = { source: r3, sourceSpatialReference: i, spatialReference: s2, geometryType: c2, filter: o2(l, u), maxReconnectionAttempts: a3, maxReconnectionInterval: m2, customParameters: p };
...
//# sourceMappingURL=chunk-Q3ISOWJP.js.map
