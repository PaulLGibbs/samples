...
var o = class {
  constructor(r) {
    this.dataBuffer = r.data.buffer, this.writerSettings = r.writerSettings, this.skipDeduplicate = r.skipDeduplicate, this.indices = s(r.indices) ? r.indices.buffer : r.indices, this.indicesType = s(r.indices) ? a(r.indices) ? "Uint32Array" : "Uint16Array" : "Array", this.indicesLength = r.indicesLength;
  }
};
...
//# sourceMappingURL=chunk-UM3DUOIF.js.map
