...
function i(e, t, r, s2) {
  switch (r) {
    case 0:
      return u(e, t + s2, 0);
    case 1:
      return "lowerLeft" === e.originPosition ? u(e, t + s2, 1) : l(e, t + s2, 1);
  }
}
function n2(e, t, r, s2) {
  return 2 === r ? u(e, t, 2) : i(e, t, r, s2);
}
function a(e, t, r, s2) {
  return 2 === r ? 0 === t ? 0 : u(e, t, 3) : i(e, t, r, s2);
}
function h(e, t, r, s2) {
  return 3 === r ? 0 === t ? 0 : u(e, t, 3) : n2(e, t, r, s2);
}
function u({ translate: e, scale: t }, r, s2) {
  return e[s2] + r * t[s2];
}
function l({ translate: e, scale: t }, r, s2) {
  return e[s2] - r * t[s2];
}
var d2 = class {
  constructor(e) {
  ...
  addCoordinatePoint(e, t, r) {
    const s2 = this._transform;
    switch (t = this._applyTransform(s2, t, r, 0), r) {
      case 0:
        e.x = t;
        break;
      case 1:
  ...
  _transformPathLikeValue(e, t) {
    ...
    const s2 = this._transform;
    return null !== this._mValueOffset && 0 === e && t > 0 && !(t % this._mValueOffset) ? 0 : this._applyTransform(s2, e, t, r);
  }
  ...
  _addCoordinateMultipoint(e, t, r) {
    0 === r && e.points.push([]);
    const s2 = this._transformPathLikeValue(t, r);
  ...
  _dehydratedAddPointsCoordinate(e, t, r) {
    ...
    const s2 = this._transformPathLikeValue(t, r), o3 = e[e.length - 1];
    0 === r && (this._coordinateBufferPtr = 0, this._coordinateBuffer = new Array(this._vertexDimension), o3.push(this._coordinateBuffer)), this._coordinateBuffer[this._coordinateBufferPtr++] = s2;
  }
...
async function s(r, e, t) {
  const s2 = await n3(r, b.from(e), t);
  return d.fromJSON(s2);
}
async function n3(o3, s2, n4) {
  const p = f(o3), i2 = { ...n4 }, u2 = b.from(s2), m = !u2.quantizationParameters, { data: f3 } = await f2(p, u2, new d2({ sourceSpatialReference: u2.sourceSpatialReference, applyTransform: m }), i2);
  return f3;
}
...
//# sourceMappingURL=chunk-R3BJVEJ3.js.map
