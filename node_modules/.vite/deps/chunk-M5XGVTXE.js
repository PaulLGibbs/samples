...
async function o(o2) {
  var _a;
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-4RQTO3RB.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var h = class extends i.EventedMixin(n2.IdentifiableMixin(m2)) {
  ...
  static async fromArcGISServerUrl(e) {
    ...
    return (await import("./arcgisLayers-IBU3ZYJY.js")).fromUrl(t);
  }
...
//# sourceMappingURL=chunk-M5XGVTXE.js.map
