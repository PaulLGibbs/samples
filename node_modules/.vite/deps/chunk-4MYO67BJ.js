...
function u(e, r) {
  if (null == e.encoding || "" === e.encoding) {
    ...
    const l2 = l(r, o.vertexAttributes.position), s = o.header.fields, i2 = [s.offsetX, s.offsetY, s.offsetZ], u2 = [s.scaleX, s.scaleY, s.scaleZ], c3 = l2.length / 3, a3 = new Float64Array(3 * c3);
    for (let e2 = 0; e2 < c3; e2++) a3[3 * e2] = l2[3 * e2] * u2[0] + i2[0], a3[3 * e2 + 1] = l2[3 * e2 + 1] * u2[1] + i2[1], a3[3 * e2 + 2] = l2[3 * e2 + 2] * u2[2] + i2[2];
    return a3;
  }
  if ("lepcc-xyz" === e.encoding) return c(r).result;
}
function c2(e, r, o) {
  return (e == null ? void 0 : e.attributeInfo.useElevation) ? r ? a2(r, o) : null : (e == null ? void 0 : e.attributeInfo.storageInfo) ? I(e.attributeInfo.storageInfo, e.buffer, o) : null;
}
function a2(e, r) {
...
//# sourceMappingURL=chunk-4MYO67BJ.js.map
