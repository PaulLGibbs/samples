...
var n = class _n {
  ...
  sqrMaxMinDistanceEnvelope(i) {
    ...
    {
      const m = ei.sqrDistanceCoords(this.xmin, this.ymin, i.xmax, i.ymin), h = ei.sqrDistanceCoords(this.xmin, this.ymin, i.xmax, i.ymax), x = ei.sqrDistanceCoords(this.xmin, this.ymax, i.xmax, i.ymin), n2 = ei.sqrDistanceCoords(this.xmin, this.ymax, i.xmax, i.ymax), e = Math.max(m, h), a = Math.max(x, n2), r = Math.max(e, a);
      t = Math.min(r, t);
    }
    {
      const m = ei.sqrDistanceCoords(this.xmin, this.ymin, i.xmin, i.ymax), h = ei.sqrDistanceCoords(this.xmin, this.ymin, i.xmax, i.ymax), x = ei.sqrDistanceCoords(this.xmax, this.ymin, i.xmin, i.ymax), n2 = ei.sqrDistanceCoords(this.xmax, this.ymin, i.xmax, i.ymax), e = Math.max(m, h), a = Math.max(x, n2), r = Math.max(e, a);
      t = Math.min(r, t);
    }
    {
      const m = ei.sqrDistanceCoords(this.xmax, this.ymin, i.xmin, i.ymin), h = ei.sqrDistanceCoords(this.xmax, this.ymin, i.xmin, i.ymax), x = ei.sqrDistanceCoords(this.xmax, this.ymax, i.xmin, i.ymin), n2 = ei.sqrDistanceCoords(this.xmax, this.ymax, i.xmin, i.ymax), e = Math.max(m, h), a = Math.max(x, n2), r = Math.max(e, a);
      t = Math.min(r, t);
    }
    {
      const m = ei.sqrDistanceCoords(this.xmin, this.ymax, i.xmin, i.ymin), h = ei.sqrDistanceCoords(this.xmin, this.ymax, i.xmax, i.ymin), x = ei.sqrDistanceCoords(this.xmax, this.ymax, i.xmin, i.ymin), n2 = ei.sqrDistanceCoords(this.xmax, this.ymax, i.xmax, i.ymin), e = Math.max(m, h), a = Math.max(x, n2), r = Math.max(e, a);
      t = Math.min(r, t);
    }
    return t;
  }
  sqrMaxDistanceEnvelope(i) {
    ...
    for (let m = 0; m < 4; m++) for (let i2 = 0; i2 < 4; i2++) {
      const n2 = ei.sqrDistance(h[m], x[i2]);
      n2 > t && (t = n2);
    }
    return t;
  }
  sqrMaxMinDistance(i) {
    const t = ei.sqrDistance(i, this.getLowerLeft()), m = ei.sqrDistance(i, this.getUpperLeft()), h = ei.sqrDistance(i, this.getLowerRight()), x = ei.sqrDistance(i, this.getUpperRight());
  ...
  sqrMaxDistance(i) {
    let t = ei.sqrDistance(i, this.getLowerLeft());
    return t = Math.max(ei.sqrDistance(i, this.getUpperLeft()), t), t = Math.max(ei.sqrDistance(i, this.getUpperRight()), t), t = Math.max(ei.sqrDistance(i, this.getLowerRight()), t), t;
  }
  snapToBoundary(i) {
  ...
  snapClip(i) {
    const t = ks(i.x, this.xmin, this.xmax), m = ks(i.y, this.ymin, this.ymax);
    return ei.construct(t, m);
  }
  boundaryDistance(i) {
    if (this.isEmpty() || i.isNAN()) return Number.NaN;
...
//# sourceMappingURL=chunk-BKBHJYAN.js.map
