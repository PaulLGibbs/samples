...
var u2 = class extends ai {
  ...
  _makeButton() {
    return this.children.push(o2.new(this._root, { themeTags: ["resize", "button", this.get("orientation")], icon: Ye.new(this._root, { themeTags: ["icon"] }) }));
  }
  _makeThumb() {
  ...
  _updateThumb() {
    ...
    "vertical" == this.get("orientation") ? _(o3) && _(u3) && (this._thumbBusy || t.isDragging() || (t.set("height", u3 - o3), t.set("y", o3)), d2 = o3 / i, p2 = u3 / i) : _(r) && _(n2) && (this._thumbBusy || t.isDragging() || (t.set("width", n2 - r), t.set("x", r)), d2 = r / h, p2 = n2 / h), !this.getPrivate("isBusy") || this.get("start") == d2 && this.get("end") == p2 || (this.set("start", d2), this.set("end", p2));
...
//# sourceMappingURL=chartCommon-PUEUD7LK.js.map
