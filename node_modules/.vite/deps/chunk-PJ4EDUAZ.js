...
function b2() {
  ...
  const a7 = s.workers.loaderConfig, i2 = r3({ baseUrl: a7 == null ? void 0 : a7.baseUrl, locale: r(), has: { "csp-restrictions": 1, "dojo-test-sniff": 0, "host-webworker": 1, ...a7 == null ? void 0 : a7.has }, map: { ...a7 == null ? void 0 : a7.map }, paths: { ...a7 == null ? void 0 : a7.paths }, packages: (a7 == null ? void 0 : a7.packages) || [] }), l3 = { buildDate: a, fullVersion: r2, revision: e };
...
function w3() {
  d2 && (h2.abort(), d2 = null);
  for (let r4 = 0; r4 < l2.length; r4++) l2[r4] && l2[r4].terminate();
  l2.length = 0;
}
var h2;
var d2 = null;
...
//# sourceMappingURL=chunk-PJ4EDUAZ.js.map
