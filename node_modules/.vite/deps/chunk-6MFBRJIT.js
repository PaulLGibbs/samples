...
var n = new FinalizationRegistry((n4) => {
  n4.close();
});
function e3(e6, i3) {
  n.register(e6, i3, i3);
...
function t2(t3, r3) {
  return new Proxy({}, { get: (e6, i3, s5) => (...e7) => {
    ...
    n2(a3) && (s6 = a3.signal, o3 = a3.transferList, e7.pop());
...
var e4 = { statsWorker: () => import("./statsWorker-CI5R2OQP.js"), geometryEngineWorker: () => import("./geometryEngineWorker-HQL7PWSI.js"), arcadeGeometryOperatorsWorker: () => import("./operatorsWorker-CWZKDZHN.js"), CSVSourceWorker: () => import("./CSVSourceWorker-CNI7535E.js"), EdgeProcessingWorker: () => import("./EdgeProcessingWorker-7X2PVZEL.js"), ElevationSamplerWorker: () => import("./ElevationSamplerWorker-UX3DGXIZ.js"), FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-BCPK5LVX.js"), GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-TZNUIDJD.js"), LercWorker: () => import("./LercWorker-6CRL4SWK.js"), MemorySourceWorker: () => import("./MemorySourceWorker-7PGAWPW7.js"), PBFDecoderWorker: () => import("./PBFDecoderWorker-EWFFX73D.js"), FeaturePipelineWorker: () => import("./FeaturePipelineWorker-57R3UJ7H.js"), PointCloudWorker: () => import("./PointCloudWorker-NZLLMHZF.js"), RasterWorker: () => import("./RasterWorker-MRRSVHNN.js"), SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-35WXN44M.js"), SceneLayerWorker: () => import("./SceneLayerWorker-4WQOQAFP.js"), WFSSourceWorker: () => import("./WFSSourceWorker-QUWOXQAP.js"), WorkerTileHandler: () => import("./WorkerTileHandler-3HLPENYJ.js"), Lyr3DWorker: () => import("./Lyr3DWorker-BCGG6U64.js"), Feature3DPipelineWorker: () => import("./Feature3DPipelineWorker-AVLZOSSD.js"), TextureCompressionWorker: () => import("./TextureCompressionWorker-YAKUGV4Z.js") };
...
function a2(t3, r3, n4, s5) {
  if (r3.type === e5.OPEN_PORT) return void t3.postMessage(r3, [r3.port]);
  if (r3.type !== e5.INVOKE && r3.type !== e5.RESPONSE) return void t3.postMessage(r3);
  let f2;
      ...
      for (const n5 of f2) if ("byteLength" in n5 && n5.byteLength > 267386880) {
        ...
        switch (r3.type) {
          case e5.INVOKE:
            throw n6;
          case e5.RESPONSE:
            return void a2(t3, { type: e5.RESPONSE, jobId: r3.jobId, error: i2(n6) });
        }
      }
    }
...
var { CLOSE: M, ABORT: k, INVOKE: j, RESPONSE: y, OPEN_PORT: I, ON: J } = e5;
var w = 2;
var O2 = class {
  constructor(e6) {
  ...
  push(e6) {
    e6.type === e5.ABORT ? this._cancelledJobIds.add(e6.jobId) : (this._invokeMessages.push(e6), null === this._timer && (this._timer = setTimeout(this._process, 0)));
  }
  clear() {
...
var E = class _E {
  ...
  on(e6, s5) {
    ...
    return this._port.postMessage({ type: e5.ON, eventType: e6, port: t3.port2 }, [t3.port2]), t3.port1.addEventListener("message", n4), t3.port1.start(), e(() => {
      t3.port1.postMessage({ type: e5.CLOSE }), t3.port1.close(), t3.port1.removeEventListener("message", n4);
    });
  }
  jobAdded() {
    this._processWork();
  ...
  _onInvokeMessage(e6) {
    ...
    try {
      ...
      return void this._post({ type: y, jobId: t3, error: i2(_) });
    }
    S(l2) ? (i3.set(t3, { controller: r3, promise: l2 }), l2.then((e7) => {
      i3.has(t3) && (i3.delete(t3), this._post({ type: y, jobId: t3 }, e7));
    }, (e7) => {
      i3.has(t3) && (i3.delete(t3), b(e7) || this._post({ type: y, jobId: t3, error: i2(e7 || { message: `Error encountered at method ${s5}` }) }));
  ...
  _onOnMessage(e6) {
    const { port: s5 } = e6, o3 = this._client.on(e6.eventType, (e7) => {
      ...
      const t3 = f(e7);
      (t3 == null ? void 0 : t3.type) === e5.CLOSE && (n4.remove(), o3.remove(), s5.close());
    });
  }
...
//# sourceMappingURL=chunk-6MFBRJIT.js.map
