import {
  n as n2,
  o
} from "./chunk-QLQUYKO5.js";
import {
  a,
  i as i3,
  p,
  u
} from "./chunk-RIBPQVU2.js";
import {
  i as i2
} from "./chunk-6BFW5NU5.js";
import {
  i2 as i,
  s2 as s
...
function f(r, e) {
  var _a, _b;
  return s(r) || i(r) ? U((_a = r.target) == null ? void 0 : _a.object, e) : n2(r) ? (_b = e.map) == null ? void 0 : _b.ground : i3(r) || a(r) || o(r) || u(r) ? U(r.target, e) : null;
}
function m(r, e) {
  const t = h(r, e);
...
function h(r, e) {
  ...
  if (s(r) || i(r)) return d((_a = r.target) == null ? void 0 : _a.object, e);
  if (i3(r)) {
...
function d(r, e) {
  if (null == (r == null ? void 0 : r.graphicUid)) return null;
  const t = U(r, e);
...
function b(r) {
  return null != r ? { type: "graphic", graphic: r, layer: r.layer } : null;
}
function U(r, e) {
  return null == (r == null ? void 0 : r.layerUid) ? null : null != e.graphicsView && r.layerUid === e.graphicsView.processor.layer.id ? e.graphics : e.map.allLayers.find((e2) => e2.uid === r.layerUid);
}
function V(e, i4) {
...
//# sourceMappingURL=chunk-KVJMXINX.js.map
