...
var _TabTitle = class _TabTitle extends LitElement {
  ...
  render() {
    ...
    })} .hidden=${closed} ${ref((el2) => {
      var _a;
      return el2 ? (_a = this.resizeObserver) == null ? void 0 : _a.observe(el2) : null;
    })}><div class=${safeClassMap({ [CSS.content]: true, [CSS.contentHasText]: this.hasText })}>${this.iconStart ? iconStartEl : null}<slot></slot>${this.iconEnd ? iconEndEl : null}</div>${this.renderCloseButton()}<div class=${safeClassMap(CSS.selectedIndicator)}></div></div>` });
  }
  renderCloseButton() {
...
@esri/calcite-components/dist/components/calcite-tab-title/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=chunk-XAHOIZ6A.js.map
