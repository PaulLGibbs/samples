...
function X(t2, e3) {
  const r2 = B2(t2);
  return s(r2, e3) || r2.imageCoordinateSystem || e3.imageCoordinateSystem ? t2 : O(t2, e3);
}
async function Y(e3, r2) {
  ...
  let l2 = null;
  (u4 == null ? void 0 : u4.targetGeometry) ? l2 = u4.targetGeometry : e3 instanceof w ? l2 = e3 : e3 instanceof n ? l2 = await J(e3, r2, n3) : e3 && (l2 = await J(e3.center, r2, n3) || await J(e3.target, r2, n3) || await J(e3, r2, n3)), !l2 && (i2 == null ? void 0 : i2.targetGeometry) ? l2 = i2.targetGeometry : !l2 && r2.extent && (l2 = r2.extent), n3 || (n3 = B2(r2.spatialReference || r2.extent || l2)), k() || s(l2.spatialReference, n3) || L(l2.spatialReference, n3) || await K();
...
//# sourceMappingURL=chunk-6L7EBX4O.js.map
