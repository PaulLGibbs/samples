...
var u;
var d2 = function(e3) {
  if ("WebkitTransition" in e3.style) l2 = "webkitTransitionEnd", u = "webkitAnimationEnd";
  else {
    if (!("transition" in e3.style)) throw new Error("Your browser is not supported!");
    l2 = "transitionend", u = "animationend";
  }
};
var f = function(e3) {
  l2 || d2(e3);
...
var m = function(e3, t4) {
  return void 0 === t4 && (t4 = e3 + "-active"), function(n2) {
    f(n2);
    var r = false, i = function(o2) {
      r || (r = true, n2.removeEventListener(l2, i), n2.removeEventListener(u, i), n2.classList.remove(e3), n2.classList.remove(t4));
    };
    n2.classList.add(e3), n2.addEventListener(l2, i), n2.addEventListener(u, i), requestAnimationFrame(function() {
      n2.classList.add(t4);
    });
  };
};
var p = function(e3, t4) {
  return void 0 === t4 && (t4 = e3 + "-active"), function(n2, r) {
    f(n2);
    var i = false, o2 = function(e4) {
      i || (i = true, n2.removeEventListener(l2, o2), n2.removeEventListener(u, o2), r());
    };
    n2.classList.add(e3), n2.addEventListener(l2, o2), n2.addEventListener(u, o2), requestAnimationFrame(function() {
      n2.classList.add(t4);
    });
  };
};
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-2F44JUFZ.js.map
