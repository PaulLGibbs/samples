...
var D2 = class _D {
  constructor(e2, t) {
    ...
    for (const i2 of e2.fields.keys()) {
  ...
  copyFrom(e2, t = 0, i2 = 0, s2 = e2.count) {
    const r = this.stride;
    if (r % 4 == 0) {
      const n = new Uint32Array(e2.buffer, t * r, s2 * r / 4);
      new Uint32Array(this.buffer, i2 * r, s2 * r / 4).set(n);
    } else {
      const n = new Uint8Array(e2.buffer, t * r, s2 * r);
...
var G2 = class _G {
  ...
  _appendField(e2, t, i2) {
    ...
    this._stride += s2, this._fields.set(e2, { size: s2, constructor: t, offset: r, optional: i2 });
  }
  createBuffer(e2) {
  ...
  clone() {
    const e2 = new _G();
    return e2._stride = this._stride, e2._fields = /* @__PURE__ */ new Map(), this._fields.forEach((t, i2) => e2._fields.set(i2, t)), e2.BufferType = this.BufferType, e2;
  }
  get stride() {
...
var I2 = class {
  constructor(e2) {
    this.fields = new Array(), e2.fields.forEach((e3, t) => {
      const i2 = { ...e3, constructor: K(e3.constructor) };
...
//# sourceMappingURL=chunk-D4U4GUIV.js.map
