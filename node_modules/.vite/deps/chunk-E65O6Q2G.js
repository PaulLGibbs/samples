...
var t2 = class {
  ...
  sample(a, t3) {
    ...
    const { safeWidth: e, data: s, dx: r, dy: n, y1: i, x0: u } = this._samplerData, { width: o, values: m, noDataValue: h } = s, p = l(n * (i - t3), 0, e), D = l(r * (a - u), 0, e), d = Math.floor(p), f = Math.floor(D), _ = d * o + f, c = _ + o, x = m[_], V = m[c], g = m[_ + 1], v = m[c + 1];
    if (x !== h && V !== h && g !== h && v !== h) {
...
//# sourceMappingURL=chunk-E65O6Q2G.js.map
