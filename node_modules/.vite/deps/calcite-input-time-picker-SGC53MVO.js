import {
  decimalPlaces,
  getDecimals
} from "./chunk-KMOWC2SY.js";
import {
  capitalizeWord
} from "./chunk-R3CB5SWU.js";
import "./chunk-5IDCQ7VP.js";
import "./chunk-3UKTMRNJ.js";
import "./chunk-UYSQAND3.js";
import {
  syncHiddenFormInput
} from "./chunk-M3GXCJNK.js";
import {
  getDateTimeFormat,
...
} from "./chunk-7PVVYHUM.js";
import {
  Validation
} from "./chunk-JTH7QURZ.js";
import "./chunk-K7PSKWDN.js";
import {
  HiddenFormInputSlot,
  connectForm,
  disconnectForm,
  submitForm
} from "./chunk-IAASJRDO.js";
import "./chunk-NLYRY4LW.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-QZJ4DBKL.js";
import "./chunk-2VRCRRPL.js";
import "./chunk-KVK5YQOZ.js";
import "./chunk-H42L74JV.js";
import "./chunk-UZKDSEQU.js";
import {
  numberKeys
} from "./chunk-KHMRVUHW.js";
import "./chunk-MTAWJRXJ.js";
import {
  InteractiveContainer,
  updateHostInteraction
} from "./chunk-MTORZ73F.js";
import "./chunk-GUN7IPYS.js";
import {
  componentFocusable,
  getIconScale
...
import {
  toFunction,
  useT9n
} from "./chunk-5EQ4YFA6.js";
import "./chunk-KZHXLDT6.js";
import "./chunk-TCHT7XS6.js";
import {
  focusFirstTabbable,
  getElementDir
} from "./chunk-AFJWOJDI.js";
import "./chunk-P66NIFEQ.js";
...
var _TimePicker = class _TimePicker extends LitElement {
  ...
  setValuePart(key, value) {
    ...
    this.value = newValue;
    this.localizedMeridiem = this.value ? ((_a = localizeTimeStringToParts({
      hour12,
      locale,
      numberingSystem,
      step,
      value: this.value
    })) == null ? void 0 : _a.meridiem) || null : localizeTimePart({
      hour12,
      value: this.meridiem,
      part: "meridiem",
      locale,
...
var _InputTimePicker = class _InputTimePicker extends LitElement {
  ...
  render() {
    ...
    })} role=combobox ${ref(this.setContainerEl)}><calcite-icon class=${safeClassMap(CSS2.clockIcon)} icon=clock .scale=${scale === "l" ? "m" : "s"}></calcite-icon><div class=${safeClassMap(CSS2.inputContainer)} dir=ltr>${showMeridiem && meridiemStart && this.renderMeridiem("start") || ""}<span aria-label=${this.messages.hour ?? nothing} aria-valuemax=23 aria-valuemin=1 aria-valuenow=${hourIsNumber && parseInt(hour) || "0"} aria-valuetext=${hour ?? nothing} class=${safeClassMap({
  ...
  renderToggleIcon(open) {
    return html`<span class=${safeClassMap(CSS2.toggleIcon)} @click=${this.toggleIconClickHandler}><calcite-icon .icon=${open ? "chevron-up" : "chevron-down"} .scale=${getIconScale(this.scale)}></calcite-icon></span>`;
  }
};
...
@esri/calcite-components/dist/components/calcite-input-time-picker/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=calcite-input-time-picker-SGC53MVO.js.map
