...
import {
  W,
  Z
} from "./chunk-FX2QKRKW.js";
import {
  F,
  h as h4
} from "./chunk-6MUKWRGG.js";
import {
  d as d4,
  h as h3
...
import {
  ...
  p as p2,
  w
} from "./chunk-7MOAINUW.js";
import {
  n as n3
} from "./chunk-H5OMIITW.js";
import {
  E as E2,
  E2 as E3,
  e as e3,
...
var r6 = class {
  ...
  _adjustRotateAngle(a2) {
    ...
    a2.rotateAngle = s2(5 * Math.round(n7 / 5));
  }
};
...
var Y = class extends n3 {
  ...
  get _plane() {
    ...
    return s(a2, e4.spatialReference) && (o2 *= Q(a2) / Q(e4.spatialReference)), S3(s7, t4, o2, this._planeCache);
  }
  get _displayPlane() {
  ...
  async _initialize() {
    ...
    }), a2.addToggle(d4.factorModifier, (e5) => this._factor = "key-down" === e5.type ? X : Q3), a2.add(d4.scaleUp, () => this._scale(this._factor)), a2.add(d4.scaleDown, () => this._scale(-this._factor)), a2.add(d4.moveUp, () => this._move(0, this._factor)), a2.add(d4.moveDown, () => this._move(0, -this._factor)), a2.add(d4.moveLeft, () => this._move(-this._factor, 0)), a2.add(d4.moveRight, () => this._move(this._factor, 0)), this.addHandles([e4.on("key-down", (t4) => {
...
//# sourceMappingURL=chunk-6YZKZ2T6.js.map
