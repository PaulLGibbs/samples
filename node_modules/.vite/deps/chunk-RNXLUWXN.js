...
var r2 = (t2, o, n2) => {
  for (let l2 = 0, i = o.length; l2 < i; l2++) {
    let i2 = o[l2];
    Array.isArray(i2) ? r2(t2, i2, n2) : null != i2 && false !== i2 && ("string" == typeof i2 && (i2 = e(i2)), n2.push(i2));
  }
};
function t(e2, t2, o) {
  ...
  let n2, l2;
  return o && 1 === o.length && "string" == typeof o[0] ? n2 = o[0] : o && (l2 = [], r2(e2, o, l2), 0 === l2.length && (l2 = void 0)), { vnodeSelector: e2, properties: t2, children: l2, text: "" === n2 ? void 0 : n2, domNode: null };
}
...
var n = class extends g {
  ...
  constructor(t2) {
    super(t2), this.x = 0, this.y = 0, this.text = "-", this.fontSize = 14, this.anchor = "center", this.visible = true, this.isDecoration = true, this.backgroundColor = new h([0, 0, 0, 0.6]), this.textColor = new h([255, 255, 255]), this._textShadowSize = 1;
  }
  render() {
  ...
  renderCanvas(t2) {
    ...
    const { padding: o, borderRadius: i } = this, r3 = t2.measureText(this.text).width, s = "" !== this.text ? this.fontSize : 0, l2 = h2[this.anchor];
    t2.textAlign = "center", t2.textBaseline = "middle";
    const n2 = r3 + 2 * o, a3 = s + 2 * o, x2 = this.x + l2.x * n2, d = this.y + l2.y * a3;
    this._roundedRect(t2, x2, d, n2, a3, i), t2.fillStyle = this.backgroundColor.toCss(true), t2.fill();
  ...
  _renderTextShadow(t2, e2, o, i) {
    ...
    const r3 = this._textShadowSize;
    for (const [s, l2] of a2) t2.fillText(e2, o + r3 * s, i + r3 * l2);
  }
  _roundedRect(t2, e2, o, i, r3, s) {
    s = Math.min(s, r3 / 2, i / 2), t2.beginPath(), t2.moveTo(e2, o + s), t2.arcTo(e2, o, e2 + s, o, s), t2.lineTo(e2 + i - s, o), t2.arcTo(e2 + i, o, e2 + i, o + s, s), t2.lineTo(e2 + i, o + r3 - s), t2.arcTo(e2 + i, o + r3, e2 + i - s, o + r3, s), t2.lineTo(e2 + s, o + r3), t2.arcTo(e2, o + r3, e2, o + r3 - s, s), t2.closePath();
  }
  _cssClasses() {
...
r([m()], n.prototype, "x", void 0), r([m()], n.prototype, "y", void 0), r([m()], n.prototype, "position", null), r([m()], n.prototype, "text", void 0), r([m()], n.prototype, "fontSize", void 0), r([m()], n.prototype, "anchor", void 0), r([m()], n.prototype, "visible", void 0), r([m()], n.prototype, "isDecoration", void 0), r([m()], n.prototype, "backgroundColor", void 0), r([m()], n.prototype, "textColor", void 0), r([m()], n.prototype, "_textShadowSize", void 0), r([m()], n.prototype, "_textShadowColor", null), r([m()], n.prototype, "_textShadow", null), r([m()], n.prototype, "padding", null), r([m()], n.prototype, "borderRadius", null), n = r([a("esri.views.overlay.TextOverlayItem")], n);
var h2 = { bottom: { x: -0.5, y: -1, textAlign: "center", textBaseline: "bottom" }, "bottom-left": { x: 0, y: -1, textAlign: "left", textBaseline: "bottom" }, "bottom-right": { x: -1, y: -1, textAlign: "right", textBaseline: "bottom" }, center: { x: -0.5, y: -0.5, textAlign: "center", textBaseline: "middle" }, left: { x: 0, y: -0.5, textAlign: "left", textBaseline: "middle" }, right: { x: -1, y: -0.5, textAlign: "right", textBaseline: "middle" }, top: { x: -0.5, y: 0, textAlign: "center", textBaseline: "top" }, "top-left": { x: 0, y: 0, textAlign: "left", textBaseline: "top" }, "top-right": { x: -1, y: 0, textAlign: "right", textBaseline: "top" } };
var a2 = [];
{
  const t2 = 16;
...
//# sourceMappingURL=chunk-RNXLUWXN.js.map
