...
function u(r) {
  if (a()) {
    ...
    if (n3) {
      ...
      o().error(new s("webgl-error", "WebGL error occurred", { message: a2, stack: c3 }));
    }
  }
}
...
function i(e, r) {
  var _a;
  return (((_a = e.vertexBuffers.get(r)) == null ? void 0 : _a.usedMemory) ?? 0) / R(e.layout.get(r));
}
function R(e) {
  return e[0].stride;
}
function E(r, t2, s3, a2, c3 = 0) {
  ...
  for (const R2 of a2) {
    ...
    else if (16 === R2.count) for (let e = 0; e < 4; e++) i2.vertexAttribPointer(s4 + e, 4, R2.type, R2.normalized, R2.stride, R2.offset + 16 * e + a3), i2.enableVertexAttribArray(s4 + e), R2.divisor > 0 && ((_a = r.gl) == null ? void 0 : _a.vertexAttribDivisor(s4 + e, R2.divisor));
...
function _(e, t2, s3, a2) {
  ...
  for (const r of a2) {
    ...
    if (r.count <= 4) c3.disableVertexAttribArray(s4), r.divisor && r.divisor > 0 && ((_a = e.gl) == null ? void 0 : _a.vertexAttribDivisor(s4, 0));
    else if (9 === r.count) for (let t3 = 0; t3 < 3; t3++) c3.disableVertexAttribArray(s4 + t3), r.divisor && r.divisor > 0 && ((_b = e.gl) == null ? void 0 : _b.vertexAttribDivisor(s4 + t3, 0));
    else if (16 === r.count) for (let t3 = 0; t3 < 4; t3++) c3.disableVertexAttribArray(s4 + t3), r.divisor && r.divisor > 0 && ((_c = e.gl) == null ? void 0 : _c.vertexAttribDivisor(s4 + t3, 0));
...
//# sourceMappingURL=chunk-WDPL26XY.js.map
