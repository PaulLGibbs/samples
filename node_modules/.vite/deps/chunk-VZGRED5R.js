...
function y2(e2, u3, l3, d2 = null, f5 = null) {
  ...
  switch (e2.type) {
    ...
    case "parameter": {
      ...
      if (f(r3)) return S2(r3, u3);
      if (g2(r3)) return E(r3, u3);
      if (Array.isArray(r3)) {
        const e3 = [];
        for (let i3 = 0; i3 < r3.length; i3++) "string" == typeof r3[i3] ? e3.push("'" + r3[i3].toString().replaceAll("'", "''") + "'") : d(r3[i3]) || m2(r3[i3]) ? e3.push(I(r3[i3], u3)) : T(r3[i3]) ? e3.push(A(r3[i3], u3)) : f(r3[i3]) ? e3.push(S2(r3[i3], u3)) : g2(r3[i3]) ? e3.push(E(r3[i3], u3)) : e3.push(r3[i3].toString());
        return e3;
      }
      return r3.toString();
    }
...
//# sourceMappingURL=chunk-VZGRED5R.js.map
