import {
  calciteSize48
} from "./chunk-IO23KAKR.js";
import {
  CSS as CSS2,
  XButton
} from "./chunk-3TDHAIWU.js";
import {
  CSS,
  ...
  hasActiveChildren,
  isSingleLike
} from "./chunk-7SCS2GTA.js";
import {
  filter
} from "./chunk-OXHEWS3R.js";
import {
  Validation
...
var _Combobox = class _Combobox extends LitElement {
  constructor() {
    ...
    this.filterItems = (() => {
      ...
      return debounce_default((text, setOpenToEmptyState = false, emit = true) => {
        ...
        this.filterTextMatchPattern = this.filterText && new RegExp(`(${escapeRegExp_default(this.filterText)})`, "i");
  ...
  async setFocus() {
    ...
    (_a = this.textInput.value) == null ? void 0 : _a.focus();
    this.activeChipIndex = -1;
    this.activeItemIndex = -1;
  }
  connectedCallback() {
  ...
  scrollToActiveOrSelectedItem(scrollToSelected = false) {
    var _a;
    const item = scrollToSelected && ((_a = this.selectedItems) == null ? void 0 : _a.length) ? this.selectedItems[0] : this.filteredItems[this.activeItemIndex];
    if (!item) {
      return;
    }
  ...
  renderInput() {
    ...
    return html`<span class=${safeClassMap({
      ...
      [CSS.label]: true,
      [CSS.labelIcon]: !!(selectedItem == null ? void 0 : selectedItem.icon)
  ...
  renderChevronIcon() {
    const { open } = this;
    return keyed("chevron", html`<span class="icon-end"><calcite-icon class=${safeClassMap(CSS.icon)} .icon=${open ? "chevron-up" : "chevron-down"} .scale=${getIconScale(this.scale)}></calcite-icon></span>`);
  }
  render() {
    var _a;
...
@esri/calcite-components/dist/components/calcite-combobox/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=chunk-JET3ZWYV.js.map
