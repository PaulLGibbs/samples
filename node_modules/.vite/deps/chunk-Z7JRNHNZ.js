...
var o = (r) => r.map((r2) => new ei(r2.x, r2.y));
var i = class {
  constructor() {
  ...
  rotate(r, n2, o2) {
    const i2 = s(r);
    return null != n2 && null != o2 ? this.transform.rotateAngleAbout(i2, new ei(n2, o2)) : this.transform.rotateAngle(i2), this;
  }
  scale(t, r) {
...
//# sourceMappingURL=chunk-Z7JRNHNZ.js.map
