...
function V2(t3, n6) {
  return (n6 == null ? void 0 : n6.useEllipsoid) && A(t3) ? w2 : a(t3);
}
...
function z(t3, n6, r2) {
  ...
  if (!r2) {
    ...
    return { position: a2(new Float64Array(r3.length), r3, n6), tangent: o4, normal: e4 };
  }
  const e3 = I(t3, r2.localMatrix);
  return a2(e3.position, e3.position, n6), e3;
}
...
//# sourceMappingURL=chunk-QW5ASOGQ.js.map
