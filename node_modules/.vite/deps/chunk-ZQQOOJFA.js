  ...
  let b = class extends f3 {
    ...
    async fetchSublayerInfo(e2, t3) {
      ...
      if ((this == null ? void 0 : this.portalItem) && "tile" === this.type && "map-layer" === (s3 == null ? void 0 : s3.type) && c(this.portalItem) && e2.originIdOf("url") < e.SERVICE) {
        ...
        r4 && (e2.url = V2(r4.url, s3.mapLayerId.toString()), e2.layerItemId = r4.itemId);
      }
      const { url: i } = e2;
      let a2;
    ...
    async _fetchAllLayersAndTablesFromService(e2, i) {
      ...
      const a2 = d(e2), p = r2(this._allLayersAndTablesMap, a2 == null ? void 0 : a2.url.path, () => P(V2(a2 == null ? void 0 : a2.url.path, "/layers"), { responseType: "json", query: { f: "json", ...this.customParameters, token: this.apiKey } }).then((e3) => {
...
//# sourceMappingURL=chunk-ZQQOOJFA.js.map
