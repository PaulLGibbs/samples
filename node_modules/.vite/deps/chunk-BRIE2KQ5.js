import {
  ...
  n as n4,
  u
} from "./chunk-USVB662P.js";
import {
  o as o4,
  s as s2,
  t as t4
} from "./chunk-JOWPEQFL.js";
import {
  l
} from "./chunk-UQKAOB3Z.js";
import {
  e as e4
...
function E(o8) {
  ...
  i3.include(s2), i3.include(l, o8), i3.include(e4, o8), i3.include(n4), q.include(t3), q.include(e6), i3.varyings.add("vcolor", "vec4"), i3.varyings.add("vtc", "vec2"), i3.varyings.add("vsize", "vec2");
  const k = V2 === n3.Highlight, G = k && o8.occlusionTestEnabled;
  G && i3.varyings.add("voccluded", "float"), I.uniforms.add(new o7("viewport", (e7) => e7.camera.fullViewport), new e5("screenOffset", (o9, i4) => o2(R, 2 * o9.screenOffset[0] * i4.camera.pixelRatio, 2 * o9.screenOffset[1] * i4.camera.pixelRatio)), new e5("anchorPosition", (e7) => U(e7)), new e3("materialColor", (e7) => e7.color), new s3("materialRotation", (e7) => e7.rotation)), w(I), E2 && (I.uniforms.add(new e3("outlineColor", (e7) => e7.outlineColor)), q.uniforms.add(new e3("outlineColor", (e7) => M(e7) ? e7.outlineColor : s), new s3("outlineSize", (e7) => M(e7) ? e7.outlineSize : 0))), o8.horizonCullingEnabled && I.uniforms.add(new o("pointDistanceSphere", (e7, o9) => {
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
  ...
  I.main.add(n2`
    ...
    vsize = inputSize;
  `), q.uniforms.add(new s4("tex", (e7) => e7.texture)), o8.occludedFragmentFade && (q.uniforms.add(new o5("depthMap", (e7) => e7.mainDepth)), q.uniforms.add(new e2("occludedOpacity", (e7) => e7.hudOccludedFragmentOpacity)));
...
function H(o8, i3, r3) {
  o2(r3, o8[0] * (i3[2] - i3[0]) + i3[0], o8[1] * (i3[3] - i3[1]) + i3[1]);
}
var R = n();
...
//# sourceMappingURL=chunk-BRIE2KQ5.js.map
