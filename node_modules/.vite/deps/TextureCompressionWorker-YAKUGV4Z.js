...
function i() {
  return t ?? (t = (async () => {
    const i3 = await import("./basis_encoder-UKMNWKRY.js"), t2 = await i3.default({ locateFile: (i4) => n(`esri/libs/basisu/${i4}`) });
...
function e() {
  return r ?? (r = (async () => {
    const e2 = await import("./dxt_encoder-UB5H6HSG.js");
...
//# sourceMappingURL=TextureCompressionWorker-YAKUGV4Z.js.map
