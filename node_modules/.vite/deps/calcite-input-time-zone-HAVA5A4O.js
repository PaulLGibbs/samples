import "./chunk-JET3ZWYV.js";
import "./chunk-IO23KAKR.js";
import "./chunk-3TDHAIWU.js";
import "./chunk-A6BUWCVR.js";
import "./chunk-R3CB5SWU.js";
import "./chunk-URFH5FCO.js";
import "./chunk-7SCS2GTA.js";
import {
  repeat
} from "./chunk-IIQGM4B5.js";
import "./chunk-NH54YWA6.js";
import "./chunk-OXHEWS3R.js";
import {
  getDateTimeFormat
...
async function getNormalizer(mode) {
  ...
  const { normalize } = await import("./time-zones-KFUUVHHS.js");
  return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
  if (mode === "name") {
    const { groupByName } = await import("./groupByName-BHRGVT4C.js");
  ...
  if (mode === "region") {
    const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
      import("./groupByRegion-VK4GTQ7G.js"),
      import("./region-LSTNTZ7E.js")
    ]);
  ...
  const [{ groupByOffset }, { DateEngine }] = await Promise.all([
    import("./groupByOffset-BEMZUU3G.js"),
    import("./native-FZTW3LAB.js")
  ]);
...
@esri/calcite-components/dist/components/calcite-input-time-zone/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=calcite-input-time-zone-HAVA5A4O.js.map
