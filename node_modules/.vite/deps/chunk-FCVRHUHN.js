...
var h = n();
function u2(t2, r4) {
  const { data: n4, size: i } = t2, o4 = n4.length / i;
  if (o4 <= 0) return;
  const s3 = new tt(t2);
  it(f4, s3.minProj, s3.maxProj), st(f4, f4, 0.5), ot(h, s3.maxProj, s3.minProj);
  const a2 = nt(h), m4 = new rt();
  m4.quality = a2, o4 < 14 && (t2 = new s2(new Float64Array(s3.buffer, 112, 42), 3));
...
function l3(t2, r4, n4, i, o4, s3, e6, a2, c2, f5) {
...
var V = n();
var y = n();
function w(t2, r4, n4, i, o4, s3, e6, a2, c2) {
  M(t2, r4, n4, j, P), void 0 !== j[0] && (ot(b, j, n4), ct(b, b), ot(x2, j, i), ct(x2, x2), ot(I, j, o4), ct(I, I), at(N3, x2, s3), ct(N3, N3), at(V, I, e6), ct(V, V), at(y, b, a2), ct(y, y), Y(t2, N3, s3, x2, b, c2), Y(t2, V, e6, I, x2, c2), Y(t2, y, a2, b, I, c2)), void 0 !== P[0] && (ot(b, P, n4), ct(b, b), ot(x2, P, i), ct(x2, x2), ot(I, P, o4), ct(I, I), at(N3, x2, s3), ct(N3, N3), at(V, I, e6), ct(V, V), at(y, b, a2), ct(y, y), Y(t2, N3, s3, x2, b, c2), Y(t2, V, e6, I, x2, c2), Y(t2, y, a2, b, I, c2));
}
function A(t2, r4, n4) {
  ...
  et(r4, t2.minVert[o4]), et(n4, t2.maxVert[o4]);
}
var g2 = [0, 0, 0];
function q2(t2, r4, n4, i) {
  ...
  for (let c2 = 0; c2 < o4.length; c2 += s3) {
    ...
    const t3 = n4[0] * g2[0] + n4[1] * g2[1] + n4[2] * g2[2], i2 = n4[0] * n4[0] + n4[1] * n4[1] + n4[2] * n4[2], s4 = g2[0] * g2[0] + g2[1] * g2[1] + g2[2] * g2[2] - t3 * t3 / i2;
    s4 > e6 && (e6 = s4, a2 = c2);
  }
  return et(i, o4, a2), e6;
}
var d2 = n3();
function M(t2, r4, n4, i, o4) {
  G2(t2, r4, d2, o4, i);
  const s3 = ht(n4, r4);
...
var p2 = n();
var z2 = n();
function Y(t2, r4, n4, i, o4, s3) {
  if (mt(r4) < m3) return;
  at(F, n4, r4), at(T, i, r4), at(v, o4, r4), S(t2, r4, d2), p2[1] = d2[0], E[1] = d2[1], z2[1] = E[1] - p2[1];
  const e6 = [n4, i, o4], a2 = [F, T, v];
  for (let c2 = 0; c2 < 3; ++c2) {
    S(t2, e6[c2], d2), p2[0] = d2[0], E[0] = d2[1], S(t2, a2[c2], d2), p2[2] = d2[0], E[2] = d2[1], z2[0] = E[0] - p2[0], z2[2] = E[2] - p2[2];
    const n5 = nt(z2);
...
function S(t2, r4, n4) {
  ...
  for (let s3 = 0; s3 < i.length; s3 += o4) {
    ...
    n4[0] = Math.min(n4[0], t3), n4[1] = Math.max(n4[1], t3);
  }
}
function G2(t2, r4, n4, i, o4) {
  const { data: s3, size: e6 } = t2;
  et(i, s3), et(o4, i), n4[0] = ht(_2, r4), n4[1] = n4[0];
  for (let a2 = e6; a2 < s3.length; a2 += e6) {
    const t3 = s3[a2] * r4[0] + s3[a2 + 1] * r4[1] + s3[a2 + 2] * r4[2];
    t3 < n4[0] && (n4[0] = t3, et(i, s3, a2)), t3 > n4[1] && (n4[1] = t3, et(o4, s3, a2));
  }
}
function O3(t2, n4, i) {
  i.center = t2, i.halfSize = g(n4, n4, 0.5), i.quaternion = r3;
}
var k = n();
var B = n();
var C = n();
...
var J = n();
function K(t2, r4, n4) {
  et(k, r4), Math.abs(r4[0]) > Math.abs(r4[1]) && Math.abs(r4[0]) > Math.abs(r4[2]) ? k[0] = 0 : Math.abs(r4[1]) > Math.abs(r4[2]) ? k[1] = 0 : k[2] = 0, mt(k) < m3 && (k[0] = k[1] = k[2] = 1), at(B, r4, k), ct(B, B), at(C, r4, B), ct(C, C), L(t2, r4, B, C, D, H), ot(J, H, D), Z2(r4, B, C, D, H, J, n4);
}
function L(t2, r4, n4, i, o4, s3) {
  S(t2, r4, d2), o4[0] = d2[0], s3[0] = d2[1], S(t2, n4, d2), o4[1] = d2[0], s3[1] = d2[1], S(t2, i, d2), o4[2] = d2[0], s3[2] = d2[1];
}
var Q2 = n();
var R2 = n();
var U = n();
...
var X3 = e5();
function Z2(t2, r4, n4, i, e6, a2, c2) {
  W[0] = t2[0], W[1] = t2[1], W[2] = t2[2], W[3] = r4[0], W[4] = r4[1], W[5] = r4[2], W[6] = n4[0], W[7] = n4[1], W[8] = n4[2], c2.quaternion = ut(X3, W), it(Q2, i, e6), st(Q2, Q2, 0.5), st(R2, t2, Q2[0]), st(U, r4, Q2[1]), it(R2, R2, U), st(U, n4, Q2[2]), c2.center = u(R2, R2, U), c2.halfSize = g(Q2, a2, 0.5);
}
var $ = 7;
var tt = class {
  constructor(t2) {
    ...
    for (let a2 = 0; a2 < s3.length; a2 += e6) {
      let t3 = s3[a2];
      t3 < this.minProj[0] && (this.minProj[0] = t3, i[0] = a2), t3 > this.maxProj[0] && (this.maxProj[0] = t3, o4[0] = a2), t3 = s3[a2 + 1], t3 < this.minProj[1] && (this.minProj[1] = t3, i[1] = a2), t3 > this.maxProj[1] && (this.maxProj[1] = t3, o4[1] = a2), t3 = s3[a2 + 2], t3 < this.minProj[2] && (this.minProj[2] = t3, i[2] = a2), t3 > this.maxProj[2] && (this.maxProj[2] = t3, o4[2] = a2), t3 = s3[a2] + s3[a2 + 1] + s3[a2 + 2], t3 < this.minProj[3] && (this.minProj[3] = t3, i[3] = a2), t3 > this.maxProj[3] && (this.maxProj[3] = t3, o4[3] = a2), t3 = s3[a2] + s3[a2 + 1] - s3[a2 + 2], t3 < this.minProj[4] && (this.minProj[4] = t3, i[4] = a2), t3 > this.maxProj[4] && (this.maxProj[4] = t3, o4[4] = a2), t3 = s3[a2] - s3[a2 + 1] + s3[a2 + 2], t3 < this.minProj[5] && (this.minProj[5] = t3, i[5] = a2), t3 > this.maxProj[5] && (this.maxProj[5] = t3, o4[5] = a2), t3 = s3[a2] - s3[a2 + 1] - s3[a2 + 2], t3 < this.minProj[6] && (this.minProj[6] = t3, i[6] = a2), t3 > this.maxProj[6] && (this.maxProj[6] = t3, o4[6] = a2);
    }
    for (let a2 = 0; a2 < $; ++a2) {
      let t3 = i[a2];
      et(this.minVert[a2], s3, t3), t3 = o4[a2], et(this.maxVert[a2], s3, t3);
    }
  }
};
var rt = class {
...
function it(t2, r4, n4) {
  t2[0] = r4[0] + n4[0], t2[1] = r4[1] + n4[1], t2[2] = r4[2] + n4[2];
}
function ot(t2, r4, n4) {
  t2[0] = r4[0] - n4[0], t2[1] = r4[1] - n4[1], t2[2] = r4[2] - n4[2];
}
function st(t2, r4, n4) {
  t2[0] = r4[0] * n4, t2[1] = r4[1] * n4, t2[2] = r4[2] * n4;
}
function et(t2, r4, n4 = 0) {
  t2[0] = r4[n4], t2[1] = r4[n4 + 1], t2[2] = r4[n4 + 2];
}
function at(t2, r4, n4) {
  const i = r4[0], o4 = r4[1], s3 = r4[2], e6 = n4[0], a2 = n4[1], c2 = n4[2];
  t2[0] = o4 * c2 - s3 * a2, t2[1] = s3 * e6 - i * c2, t2[2] = i * a2 - o4 * e6;
}
function ct(t2, r4) {
...
function ft(t2, r4) {
  const n4 = r4[0] - t2[0], i = r4[1] - t2[1], o4 = r4[2] - t2[2];
...
function ut(t2, r4) {
  ...
  if (n4 > 0) {
    ...
    t2[n5] = 0.5 * s3, s3 = 0.5 / s3, t2[3] = (r4[3 * i + o4] - r4[3 * o4 + i]) * s3, t2[i] = (r4[3 * i + n5] + r4[3 * n5 + i]) * s3, t2[o4] = (r4[3 * o4 + n5] + r4[3 * n5 + o4]) * s3;
  }
  return t2;
}
...
var I2 = class _I {
  constructor(t2 = _, a2 = gt, e6 = r3) {
    this._data = [t2[0], t2[1], t2[2], a2[0], a2[1], a2[2], e6[0], e6[1], e6[2], e6[3]];
  }
  clone() {
    const t2 = new _I();
  ...
  setCenter(t2, a2, e6) {
    this._data[0] = t2, this._data[1] = a2, this._data[2] = e6;
  }
  get halfSize() {
  ...
  get radius() {
    const t2 = this._data[3], a2 = this._data[4], e6 = this._data[5];
    return Math.sqrt(t2 * t2 + a2 * a2 + e6 * e6);
  }
  intersectSphere(t2) {
    X4[0] = this._data[0] - t2[0], X4[1] = this._data[1] - t2[1], X4[2] = this._data[2] - t2[2];
    const a2 = this.getQuaternion(T2);
    return O(O4, a2), Q(X4, X4, O4), f2(X4, X4), Y2[0] = Math.min(X4[0], this._data[3]), Y2[1] = Math.min(X4[1], this._data[4]), Y2[2] = Math.min(X4[2], this._data[5]), X(Y2, X4) < t2[3] * t2[3];
  }
  intersectSphereWithMBS(t2, a2 = this.radius) {
    const e6 = this._data;
    X4[0] = e6[0] - t2[0], X4[1] = e6[1] - t2[1], X4[2] = e6[2] - t2[2];
    const s3 = t2[3], i = s3 + a2;
  ...
  intersectPlane(t2) {
    const a2 = t2[0] * this._data[0] + t2[1] * this._data[1] + t2[2] * this._data[2] + t2[3], e6 = this.projectedRadius(O2(t2));
    return a2 > e6 ? 1 : a2 < -e6 ? -1 : 0;
  }
  intersectRay(t2, a2, e6 = 0) {
    ...
    for (let d3 = 0; d3 < 3; d3++) {
      const t3 = r4[d3], a3 = n4[d3], s4 = c2[d3] + e6;
      if (Math.abs(a3) > 1e-6) {
        const e7 = (s4 - t3) / a3, i2 = (-s4 - t3) / a3;
  ...
  projectedRadius(t2) {
    const a2 = this.getQuaternion(T2);
    return O(O4, a2), Q(X4, t2, O4), Math.abs(X4[0] * this._data[3]) + Math.abs(X4[1] * this._data[4]) + Math.abs(X4[2] * this._data[5]);
  }
  ...
  transform(t2, a2, e6, s3 = 0, i = a(e6), r4 = a(a2), n4 = G(a2, r4)) {
    if (e6 === i) a2.isGeographic ? st2(this, t2, a2, s3, r4) : et2(this, t2, a2, s3, r4, n4);
    else if (a2.isWGS84 && (e6.isWebMercator || f(e6))) $2(a2, this, e6, t2, s3);
    else if (a2.isWebMercator && f(e6)) tt2(a2, this, e6, t2, s3);
    else {
      const i2 = this.getCenter(ot2);
      i2[2] += s3, o(i2, a2, 0, i2, e6, 0), t2.center = i2, this !== t2 && (t2.quaternion = this.getQuaternion(T2), t2.halfSize = this.getHalfSize(ct2));
    }
  }
};
var O4 = e5();
...
var K2 = (() => {
  ...
  let a2 = 0;
  const e6 = (e7) => {
    for (let s3 = 0; s3 < e7.length; s3++) t2[a2 + s3] = e7[s3];
    a2 += 6;
  };
...
function L2(t2, a2, e6, s3, i) {
  const n4 = t2.getQuaternion(T2);
  ...
  if (s3 === l2.Global) {
    ...
    if (s4 < e6) i.center = o4, o2(mt2, e6, e6, e6), i.halfSize = u(mt2, h2, mt2);
      ...
      g(ut2, ft2, _3), i.halfSize = q(ut2, ut2, h2, c2), g(ut2, ft2, c2), q(ut2, ut2, h2, _3), m(mt2, mt2), e3(mt2, ut2, mt2);
    ...
    const t3 = Q(mt2, N, O4);
    f2(t3, t3), i.halfSize = q(ft2, h2, t3, (e6 - a2) / 2);
  }
  return i;
}
function $2(t2, a2, e6, s3, i) {
  a2.getCenter(ot2), ot2[2] += i;
  const r4 = a(e6);
  o(ot2, t2, 0, ot2, r4, 0), at2(r4, a2, ot2, e6, s3);
}
function tt2(t2, a2, e6, s3, i) {
  a2.getCenter(ot2), ot2[2] += i, at2(t2, a2, ot2, e6, s3);
}
function at2(a2, e6, s3, i, r4) {
  ...
  for (let t2 = 0; t2 < 8; ++t2) {
    ...
    for (let a3 = 0; a3 < 3; ++a3) {
      let e7 = s3[a3];
      for (let t3 = 0; t3 < 3; ++t3) e7 += nt2[t3] * o4[3 * t3 + a3];
      it2[3 * t2 + a3] = e7;
    }
  }
  o(it2, a2, 0, it2, i, 0, 8), J2(rt2, r4);
}
function et2(t2, a2, e6, s3, i = a(e6), o4 = G(e6, i)) {
  t2.getCorners(lt), t2.getCenter(nt2), nt2[2] += s3, m2(e6, nt2, _t, i), a2.setCenter(_t[12], _t[13], _t[14]);
...
function st2(t2, a2, e6, s3, i = a(e6)) {
  const n4 = s(e6), o4 = 1 + Math.max(0, s3) / (n4.radius + t2.centerZ);
  t2.getCenter(nt2), nt2[2] += s3, o(nt2, e6, 0, nt2, i, 0), a2.center = nt2;
  const h2 = t2.getQuaternion(T2);
  a2.quaternion = h2, O(O4, h2), o2(mt2, 0, 0, 1), Q(mt2, mt2, O4);
  const _3 = t2.getHalfSize(ct2);
...
//# sourceMappingURL=chunk-FCVRHUHN.js.map
