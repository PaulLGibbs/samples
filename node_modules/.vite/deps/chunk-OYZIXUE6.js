...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-4JG6MEYL.js");
    if (t3(r)) return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-A6R3RIVE.js");
    if (t3(r)) return a2(r, e);
  }
...
//# sourceMappingURL=chunk-OYZIXUE6.js.map
