...
function t(t2, e2) {
  ...
  if (null == u2 && n(t2)) return true;
  if (null == u2 || r2 > 1) return false;
  if (e2) {
    if (null == u2.fields.find((n2) => n2.name.toLowerCase() === e2.toLowerCase())) return false;
  }
  return true;
}
function e(n2) {
...
function a(n2) {
  return !!(n2 == null ? void 0 : n2.length) && n2.length <= 16384;
}
...
//# sourceMappingURL=chunk-TQSG64Z5.js.map
