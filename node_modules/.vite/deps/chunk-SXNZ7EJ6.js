...
function s5(e3, r2, o3) {
  ...
  if ("string" == typeof n4) {
    ...
    if (s7.includes(".") && 0 === s7.indexOf(r2) && s2(s7, o3)) return true;
  }
  return false;
}
function i(e3) {
...
function f(e3, t3, r2, n4, f3) {
  let a6 = s4(t3[r2], f3);
  i(a6) && (e3[r2] = true);
  for (const i2 of Object.getOwnPropertyNames(t3)) a6 = s4(t3[i2], f3), s5(a6, r2, n4) && (e3[i2] = true);
}
function a4(e3, t3, r2, o3) {
  const s7 = r2.metadata, i2 = o2(s7[t3], o3), f3 = i2 == null ? void 0 : i2.default;
  if (void 0 === f3) return;
  const a6 = "function" == typeof f3 ? f3.call(e3, t3, o3) : f3;
  void 0 !== a6 && r2.set(t3, a6);
}
var c = { origin: "service" };
function u4(t3, n4, s7 = c) {
  if (!n4 || "object" != typeof n4) return;
  const i2 = t(t3), u6 = i2.metadata, d3 = {};
  for (const e3 of Object.getOwnPropertyNames(n4)) f(d3, u6, e3, n4, s7);
  i2.setDefaultOrigin(s7.origin);
  for (const r2 of Object.getOwnPropertyNames(d3)) {
    const f3 = s4(u6[r2], s7).read, a6 = f3 == null ? void 0 : f3.source;
    let c3;
...
function f2(r2, o3, u6, l, a6, p2) {
  ...
  if ((null === f3 && !a6.allowNull && !a6.writerEnsuresNonNull || void 0 === f3) && a6.isRequired) {
    const i2 = new s3("web-document-write:property-required", `Missing value for required property '${u6}' on '${r2.declaredClass}'`, { propertyName: u6, target: r2 });
  ...
  if (!a6.alwaysWriteDefaults && (!o3.store.multipleOriginsSupported || o3.store.originOf(u6) === e.DEFAULTS) && c2(r2, u6, p2, l, f3)) return false;
...
function g2(r2, e3, t3, i2) {
  ...
  return !!s7 && f2(r2, o3, e3, s7, t3, i2);
}
function d2(r2, e3, t3) {
  var _a, _b;
  ...
  for (const u6 in s7) {
    ...
    if (!f2(r2, n4, u6, c3, void 0, t3)) continue;
    const g3 = o(r2, u6), d3 = p(r2, c3, c3.write && "string" == typeof c3.write.target ? c3.write.target : u6, g3, t3);
...
var u5 = (t3) => {
  let u6 = class extends t3 {
    constructor(...r2) {
      super(...r2);
      const t4 = t(this), e3 = t4.store, c3 = new s6();
...
//# sourceMappingURL=chunk-SXNZ7EJ6.js.map
