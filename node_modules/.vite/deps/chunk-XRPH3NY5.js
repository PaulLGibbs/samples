import {
  ...
  w,
  w2
} from "./chunk-VZGRED5R.js";
import {
  t
} from "./chunk-6C4A4LWB.js";
import {
  C
...
import {
  m as m3
} from "./chunk-6CM6CYUF.js";
import {
  y
} from "./chunk-MECOLJTX.js";
import {
  S as S2
} from "./chunk-TY42MOB7.js";
import {
  f as f3
...
var B2 = class _B extends I2 {
  ...
  evaluateNodeToWhereClause(e3, t5, r3 = null, s5 = null, a6) {
    ...
    switch (e3.type) {
      ...
      case "binary-expression":
        switch (e3.operator) {
          ...
          case "IS":
            if ("null" !== e3.right.type) throw new n2(a.UnsupportedIsRhs);
    ...
    throw new n2(a.UnsupportedSyntax, { node: e3.type });
  }
  extractValue(e3) {
...
function s4(s5) {
  if ("function" === s5.parseTree.type) {
    ...
    if (s5.parseTree.args.value.length > 1) throw new n2(a.MissingStatisticParameters);
...
var a4 = class _a {
  ...
  static parseStatField(e3, t5, o3, l3) {
    ...
    if (null === p3) throw new n2(a.UnsupportedSqlFunction, { function: "" });
    const c5 = p3.name.toUpperCase().trim();
    if ("MIN" === c5) {
      if (f5.typeofstat = "MIN", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "min" });
    } else if ("MAX" === c5) {
      if (f5.typeofstat = "MAX", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "max" });
    } else if ("COUNT" === c5) f5.typeofstat = "COUNT", f5.workingexpr = p3.expr;
    else if ("STDEV" === c5) {
      if (f5.typeofstat = "STDDEV", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "stdev" });
    } else if ("SUM" === c5) {
      if (f5.typeofstat = "SUM", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "sum" });
    } else if ("MEAN" === c5) {
      if (f5.typeofstat = "AVG", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: c5 });
    } else if ("AVG" === c5) {
      if (f5.typeofstat = "AVG", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "avg" });
    } else {
      if ("VAR" !== c5) throw new n2(a.UnsupportedSqlFunction, { function: c5 });
      if (f5.typeofstat = "VAR", f5.workingexpr = p3.expr, null === u2) throw new n2(a.InvalidFunctionParameters, { function: "var" });
    }
    return f5;
  }
  toStatisticsName() {
      ...
      if (r3 == null ? void 0 : r3.relatedRecordGroups) {
        ...
        for (const s6 of r3.relatedRecordGroups) {
          ...
          for (const t7 of s6.relatedRecords) {
            ...
            const r4 = new b({ geometry: t7.geometry ? f2(t7.geometry) : null, attributes: t7.attributes });
            n5.push(r4);
          }
...
var p2 = class _p extends S4 {
  ...
  static create(e3, t5) {
    ...
    if ("esriGeometryNull" !== u2) for (const y2 of l3) y2.geometry && y2.geometry instanceof n3 == false && (y2.geometry.type = u2, void 0 === y2.geometry.spatialReference && (y2.geometry.spatialReference = n5));
...
//# sourceMappingURL=chunk-XRPH3NY5.js.map
