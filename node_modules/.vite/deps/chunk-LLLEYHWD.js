...
import {
  ...
  j as j3,
  x
} from "./chunk-HFBJAOLH.js";
import {
  l
} from "./chunk-DA3A4FWF.js";
import {
  t
} from "./chunk-SPOZLHG6.js";
import {
  a as a2
} from "./chunk-N66XIKGA.js";
import {
  C
...
function T(T2) {
  "async" === T2.mode && (T2.functions.disjoint = function(n2, t2) {
    ...
    return T2.standardFunctionAsync(n2, t2, (a3, s, c) => {
    ...
    return T2.standardFunctionAsync(n2, t2, async (o3, s, c) => {
    ...
    return T2.standardFunctionAsync(n2, t2, async (a3, s, c) => {
    ...
    return T2.standardFunctionAsync(n2, t2, async (s, c, l2) => {
      if (l2 = Fe(l2), oe(l2, 2, 2, n2, t2), !(l2[1] instanceof P) && null !== l2[1]) throw new a(n2, r.InvalidParameter, t2);
      if (null === l2[0]) return [];
    ...
    return T2.standardFunctionAsync(n2, t2, async (a3, s, c) => {
      ...
      if (!(l2 instanceof n)) throw new a(n2, r.InvalidParameter, t2);
      if (true === l2.hasZ) {
        const { convertFromSpatialReferenceUnit: n3, toLengthUnit: t3 } = await import("./unitConversion-T6BZ76QE.js"), e = P2(l2);
    ...
    return T2.standardFunctionAsync(n2, t2, async (a3, s, c) => {
      ...
      const f2 = new P({ paths: [], spatialReference: l2.spatialReference });
    ...
    return T2.standardFunctionAsync(n2, t2, async (a3, s, c) => {
      ...
      if (!(c[0] instanceof j2 || c[0] instanceof P)) throw new a(n2, r.InvalidParameter, t2);
      const l2 = be(c[1]);
      if (isNaN(l2)) throw new a(n2, r.InvalidParameter, t2);
    ...
    return T2.standardFunctionAsync(a3, i, async (s, c, l2) => {
      var _a, _b;
      oe(l2, 0, 2, a3, i);
    ...
    return T2.standardFunctionAsync(n2, a3, async (s, c, l2) => {
...
//# sourceMappingURL=chunk-LLLEYHWD.js.map
