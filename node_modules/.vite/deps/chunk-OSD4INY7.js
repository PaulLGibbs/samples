...
function U2({ start: t3, end: o4, type: c4 }, i2, u2) {
  const a2 = [], f3 = e3(et, o4, t3), m3 = e3(ot, t3, i2), L = p3(f3), h2 = 2 * j3(f3, m3), A3 = h2 * h2 - 4 * L * (p3(m3) - u2 * u2);
  if (0 === A3) {
    const n4 = -h2 / (2 * L);
...
function k2(t3, r4) {
  const e4 = t3.start, c4 = t3.end, i2 = e3(et, c4, e4), u2 = o2(it, -i2[1], i2[0], 0), a2 = r4.start, f3 = r4.end, p4 = R(ut, f3, a2), m3 = P(p4, u2), L = o2(at, e4[0], e4[1], 0), E3 = R(ft, L, a2), N4 = P(E3, u2), y2 = e();
...
var O3 = (() => {
  ...
  return ({ start: s5, end: e4 }, { center: o4, radius: c4, normal: i2, slicePlane: u2 }) => {
    ...
    if ($2(Q(a2, s5), 0) && $2(Q(a2, e4), 0)) {
      q2(i2, t3, n4);
      const a3 = (s6, e5) => (c(r4, e5, o4), o3(s6, P(r4, t3), P(r4, n4)), s6), p5 = d3({ start: a3(et, s5), end: a3(ot, e4), type: j5.LINE }, l2, c4), m3 = [];
...
function Q2({ start: t3, end: e4, type: o4 }, c4, i2) {
  const u2 = [], a2 = c(ct, e4, t3), f3 = e3(ot, t3, c4), p4 = p3(a2), m3 = 2 * j3(a2, f3), L = m3 * m3 - 4 * p4 * (p3(f3) - i2 * i2);
  if (0 === L) {
    const n4 = -m3 / (2 * p4);
...
function W(t3, n4, r4, s5) {
  ...
  const h2 = (n4 * n4 - s5 * s5 + p4) / (2 * L), A3 = Math.sqrt(n4 * n4 - h2 * h2), d6 = A3 * f3 / L, l4 = A3 * u2 / L, [E3, N4] = _3(et, t3, r4, h2 / L);
...
var Pt = class extends mt2 {
  ...
  asCircle() {
    return new zt(v2(this.center), this.radius, d4(0, 0, 1));
  }
};
var zt = class extends mt2 {
  ...
  closestTo(t3) {
    ...
    const i2 = s5 / Math.sqrt(n4), o4 = c3();
    q(o4, e4, r4, i2);
...
var jt = class extends mt2 {
  ...
  closestEndTo(t3) {
    ...
    return Math.sign(j3(e3(vt, s5, e4), e3(At2, s4(t3), e4))) > 0 ? this.end : this.start;
  }
  getPlane(t3 = M()) {
...
var It = class extends mt2 {
  constructor(t3, e4) {
    super(), this.sphere = O(t3, e4);
  }
  equals(t3) {
    return this === t3 || Te(t3) && _2(this.sphere, t3.sphere);
  }
  closestTo(t3) {
    const e4 = c3();
...
var Jt = (() => {
  ...
  return (n4, i2, o4) => {
    ...
    q2(c4, e4, r4);
    const f3 = O2(n4), l4 = h2 * P(f3, e4), d6 = h2 * P(f3, r4);
...
function Qt({ z: t3 }, { planeLike: e4 }) {
  const [s5, r4] = e4.start, [n4, i2] = e4.end, o4 = d4(s5, r4, t3), c4 = d4(n4, i2, t3);
  return e4.type === rt.PLANE ? new Lt2(o4, c4) : new kt(o4, c4);
}
function Wt(t3, e4) {
  const [s5, r4] = e4.center;
  return new Pt(d4(s5, r4, t3.z), e4.radius);
}
function Xt(t3, e4) {
...
function te(t3, { center: e4, radius: s5 }) {
  ...
  const n4 = d4(e4[0], e4[1], t3.z), i2 = Math.sqrt(s5 ** 2 - r4 ** 2);
...
function de(t3) {
  return ge(t3.map(([t4, e4]) => {
    const s5 = d4(t4, e4, 0), r4 = d4(t4, e4, 1);
...
function N3(n4, r4 = () => {
  ...
  const o4 = d(() => ({ view: n4.view, snappingOptions: n4.snappingOptions }), ({ view: e4, snappingOptions: t3 }) => {
    ...
    const o5 = _4.TOOL, i2 = [e4.on("key-down", (e5) => {
      e5.key !== c2.toggle || e5.repeat || (t3.enabledToggled = true, r4());
    }, o5), e4.on("key-up", (e5) => {
      e5.key === c2.toggle && (t3.enabledToggled = false, r4());
...
//# sourceMappingURL=chunk-OSD4INY7.js.map
