...
function l(i2) {
  return (i2 == null ? void 0 : i2.listMode) === n.hideChildren;
}
function u(n2) {
  return (n2 == null ? void 0 : n2.listMode) ?? void 0;
}
function o(n2) {
...
function s(n2) {
  n2 == null ? void 0 : n2.removeMany(n2.filter((n3) => n3 == null ? void 0 : n3.destroyed));
}
function d(n2) {
...
function y(n2) {
  const i2 = ((n2 == null ? void 0 : n2.layer) && x(n2.layer) ? n2.layer.layer : void 0) ?? (n2 == null ? void 0 : n2.layer);
...
function m(n2) {
  const i2 = n2 == null ? void 0 : n2.layer;
...
function N(n2) {
  return n2 == null ? void 0 : n2["data-item"];
}
function q(n2) {
  return n2 == null ? void 0 : n2.getAttribute("data-layer-type");
}
function w(n2) {
  const { children: i2, error: e2 } = n2, t2 = "incompatible" in n2 && n2.incompatible;
  return !!(i2 == null ? void 0 : i2.filter((n3) => !n3.hidden).length) && !e2 && !t2;
}
function k(n2) {
...
//# sourceMappingURL=chunk-XU5FXLLK.js.map
