...
function n2(t3) {
  ...
  for (let l3 = 0; l3 < t3.length; l3++) {
    const s = t3[l3];
    u2 ? '"' === s ? '"' === t3[l3 + 1] ? (n3 += `\\${s}`, l3 += 1) : u2 = false : n3 += s : /\s/.test(s) || ("," === s ? (r5 += "" !== n3 ? e2(n3) + "," : ",", n3 = "") : ")" === s || "]" === s ? (r5 += "" !== n3 ? e2(n3) + "]}" : "]}", n3 = "") : "(" === s || "[" === s ? (r5 += '{ "entity": "' + n3.toUpperCase().trim() + '", "values":[', n3 = "") : '"' === s ? (u2 = true, n3 = "") : n3 += s);
  }
...
function m(e3) {
  ...
  if (null != r5) {
    ...
    return B.has(r5) ? o2("angular", 9105) : o2("angular", 9102);
  }
...
function f(e3) {
  ...
  return null == r5 ? null : o2("area", r5);
}
function q(n3) {
  if (null != n3) {
    if ("number" == typeof n3) return c.get(n3) ?? p.get(n3) ?? t.get(n3);
    if ("string" != typeof n3) throw new a(null, r2.InvalidParameter, null);
    switch (n3.toLowerCase().replaceAll(/[\s-]+/g, "")) {
      case "meters":
      case "meter":
      case "m":
      case "squaremeters":
...
function d(n3) {
  if (null != n3) {
    if ("number" == typeof n3) return p.get(n3) ?? t.get(n3) ?? c.get(n3);
    if ("string" != typeof n3) throw new a(null, r2.InvalidParameter, null);
    switch (n3.toLowerCase().replaceAll(/[\s-]+/g, "")) {
      case "meters":
      case "meter":
...
function p2(e3, r5, a3) {
  ...
  const t3 = "area" === r5.type && "linear" === s.type ? f(s) : s;
...
function w2(e3, r5, a3) {
  ...
  const s = m(r5);
  if (null == s) throw new Error("Unknown spatial reference unit.");
  const t3 = "area" === e3.type && "linear" === s.type ? f(s) : s;
  if (null == t3) throw new Error(`Unknown spatial reference ${e3.type} unit.`);
  return g(e3, t3, a3);
}
function h(e3, r5, a3) {
  return null == e3 || null == r5 ? a3 : g(e3, r5, a3);
}
...
//# sourceMappingURL=chunk-T7SCZJBZ.js.map
