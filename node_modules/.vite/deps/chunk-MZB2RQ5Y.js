...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-YKZXCL47.js"), import("./ProjectionTransformation-UC2Q56AR.js").then((e2) => e2.aG).then(({ injectPe: e2 }) => e2), _()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-TGAY6GJM.js"), i()]);
...
//# sourceMappingURL=chunk-MZB2RQ5Y.js.map
