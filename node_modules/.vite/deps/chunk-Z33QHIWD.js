...
function E(e4) {
  return null == e4 ? "" : o(e4) || ee(e4) ? "Array" : te(e4) ? "Date" : re(e4) ? "Time" : ne(e4) ? "DateOnly" : e2(e4) ? "String" : t(e4) ? "Boolean" : n2(e4) ? "Number" : "esri.arcade.Attachment" === (e4 == null ? void 0 : e4.declaredClass) ? "Attachment" : "esri.arcade.Portal" === (e4 == null ? void 0 : e4.declaredClass) ? "Portal" : "esri.arcade.Dictionary" === (e4 == null ? void 0 : e4.declaredClass) ? "Dictionary" : X(e4) ? "KnowledgeGraph" : e4 instanceof s2 ? "Module" : H(e4) ? "Feature" : e4 instanceof j ? "Point" : e4 instanceof j2 ? "Polygon" : e4 instanceof P2 ? "Polyline" : e4 instanceof u ? "Multipoint" : e4 instanceof w ? "Extent" : G(e4) ? "Function" : B(e4) ? "FeatureSet" : Q(e4) ? "FeatureSetCollection" : $(e4) ? "Voxel" : e4 === v ? "" : "number" == typeof e4 && isNaN(e4) ? "Number" : "Unrecognized Type";
}
function U(e4) {
...
function oe(e4, t3, n4, r6, i4) {
  if (e4.length < t3 || e4.length > n4) throw new a(r6, r4.WrongNumberOfParameters, i4);
}
function ae(e4) {
...
function ce(e4, t3, r6) {
  ...
  if (e4 === v) {
    ...
    if (re(t3)) throw new a(null, r4.CannotCompareDateAndTime, null);
    ...
    if (te(t3)) throw new a(null, r4.CannotCompareDateAndTime, null);
    if (null === t3 || t3 === v) return fe(e4.toNumber(), 0, r6);
    if (n2(t3)) return fe(e4.toNumber(), t3, r6);
    if (t(t3)) return fe(e4.toNumber(), be(t3), r6);
    if (e2(t3)) return fe(e4.toNumber(), be(t3), r6);
    if (re(t3)) return fe(e4.toNumber(), t3.toNumber(), r6);
    if (ne(t3)) throw new a(null, r4.CannotCompareDateAndTime, null);
  }
...
function Oe(e4, t3, n4 = null, r6 = null) {
  ...
  if (null === s4) throw new a(null, r4.FieldNotFound, null, { key: e4 });
...
function we(e4, t3) {
  if (!(t3 instanceof j)) throw new a(null, r4.InvalidParameter, null);
...
function Je(e4, t3) {
  if (o(e4) || ee(e4)) {
    ...
    if (o(e4)) {
      ...
      if (!ee(e4)) throw new a(null, r4.InvalidParameter, null);
    ...
    return a2(i4) || (i4 = i4.slice().reverse()), new j2({ rings: [i4], spatialReference: u2, hasZ: n4, hasM: r6 });
  }
  return e4;
}
function Me(e4, t3) {
  if (o(e4) || ee(e4)) {
    ...
    return 0 === i4.length ? null : new P2({ paths: [i4], spatialReference: o2, hasZ: n4, hasM: r6 });
  }
  return e4;
}
function Re(e4, t3) {
...
function Ke(e4) {
  ...
  return { objectIdField: t3.objectIdField, globalIdField: t3.globalIdField ?? "", geometryType: void 0 === P[t3.geometryType] ? "" : P[t3.geometryType], fields: n4 };
}
function We(r6, i4) {
...
//# sourceMappingURL=chunk-Z33QHIWD.js.map
