...
var o2 = class extends i {
  constructor(e2, o3) {
    super(e2, "ivec2", a.Bind, (r, i2) => r.setUniform2iv(e2, o3(i2)));
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/core/shaderLibrary/output/OutputHighlight.glsl.js
function d(d2, u) {
  const { fragment: o3 } = d2;
  u.output === n2.Highlight ? (o3.uniforms.add(new o("depthTexture", (i2) => i2.mainDepth), new o("highlightTexture", (i2) => i2.highlightMixTexture), new e("highlightLevel", (i2) => i2.highlightLevel ?? 0), new o2("highlightMixOrigin", (i2) => i2.highlightMixOrigin)), d2.outputs.add("fragHighlight", "vec2", 0), d2.include(l), o3.code.add(n`vec2 getAccumulatedHighlight() {
...
}`), u.canHaveOverlay && o3.code.add(n`void calculateOcclusionAndOutputHighlightOverlay(vec2 highlightToAdd) {
uint levelBits = readLevelBits(highlightToAdd, highlightLevel);
if ((levelBits & 1u) == 0u) { discard; }
outputHighlight(isHighlightOccluded());
}`)) : o3.code.add(n`void calculateOcclusionAndOutputHighlight() {}`);
}

export {
  d
};
//# sourceMappingURL=chunk-4FJV3US7.js.map
