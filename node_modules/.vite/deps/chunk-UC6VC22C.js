...
import {
  ...
  xt,
  zt
} from "./chunk-TRKOXT2M.js";
import {
  n as n4
} from "./chunk-FKVY332J.js";
import {
  A,
  B as B2,
  C as C2,
  ...
  u as u2,
  x
} from "./chunk-2PA4VNAJ.js";
import {
  te
} from "./chunk-2DQ7B4Z5.js";
import {
  c,
  t as t3
} from "./chunk-UDL7S726.js";
import {
  e as e2
...
import {
  _
} from "./chunk-4SWL27WH.js";
import {
  i as i4,
  s as s5,
  x as x2
} from "./chunk-EQOMBUGF.js";
import {
  E as E3,
  o as o4
} from "./chunk-CZQ5YR7Y.js";
import {
  t as t2
...
var o5 = class {
  constructor(t11, s9) {
    ...
    for (const o13 in s9.vertex) {
      const { data: i8, attributes: n14 } = s9.vertex[o13], f12 = E3.createVertex(t11, F.STATIC_DRAW, i8);
      this.vertexBuffers.set(o13, { buffer: f12, attributes: n14 });
    }
    for (const o13 in s9.index) {
      const { data: i8 } = s9.index[o13], n14 = E3.createIndex(t11, F.STATIC_DRAW, i8);
  ...
  bind(e9, r7, s9) {
    var _a;
    this._boundPart = s9;
    const { group: o13 } = this.parts[this._boundPart], i8 = this.groups[o13];
    if (!i8) throw new Error(`Missing group ${o13}.`);
    let n14 = i8.vertexArrays.get(r7.stringHash);
    if (!n14) {
      const s10 = new Set(r7.locations.keys()), o14 = i8.index ? (_a = this.indexBuffers.get(i8.index)) == null ? void 0 : _a.buffer : null, f12 = /* @__PURE__ */ new Map(), u13 = /* @__PURE__ */ new Map();
      ...
      n14 = new o4(e9, r7.locations, f12, u13, o14), i8.vertexArrays.set(r7.stringHash, n14);
    }
    e9.bindVAO(n14);
  }
  draw(e9) {
    if (null == this._boundPart) throw new Error("Mesh.bind() has not been called.");
    const { start: r7, count: t11 } = this.parts[this._boundPart], { group: o13 } = this.parts[this._boundPart], { primitive: i8, index: n14 } = this.groups[o13];
    if (n14) {
      ...
      e9.drawElements(i8, t11, f12, r7 * T[f12]);
    } else e9.drawArrays(i8, r7, t11);
  }
  unbind(e9) {
...
var s6 = class _s extends o5 {
  static create(e9, r7) {
    ...
    if (null == o13) {
      o13 = 0;
      for (const [e10, { count: i9, type: n14, offset: s9 }] of Object.entries(r7.layout)) {
    ...
    for (const [s9, { count: d10, offset: f12, type: m17, normalized: x8 }] of Object.entries(r7.layout)) {
      ...
      i8.push(e10), a6 += d10 * T[m17];
    }
    const l7 = { primitive: r7.primitive };
    null != r7.index && (l7.index = "indexData");
    let { count: u13 } = r7;
    ...
    const c8 = { start: 0, count: u13, group: 0, primitive: r7.primitive }, p16 = { vertex: { vertexData: { data: r7.vertex, attributes: i8 } }, parts: [c8], groups: [l7] };
...
function b(t11) {
  const e9 = st(12.9898), f12 = st(78.233), s9 = st(43758.5453), l7 = pe(t11, ot(e9, f12)), m17 = Ce(l7, st(3.14));
...
function A2(t11) {
  const r7 = v2(t11.z, 7), u13 = st(1).subtract(r7), i8 = t11.xyz.subtract(lt(0, 0, st(128)));
  return u13.multiply(t11).add(r7.multiply(i8));
}
function B4(t11) {
...
var p3 = class extends P {
  ...
  getAttributeDataCoords(t11) {
    if (!this._uv) {
      const a6 = A2(t11), e9 = this.size, i8 = ut(a6.x), u13 = ut(a6.y).multiply(ut(256)), l7 = ut(a6.z).multiply(ut(256)).multiply(ut(256)), n14 = st(i8.add(u13).add(l7)), p16 = Ce(n14, e9), d10 = n14.subtract(p16).divide(e9);
...
var B5 = class extends j {
  clip(t11, i8) {
    ...
    if (e9 = e9.add(st(2).multiply(st(1).subtract(k2(o13, 0)))), this.inside ? e9 = e9.add(st(2).multiply(st(1).subtract(k2(o13, 1)))) : this.outside ? e9 = e9.add(st(2).multiply(k2(o13, 1))) : this.highlight && (e9 = e9.add(st(2).multiply(st(1).subtract(this._checkHighlight(o13))))), null != i8) {
      const t12 = new _3(1).subtract(sn(i8.x, this.view.currentZoom)), o14 = sn(i8.y, this.view.currentZoom);
      e9 = e9.add(new _3(2).multiply(t12.add(o14)));
    }
    return e9;
  }
  getFragmentOutput(t11, i8, e9 = new _3(1 / 255)) {
    const o13 = new w3();
    return o13.fragColor = this._maybeWriteHittest(i8) ?? this._maybeHighlight(t11, e9) ?? t11, o13;
  }
  _maybeHighlight(t11, i8) {
    return this.highlight ? new Y(t11.rgb, sn(i8, t11.a)) : null;
  }
  _checkHighlight(t11) {
  ...
  _checkHighlightBit(t11, i8) {
    return q2(t11, i8).multiply(v2(this.highlight.activeReasons, i8));
  }
  maybeRunHittest(t11, i8, e9) {
    if (null == this.hittestRequest) return null;
    const o13 = this.hittest(t11, i8, e9);
    ...
    const l7 = new Y(new _3(1 / 255), 0, 0, 0);
    return { glPointSize: new _3(1), glPosition: new Y(h11, s9, 1), color: l7 };
  }
...
var f2 = class extends P {
  getColor(s9, t11, o13) {
    return Tt([Ht(w4(s9), o13), t11], [Xt(s9, this.values.first()), this.colors.first()], [Gt(s9, this.values.last()), this.colors.last()], [true, () => {
      const t12 = this.values.findIndex((t13) => Yt(t13, s9)), o14 = this.values.get(t12), r7 = t12.subtract(1), e9 = this.values.get(r7), i8 = s9.subtract(e9).divide(o14.subtract(e9));
      return _e(this.colors.get(r7), this.colors.get(t12), i8);
    }]);
  }
};
...
var h5 = class extends P {
  getOpacity(t11) {
    return Tt([w4(t11), new _3(1)], [Xt(t11, this.opacityValues.first()), this.opacities.first()], [Gt(t11, this.opacityValues.last()), this.opacities.last()], [true, () => {
      const s9 = this.opacityValues.findIndex((s10) => Yt(s10, t11)), i8 = this.opacityValues.get(s9), e9 = s9.subtract(1), o13 = this.opacityValues.get(e9), a6 = t11.subtract(o13).divide(i8.subtract(o13));
...
var p5 = class extends P {
  getSizeForViewScale(s9) {
    return Tt([Xt(s9, this.values.first()), this.sizes.first()], [Gt(s9, this.values.last()), this.sizes.last()], [true, () => {
      const t11 = this.values.findIndex((t12) => Yt(t12, s9)), e9 = this.values.get(t11), i8 = t11.subtract(1), r7 = this.values.get(i8), o13 = s9.subtract(r7).divide(e9.subtract(r7));
      return _e(this.sizes.get(i8), this.sizes.get(t11), o13);
    }]);
  }
};
...
var f3 = class extends P {
  getSize(s9, t11) {
    const e9 = Tt([w4(s9), t11], [Xt(s9, this.values.first()), this.sizes.first()], [Gt(s9, this.values.last()), this.sizes.last()], [true, () => {
      const t12 = this.values.findIndex((t13) => Yt(t13, s9)), e10 = this.values.get(t12), i8 = t12.subtract(1), r7 = this.values.get(i8), o13 = s9.subtract(r7).divide(e10.subtract(r7));
      return _e(this.sizes.get(i8), this.sizes.get(t12), o13);
    }]);
...
function l3(a6, e9, i8) {
  var _a, _b, _c, _d;
  if (t8(a6)) {
    const t11 = a6.storage.getSizeValue(e9);
    return ((_a = a6.visualVariableSizeMinMaxValue) == null ? void 0 : _a.getSize(t11, i8)) ?? ((_b = a6.visualVariableSizeScaleStops) == null ? void 0 : _b.getSizeForViewScale(a6.view.currentScale)) ?? ((_c = a6.visualVariableSizeStops) == null ? void 0 : _c.getSize(t11, i8)) ?? ((_d = a6.visualVariableSizeUnitValue) == null ? void 0 : _d.getSize(t11, i8));
  }
  return i8;
}
function r5(e9, i8, t11, l7 = new J(false)) {
  if (null == e9.visualVariableColor) return t11;
  const r7 = e9.storage.getColorValue(i8);
  return e9.visualVariableColor.getColor(r7, t11, l7);
}
function n6(a6, i8) {
  if (null == a6.visualVariableOpacity) return new _3(1);
  const t11 = a6.storage.getOpacityValue(i8);
...
function o7(a6, i8) {
  ...
  const t11 = a6.storage.getRotationValue(i8);
...
var E6 = class extends B5 {
  ...
  _toNdc(i8) {
    return this.animationInfo.toNdc.multiply(new X(i8, 1)).xy;
  }
  _getEvalParams(i8, t11) {
    const { globalTime: o13, animationTextureSize: e9, animationTexture: a6 } = this.animationInfo;
    return { globalTime: o13, localTimeOrigin: this._getLocalTimeOrigin(i8.id), animationTextureSize: e9, animationTexture: a6, pixelDimensions: t11 };
  }
  _getColor(i8, t11) {
    return zt(Ut(t11.isSDF, new _3(1)), this._getSDFColor(i8, t11), this._getSpriteColor(i8, t11));
  }
  _getSpriteColor(i8, t11) {
    return pn(this.mosaicInfo.texture, i8).multiply(t11.color);
  }
  _getSDFColor(i8, t11) {
    const o13 = pn(this.mosaicInfo.texture, i8), e9 = new _3(0.5).subtract(B4(o13)).multiply(t11.distanceToPx).multiply(o3), a6 = ce(new _3(0.5).subtract(e9), new _3(0), new _3(1)), r7 = t11.color.multiply(a6), l7 = t11.outlineSize.multiply(0.5), s9 = Kt(e9).subtract(l7), n14 = ce(new _3(0.5).subtract(s9), new _3(0), new _3(1)), u13 = t11.outlineColor.multiply(n14);
    return new _3(1).subtract(u13.a).multiply(r7).add(u13);
  }
};
function G3(i8, t11, e9) {
  const a6 = i8.add(new C3(t11, 0)), r7 = pn(e9.animationTexture, a6.add(0.5).divide(e9.animationTextureSize)).xy;
  return i8 = i8.add(r7), It({ animationPointer: i8, ...e9 }, Y, null, (i9) => {
    const { out: t12 } = i9;
...
function j3(t11, u13, s9) {
  const l7 = s9.subtract(u13), c8 = v3(t11.subtract(u13), l7), e9 = ce(c8.divide(Me(l7)), new _3(0), new _3(1));
...
function h6(t11, u13, n14, i8) {
  const y6 = new rt(n14.x.multiply(i8.y).subtract(i8.x.multiply(n14.y)), i8.x.multiply(u13.y).subtract(u13.x.multiply(i8.y)), u13.x.multiply(n14.y).subtract(n14.x.multiply(u13.y)), n14.y.subtract(i8.y), i8.y.subtract(u13.y), u13.y.subtract(n14.y), i8.x.subtract(n14.x), u13.x.subtract(i8.x), n14.x.subtract(u13.x)), s9 = u13.x.multiply(n14.y.subtract(i8.y)), l7 = n14.x.multiply(i8.y.subtract(u13.y)), a6 = i8.x.multiply(u13.y.subtract(n14.y)), o13 = s9.add(l7).add(a6);
  return new _3(1).divide(o13).multiply(y6.multiply(new X(1, t11)));
}
function M2(t11, u13, n14, i8) {
  return Ut(g2(h6(t11, u13, n14, i8)), new _3(1));
}
function P3(t11, u13, n14, i8) {
  const y6 = n14.subtract(u13), s9 = i8.subtract(u13), l7 = j2(y6, s9), c8 = Vt(Ct(l7, new _3(u2)), Yt(l7, new _3(-0.05)));
  return Tt([Vt(Ge(c8), M2(t11.xy, u13, n14, i8)), new _3(-1)], [true, () => {
    const r7 = j3(t11, u13, n14), y7 = j3(t11, n14, i8), s10 = j3(t11, i8, u13);
...
function z2(t11, u13, n14) {
  const { viewMat3: r7, tileMat3: i8 } = t11.view, y6 = r7.multiply(i8), s9 = y6.multiply(new X(u13.pos, 1)), l7 = y6.multiply(new X(n14.nextPos1, 1)), c8 = y6.multiply(new X(n14.nextPos2, 1));
  return P3(t11.hittestRequest.position, s9.xy, l7.xy, c8.xy);
}
...
function G4(t11, e9, i8, s9) {
  return e9.multiply(t11.x).add(i8.multiply(t11.y)).add(s9.multiply(t11.z));
}
var H4 = class extends E6 {
  ...
  _vertexPreamble(t11) {
    const { id: e9, pos: i8, offset: s9, animationPointerAndBaseSizeAndReferenceSize: o13, uv: r7, sizing: p16, angle: h11 } = t11, c8 = o13.xy, x8 = o13.z, y6 = o13.w, v8 = p16.xy, f12 = p16.z, w10 = v2(t11.bitset, o2.bitset.isStroke), S7 = p16.w, b10 = v2(t11.bitset, o2.bitset.scaleSymbolsProportionally), g10 = this._getEvalParams(t11, v8), z6 = G3(c8, o8.transform, g10), P8 = Tt([Ut(v2(t11.bitset, o2.bitset.isMapAligned), new _3(1)), this.view.rotation.divide(180).multiply(Math.PI)], [true, new _3(0)]), _9 = new nt(ie(P8), nn(P8.multiply(-1)), nn(P8), ie(P8)).multiply(z6.xy), V4 = z6.z.subtract(P8).subtract(h11.multiply(c2)), C8 = z6.w, j7 = v2(t11.bitset, o2.bitset.isSDF), F10 = l3(this, e9, new _3(y6)).divide(new _3(y6));
    return { baseSize: x8, animationPointer: c8, strokeWidth: f12, isOutline: w10, unscaledDistanceToPx: S7, scaleSymbolsProportionally: b10, isSDF: j7, position: this._getScreenPosition({ id: e9, pos: i8, offset: s9, referenceSize: y6, translation: _9, rotation: V4, scale: C8, vvScale: F10 }), uv: r7, evalParams: g10, vvScale: F10, scale: C8 };
  }
  vertex(t11, e9) {
    const { position: i8, animationPointer: s9, evalParams: o13, isOutline: r7, unscaledDistanceToPx: l7, vvScale: n14, uv: d10, strokeWidth: m17, scaleSymbolsProportionally: u13, scale: v8, isSDF: f12, baseSize: w10 } = this._vertexPreamble(t11), S7 = this._toNdc(i8);
    let b10 = G3(s9, o8.fromColor, o13);
    b10 = new Y(b10.rgb.multiply(b10.a), b10.a);
    let g10 = G3(s9, o8.toColor, o13);
    g10 = new Y(g10.rgb.multiply(g10.a), g10.a);
    let z6 = G3(s9, o8.colorMix, o13);
    z6 = new Y(z6.rgb.multiply(z6.a), z6.a);
    const P8 = G3(s9, o8.toOpacity, o13).a, _9 = G3(s9, o8.opacityMix, o13).a, V4 = r5(this, t11.id, b10, Ht(h4(t11.bitset, o2.bitset.colorLocked), new J(r7))), C8 = _e(V4, g10, z6), D7 = n6(this, t11.id), j7 = _e(D7, P8, _9), F10 = C8.multiply(j7), R6 = this.clip(t11.id, t11.zoomRange), U4 = l7.multiply(n14);
  ...
  hittest(t11, e9, i8) {
    return zt(Ct(i8.size, this.hittestRequest.smallSymbolSizeThreshold), this._hittestSmallMarker(t11, e9, i8), this._hittestMarker(t11, e9, i8));
  }
  _hittestSmallMarker(t11, e9, i8) {
    const { position: s9, distance: o13, smallSymbolDistance: r7 } = this.hittestRequest, l7 = o13.subtract(r7), { viewMat3: a6, tileMat3: n14 } = this.view, d10 = a6.multiply(n14).multiply(new X(i8.pos, 1)).xy, m17 = i8.size.multiply(0.5);
    return fe(d10, s9).subtract(m17).add(l7);
  }
  _hittestMarker(t11, e9, i8) {
    const s9 = this._vertexPreamble({ ...t11 }).position, o13 = this._vertexPreamble({ ...t11, offset: e9.offsetNextVertex1, uv: e9.textureUVNextVertex1 }).position, r7 = this._vertexPreamble({ ...t11, offset: e9.offsetNextVertex2, uv: e9.textureUVNextVertex2 }).position, l7 = this.hittestRequest.position, a6 = this.hittestRequest.distance, n14 = P3(l7, s9, o13, r7);
    return zt(Yt(n14, a6), n14, this._hittestSamples(s9, o13, r7, t11, e9, i8));
  }
  _hittestSamples(t11, e9, i8, s9, o13, r7) {
    const { outlineSize: l7, isSDF: n14, distanceToPx: d10 } = r7, m17 = this.hittestRequest.position, u13 = this.hittestRequest.distance, h11 = h6(m17.add(new C3(xt(u13), xt(u13))), t11, e9, i8), c8 = h6(m17.add(new C3(0, xt(u13))), t11, e9, i8), x8 = h6(m17.add(new C3(u13, xt(u13))), t11, e9, i8), y6 = h6(m17.add(new C3(xt(u13), 0)), t11, e9, i8), v8 = h6(m17, t11, e9, i8), f12 = h6(m17.add(new C3(u13, 0)), t11, e9, i8), w10 = h6(m17.add(new C3(xt(u13), u13)), t11, e9, i8), S7 = h6(m17.add(new C3(0, u13)), t11, e9, i8), b10 = h6(m17.add(new C3(u13, u13)), t11, e9, i8), _9 = s9.uv.divide(this.mosaicInfo.size), V4 = o13.textureUVNextVertex1.divide(this.mosaicInfo.size), C8 = o13.textureUVNextVertex2.divide(this.mosaicInfo.size), M5 = { color: new Y(1, 1, 1, 1), outlineSize: l7, outlineColor: new Y(1, 1, 1, 1), isSDF: n14, distanceToPx: d10 };
    let N = new _3(0);
    return N = N.add(g2(h11).multiply(this._getColor(G4(h11, _9, V4, C8), M5).a)), N = N.add(g2(c8).multiply(this._getColor(G4(c8, _9, V4, C8), M5).a)), N = N.add(g2(x8).multiply(this._getColor(G4(x8, _9, V4, C8), M5).a)), N = N.add(g2(y6).multiply(this._getColor(G4(y6, _9, V4, C8), M5).a)), N = N.add(g2(v8).multiply(this._getColor(G4(v8, _9, V4, C8), M5).a)), N = N.add(g2(f12).multiply(this._getColor(G4(f12, _9, V4, C8), M5).a)), N = N.add(g2(w10).multiply(this._getColor(G4(w10, _9, V4, C8), M5).a)), N = N.add(g2(S7).multiply(this._getColor(G4(S7, _9, V4, C8), M5).a)), N = N.add(g2(b10).multiply(this._getColor(G4(b10, _9, V4, C8), M5).a)), sn(N, new _3(0.05)).multiply(q4(this.hittestRequest));
  }
};
...
var u4 = class extends t9 {
  render(a6, u13) {
    const { context: f12, painter: c8 } = a6, { target: l7 } = u13, { freezeGlobalTime: p16 } = t7, g10 = 0, x8 = c8.textureManager.animationStore.getTexture(f12, g10), d10 = [2 / a6.state.size[0], 0, 0, 0, -2 / a6.state.size[1], 0, -1, 1, 1], h11 = Array.from(s2(e5(), d10)), b10 = Array.from(i2(e5(), h11, l7.transforms.displayViewScreenMat3)), T4 = u13.instance.getInput();
    c8.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(a6, u13.target, T4.uniforms), ...h2(a6, u13.target), mosaicInfo: c8.textureManager.getMosaicInfo(f12, u13.textureKey, true), animationInfo: { globalTime: false === p16 ? a6.time / 1e3 : p16, animationTextureSize: [x8.descriptor.width, x8.descriptor.height], animationTexture: { unit: 6, texture: x8 }, toScreen: b10, toNdc: d10, mapRotation: a6.state.rotation, pixelRatio: a6.state.pixelRatio } }, defines: { ...y(a6) }, optionalAttributes: { zoomRange: true }, useComputeBuffer: true }), c8.setPipelineState({ ...M(a6) }), c8.submitDraw(a6, u13), false === p16 && l7.requestRender();
  }
};
...
var C6 = class extends j {
  ...
  vertex(t11) {
    const o13 = new rt(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new X(t11.pos.xy.divide(a), 1)), i8 = pn(this.draw.locations, o13.xy), s9 = qe(this.instance.dotSize.divide(2), new _3(1));
    let r7 = new _3(0);
    r7 = r7.add(sn(i8.a, new _3(F3)).multiply(2));
    ...
    return d10 = d10.multiply(this.draw.pixelRatio.multiply(this.draw.tileZoomFactor)), { glPosition: a6, glPointSize: d10, color: i8, ratio: p16, invEdgeRatio: h11 };
  }
  fragment(t11) {
    const o13 = Me(t11.glPointCoord.subtract(0.5)).multiply(2), e9 = cn(new _3(0), new _3(1), t11.invEdgeRatio.multiply(o13.subtract(t11.ratio)).add(1)), i8 = new w3();
    return i8.fragColor = t11.color.multiply(e9), i8;
  }
};
r([g(R2)], C6.prototype, "instance", void 0), r([g(b2)], C6.prototype, "draw", void 0), r([g(d4)], C6.prototype, "view", void 0), r([e(0, m3(z3))], C6.prototype, "vertex", null), r([e(0, m3(P4))], C6.prototype, "fragment", null);
...
var F4 = class extends B5 {
  ...
  vertex(t11) {
    const e9 = new rt(2 / a, 0, 0, 0, -2 / a, 0, -1, 1, 1).multiply(new X(t11.pos, 1)), s9 = this.clip(t11.id), i8 = new Y(e9.xy, s9, 1), r7 = this.storage.getVVData(t11.id).multiply(this.instance.isActive.get(0)).multiply(t11.inverseArea), l7 = this.storage.getDataDrivenData0(t11.id).multiply(this.instance.isActive.get(1)).multiply(t11.inverseArea), d10 = this.draw.tileZoomFactor.multiply(a).divide(this.draw.pixelRatio), n14 = this._dotThreshold(r7, this.instance.dotValue, this.draw.tileDotsOverArea), a6 = this._dotThreshold(l7, this.instance.dotValue, this.draw.tileDotsOverArea), u13 = t11.pos.add(0.5).divide(d10);
    return { glPosition: i8, color: new Y(0, 0, 0, 0), textureCoords: u13, thresholds0: n14, thresholds1: a6 };
  }
  fragment(t11) {
    const e9 = new w3(), o13 = pn(this.draw.dotTexture0, t11.textureCoords), s9 = pn(this.draw.dotTexture1, t11.textureCoords), i8 = t11.thresholds0.subtract(o13), r7 = t11.thresholds1.subtract(s9);
    let l7;
    ...
    if (this.blending) {
      const t12 = sn(new _3(0), i8), e10 = sn(new _3(0), r7), o14 = pe(t12, i8).add(pe(e10, r7)), s10 = sn(o14, new _3(0)), d10 = new _3(1).subtract(s10), p16 = o14.add(s10), h11 = i8.multiply(t12).divide(p16), c8 = r7.multiply(e10).divide(p16), u13 = n14.multiply(h11).add(a6.multiply(c8));
      l7 = d10.multiply(u13);
    } else {
      const t12 = qe(C5(i8), C5(r7)), e10 = sn(t12, new _3(0)), o14 = new _3(1).subtract(e10), s10 = sn(t12, i8), d10 = sn(t12, r7), p16 = n14.multiply(s10).add(a6.multiply(d10));
      l7 = o14.multiply(p16);
    }
    return e9.fragColor = l7, e9;
  }
  hittest(t11) {
    return q4(this.hittestRequest);
  }
};
r([K3], F4.prototype, "blending", void 0), r([g(V)], F4.prototype, "instance", void 0), r([g(_5)], F4.prototype, "draw", void 0), r([e(0, m3(j4))], F4.prototype, "vertex", null), r([e(0, m3(P2))], F4.prototype, "fragment", null);
...
var f4 = class {
  ...
  getDotDensityMesh(t11) {
    if (null == this._dotMesh) {
      const o13 = a, r7 = o13 * o13, i8 = 2, n14 = new Int16Array(r7 * i8);
      for (let t12 = 0; t12 < o13; t12++) for (let e9 = 0; e9 < o13; e9++) n14[i8 * (e9 + t12 * o13)] = e9, n14[i8 * (e9 + t12 * o13) + 1] = t12;
  ...
  _allocDotDensityTexture(t11, e9, s9) {
    ...
    const i8 = new p();
    return i8.dataType = U.FLOAT, i8.samplingMode = L2.NEAREST, i8.width = e9, i8.height = e9, new w(t11, i8, o13);
  }
};
...
var x3 = class extends B5 {
  ...
  vertex(t11, o13) {
    const r7 = n6(this, t11.id), e9 = r5(this, t11.id, t11.color).multiply(r7), i8 = this.view.displayViewScreenMat3.multiply(new X(t11.pos.xy, 1)), p16 = this.clip(t11.id, t11.zoomRange);
    return { glPosition: new Y(i8.xy, p16, 1), color: e9, ...this.maybeRunHittest(t11, o13, null) };
  }
  fragment(t11) {
...
r([_4(f2)], x3.prototype, "visualVariableColor", void 0), r([_4(h5)], x3.prototype, "visualVariableOpacity", void 0), r([e(0, m3(g3)), e(1, m3(q3))], x3.prototype, "vertex", null), r([e(0, m3(P2))], x3.prototype, "fragment", null);
...
var w5 = class extends t9 {
  ...
  _renderPolygons(e9, t11) {
    const { painter: i8 } = e9;
    i8.setShader({ shader: this.shaders.fill, uniforms: { ...h2(e9, t11.target), visualVariableColor: null, visualVariableOpacity: null }, defines: { ...y(e9) }, optionalAttributes: { zoomRange: false }, useComputeBuffer: f(e9) }), i8.setPipelineState(M(e9)), i8.submitDraw(e9, t11);
  }
  _renderDotDensity(o13, r7) {
    ...
    const v8 = s9.getBoundFramebufferObject(), P8 = h11.getFBO(s9);
    s9.bindFramebuffer(P8), s9.setClearColor(0, 0, 0, 0), s9.clear(_2.COLOR), u13.setPipelineState({ color: { write: [true, true, true, true], blendMode: "composite" }, depth: false, stencil: false }), u13.updatePipelineState(s9), u13.submitDraw(o13, r7), s9.bindFramebuffer(v8), s9.setViewport(R6.x, R6.y, R6.width, R6.height);
...
var n7 = class extends P {
  getPatternOffsetAtTileOrigin(t11, i8 = new _3(0), l7 = new _3(1)) {
    ...
    return p16 = new C3(p16.x.multiply(l7).subtract(p16.y.multiply(i8)), p16.x.multiply(i8).add(p16.y.multiply(l7))), Ce(p16, t11);
  }
};
r([g(C3)], n7.prototype, "tileOffsetFromLocalOrigin", void 0), r([g(C3)], n7.prototype, "maxIntsToLocalOrigin", void 0);
...
function L7(t11, e9, o13, i8, r7) {
  const l7 = Ut(v2(r7, C2), st(1)), s9 = B4(new Y(t11, 0));
  return zt(l7, ft(i8.divide(e9.x), o13.divide(e9.y), 0, xt(o13.divide(e9.x)), i8.divide(e9.y), 0, b(ot(s9, 0)), b(ot(0, s9)), 1), ft(i8.divide(e9.x), o13.divide(e9.y), 0, xt(o13.divide(e9.x)), i8.divide(e9.y), 0, 0, 0, 1));
}
function P5(t11, e9) {
  const o13 = t11.view.requiredZoomFactor, i8 = new C3(e9.width, e9.height), r7 = i8.multiply(e9.scale).multiply(o13), m17 = e9.angle.multiply(c2), u13 = nn(m17), f12 = ie(m17), c8 = L7(e9.id, r7, u13, f12, e9.bitset), y6 = t11.localTileOffset.getPatternOffsetAtTileOrigin(i8, u13, f12), v8 = o13.multiply(e9.scale).multiply(e9.offset.subtract(y6)).divide(r7), h11 = new X(e9.pos, 1), x8 = c8.multiply(h11).xy.subtract(v8), g10 = e9.tlbr.divide(t11.mosaicInfo.size.xyxy);
...
function Z(t11, e9) {
  const o13 = Ce(e9.tileTextureCoord, new _3(1)), i8 = _e(e9.tlbr.xy, e9.tlbr.zw, o13);
  let r7 = pn(t11.mosaicInfo.texture, i8);
...
var _6 = class extends x3 {
  ...
  vertex(t11, e9) {
    return { ...super.vertex(t11, e9), ...P5(this, t11) };
  }
  fragment(t11) {
    const e9 = Z(this, t11);
...
r([g(p4)], _6.prototype, "mosaicInfo", void 0), r([g(n7)], _6.prototype, "localTileOffset", void 0), r([e(0, m3(q5)), e(1, m3(q3))], _6.prototype, "vertex", null), r([e(0, m3(G5))], _6.prototype, "fragment", null);
...
function D5(t11, i8) {
  const { halfWidth: e9, normal: o13 } = t11, l7 = k3(e9), a6 = Me(o13).multiply(e9);
  return ce(l7.multiply(e9.subtract(a6)).divide(i8.add(l7).subtract(new _3(1))), new _3(0), new _3(1));
}
function G6(t11, i8) {
  const { id: e9, halfWidth: o13, referenceHalfWidth: l7 } = i8;
  if (t8(t11)) {
    const i9 = new _3(2).multiply(l7), a6 = l3(t11, e9, i9);
    return new _3(0.5).multiply(o13.divide(qe(l7, new _3(s4)))).multiply(a6);
  }
  return o13;
}
function L8(t11, i8) {
  const { id: e9, offset: o13, pos: l7, normal: a6, zoomRange: r7 } = i8, { displayViewScreenMat3: s9, displayViewMat3: n14 } = t11.view, c8 = r5(t11, e9, i8.color), f12 = n6(t11, e9), h11 = G6(t11, i8), v8 = new _3(0.5).multiply(t11.antialiasingControls.antialiasing), w10 = qe(h11.add(v8), new _3(0.45)).add(new _3(0.1).multiply(v8)), V4 = k3(w10).multiply(w10).multiply(o13), b10 = n14.multiply(new X(V4, new _3(0))), S7 = s9.multiply(new X(l7, new _3(1))).add(b10), x8 = new _3(2).multiply(sn(h11, new _3(0))).add(t11.clip(e9, r7)), g10 = new Y(S7.xy, x8, 1);
  return { color: c8, opacity: f12, halfWidth: w10, normal: a6, scaledOffset: V4, scaledHalfWidth: h11, glPosition: new Y(g10.xy, x8, 1) };
}
function T2(t11, i8) {
  const { opacity: e9, color: o13 } = t11, l7 = D5(t11, i8);
  return e9.multiply(o13).multiply(l7);
}
...
var _7 = class extends B5 {
  ...
  vertex(t11, i8) {
    ...
    return { ...e9, ...this.maybeRunHittest(t11, i8, e9.halfWidth) };
  }
  fragment(t11) {
    const i8 = T2(t11, this.antialiasingControls.blur);
    return this.getFragmentOutput(i8, t11);
  }
  hittest(t11, i8, e9) {
    const { viewMat3: o13, tileMat3: l7 } = this.view, a6 = o13.multiply(l7), r7 = a6.multiply(new X(t11.pos, 1)), s9 = a6.multiply(new X(i8.nextPos1, 1)), n14 = a6.multiply(new X(i8.nextPos2, 1)), { distance: p16, smallSymbolDistance: u13, smallSymbolSizeThreshold: y6 } = this.hittestRequest, f12 = sn(e9, y6.multiply(0.5)).multiply(p16.subtract(u13)), h11 = this.hittestRequest.position;
...
function R3(t11, o13, i8) {
  const { id: e9, bitset: r7 } = o13, s9 = v2(r7, B2), m17 = Yt(s9, new _3(0.5)), d10 = L8(t11, o13), c8 = zt(m17, d10.halfWidth, new _3(0)), f12 = n6(t11, e9), h11 = r5(t11, e9, o13.color), v8 = zt(m17, o13.color, h11.multiply(f12)), V4 = t11.view.displayViewScreenMat3.multiply(new X(o13.pos.xy, 1)), b10 = t11.clip(o13.id), j7 = new Y(V4.xy, b10, 1), g10 = zt(m17, d10.glPosition, j7), w10 = i8 && t11.maybeRunHittest(o13, i8, m17);
...
var H5 = class extends A4 {
  ...
  fragment(t11) {
    const { color: o13, isOutline: i8 } = t11, e9 = Yt(i8, new _3(0.5)), r7 = T2(t11, this.antialiasingControls.blur), s9 = zt(e9, r7, o13), n14 = zt(e9, new _3(1 / 255), new _3(0));
    return this.getFragmentOutput(s9, t11, n14);
  }
  hittest(t11, o13, i8) {
    return zt(i8, q4(this.hittestRequest), z2(this, t11, o13));
  }
};
...
function O2(t11, e9) {
  const r7 = e9.tlbr.xy, o13 = e9.tlbr.zw, i8 = o13.x.subtract(r7.x), n14 = r7.y.subtract(o13.y), a6 = new C3(i8, n14).multiply(e9.inverseRasterizationScale), p16 = a6.multiply(t11.view.requiredZoomFactor), u13 = j5(p16), c8 = t11.localTileOffset.getPatternOffsetAtTileOrigin(a6).divide(p16), d10 = new X(e9.pos, 1);
  return { tileTextureCoord: u13.multiply(d10).xy.subtract(c8), tlbr: e9.tlbr.divide(t11.mosaicInfo.size.xyxy) };
}
function S3(t11, e9) {
  const r7 = Ce(t11.tileTextureCoord, new _3(1)), o13 = _e(t11.tlbr.xy, t11.tlbr.zw, r7), i8 = pn(e9.texture, o13);
  return t11.color.multiply(i8);
}
...
r([g(p4)], T3.prototype, "mosaicInfo", void 0), r([g(n7)], T3.prototype, "localTileOffset", void 0), r([e(0, m3(w6)), e(1, m3(q3))], T3.prototype, "vertex", null), r([e(0, m3(g4))], T3.prototype, "fragment", null);
...
r([g(p4)], x4.prototype, "mosaicInfo", void 0), r([g(n7)], x4.prototype, "localTileOffset", void 0), r([e(0, m3(y2)), e(1, m3(q3))], x4.prototype, "vertex", null), r([e(0, m3(S4))], x4.prototype, "fragment", null);
...
var R4 = class extends A4 {
  ...
  vertex(t11, o13) {
    const { aux1: e9, aux2: r7, aux3: i8, aux4: p16 } = t11, a6 = { ...t11, width: e9, height: r7, offset: i8, scale: p16.multiply(b3) }, n14 = { ...t11, halfWidth: e9, referenceHalfWidth: r7, offset: i8, normal: p16.subtract(L4).multiply(b3) }, m17 = R3(this, n14), u13 = P5(this, a6), f12 = Yt(m17.isOutline, new _3(0.5));
    return { ...m17, ...u13, ...this.maybeRunHittest(t11, o13, f12) };
  }
  fragment(t11) {
    const { isOutline: o13 } = t11, e9 = Yt(o13, new _3(0.5)), r7 = T2(t11, this.antialiasingControls.blur), i8 = Z(this, t11), a6 = zt(e9, r7, i8), n14 = zt(e9, new _3(1 / 255), new _3(0));
...
r([g(p4)], R4.prototype, "mosaicInfo", void 0), r([g(n7)], R4.prototype, "localTileOffset", void 0), r([e(0, m3(w7)), e(1, m3(q3))], R4.prototype, "vertex", null), r([e(0, m3(C7))], R4.prototype, "fragment", null);
...
var m7 = class extends t9 {
  ...
  render(e9, a6) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e9, a6.target, f12.uniforms), ...h2(e9, a6.target), antialiasingControls: n8(p16), mosaicInfo: m17.textureManager.getMosaicInfo(u13, a6.textureKey), localTileOffset: w2(a6.target) }, defines: { ...y(e9) }, optionalAttributes: f12.optionalAttributes, useComputeBuffer: f(e9) }), m17.setPipelineState(M(e9)), m17.submitDraw(e9, a6);
  }
};
...
var P6 = class extends g3 {
};
r([h3(5, Y)], P6.prototype, "tlbr", void 0), r([h3(6, C3)], P6.prototype, "relativePosition", void 0), r([h3(7, _3)], P6.prototype, "gradientMethod", void 0), r([h3(8, C3)], P6.prototype, "relativeGradientSize", void 0);
...
var A5 = class extends x3 {
  ...
  vertex(t11, e9) {
    const { tlbr: i8, relativePosition: r7, gradientMethod: o13, relativeGradientSize: n14 } = t11, d10 = zt(h4(t11.bitset, e3.isAbsolute), this.view.displayZoomFactor, new _3(1));
    return { ...super.vertex(t11, e9), tlbr: i8, relativePosition: r7, gradientMethod: o13, gradientSize: n14.multiply(d10), isDiscrete: v2(t11.bitset, e3.isDiscrete) };
  }
  fragment(t11) {
    const { tlbr: e9, relativePosition: i8, gradientMethod: r7, gradientSize: o13, isDiscrete: g10 } = t11, y6 = zt(Yt(g10, new _3(0.5)), o13.subtract(1), new C3(0)), b10 = Tt([Ut(r7, new _3(r4.rectangular)), () => {
      const t12 = Kt(i8).add(y6).divide(o13);
      return D4(qe(t12.x, t12.y));
    }], [Ut(r7, new _3(r4.circular)), D4(un(pe(i8, i8)).add(y6.x).divide(o13.x))], [true, D4(i8.x.add(y6.x).divide(o13.x))]), j7 = new C3(ce(b10, new _3(0), new _3(1)), 0.5), S7 = _e(e9.xy, e9.zw, j7).divide(this.mosaicInfo.size), z6 = pn(this.mosaicInfo.texture, S7), F10 = t11.color.a;
    return this.getFragmentOutput(z6.multiply(F10), t11, new _3(0));
  }
};
r([g(p4)], A5.prototype, "mosaicInfo", void 0), r([e(0, m3(P6)), e(1, m3(q3))], A5.prototype, "vertex", null), r([e(0, m3(D6))], A5.prototype, "fragment", null);
...
var l4 = class extends t9 {
  ...
  render(e9, n14) {
    const { painter: u13, pixelRatio: l7 } = e9, m17 = n14.instance.getInput();
    u13.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e9, n14.target, m17.uniforms), ...h2(e9, n14.target), antialiasingControls: n8(l7) }, defines: { ...y(e9) }, optionalAttributes: m17.optionalAttributes, useComputeBuffer: f(e9) }), u13.setPipelineState(M(e9)), u13.submitDraw(e9, n14);
  }
};
...
var m9 = class extends t9 {
  ...
  render(e9, a6) {
    const { context: l7, painter: m17, pixelRatio: p16 } = e9, f12 = a6.instance.getInput();
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e9, a6.target, f12.uniforms), ...h2(e9, a6.target), antialiasingControls: n8(p16), mosaicInfo: m17.textureManager.getMosaicInfo(l7, a6.textureKey), localTileOffset: w2(a6.target) }, defines: { ...y(e9) }, optionalAttributes: f12.optionalAttributes, useComputeBuffer: f(e9) }), m17.setPipelineState(M(e9)), m17.submitDraw(e9, a6);
  }
};
...
var F7 = class extends B5 {
  ...
  vertex(t11) {
    const { radius: e9, isFieldActive: s9 } = this.kernelControls, i8 = t11.offset, l7 = s9.multiply(this.storage.getVVData(t11.id).x).add(new _3(1).subtract(s9)), o13 = this.view.displayViewScreenMat3.multiply(new X(t11.pos, 1)).add(this.view.displayViewMat3.multiply(new X(i8, 0)).multiply(e9)), r7 = this.clip(t11.id);
    return { glPosition: new Y(o13.xy, r7, 1), offset: i8, fieldValue: l7, color: new Y(0), ...this.maybeRunHittest(t11, {}, null) };
  }
  fragment(t11) {
    const { offset: e9, fieldValue: s9 } = t11, i8 = Me(e9), l7 = sn(i8, new _3(1)), o13 = new _3(1).subtract(i8.multiply(i8)), r7 = o13.multiply(o13), p16 = l7.multiply(r7).multiply(s9).multiply(new _3(n9(this.usesHalfFloatPrecision)));
    return this.getFragmentOutput(new Y(p16), t11);
  }
  hittest(t11) {
    const { viewMat3: e9, tileMat3: s9 } = this.view, i8 = e9.multiply(s9).multiply(new X(t11.pos, 1));
    return R(i8.xy, this.kernelControls.radius, this.hittestRequest.position);
  }
};
...
var b4 = class extends j {
  ...
  fragment(t11) {
    ...
    const r7 = pn(o13.texture, new C3(s9, 0.5)), i8 = new w3();
    return i8.fragColor = new Y(r7.rgb.multiply(r7.a), r7.a), i8;
  }
};
...
var p7 = class extends t9 {
  ...
  render(e9, t11) {
    const { context: n14, painter: o13, state: u13 } = e9, a6 = t11.instance.getInput(), { isFieldActive: d10 } = a6.uniforms, l7 = this._getOrCreateResourcesRecord(n14), h11 = l7.loadQualityProfile(n14);
    f(e9) || this._bind(e9, l7, a6), o13.setShader({ shader: this.shaders.accumulate, uniforms: { ...h2(e9, t11.target), kernelControls: { radius: g7(a6, u13), isFieldActive: d10 ? 1 : 0 } }, defines: { ...y(e9), ...h11.defines }, optionalAttributes: {}, useComputeBuffer: f(e9) });
    const c8 = f(e9) ? w9 : _8;
  ...
  renderResolvePass(e9, t11) {
    if (f(e9)) return;
    const { context: s9, painter: i8 } = e9, n14 = this._resources.get(s9);
    if (null == this._prevFBO || null == this._prevViewport || !(n14 == null ? void 0 : n14.initialized)) return;
    const { defines: o13 } = n14.loadQualityProfile(s9), { minDensity: u13, maxDensity: a6, radius: d10 } = t11.getInput().uniforms, l7 = 8, h11 = 9, c8 = n14.accumulateFramebuffer, p16 = n14.resolveGradientTexture, m17 = { shader: this.shaders.resolve, uniforms: { accumulatedDensity: { texture: { unit: l7, texture: c8.colorTexture }, minAndInvRange: [u13, 1 / (a6 - u13)], normalization: 3 / (d10 * d10 * Math.PI) }, gradient: { texture: { unit: h11, texture: p16 } } }, defines: o13, optionalAttributes: {}, useComputeBuffer: false };
    s9.bindFramebuffer(this._prevFBO), s9.setViewport(0, 0, this._prevViewport.width, this._prevViewport.height), s9.bindTexture(c8.colorTexture, l7), s9.bindTexture(p16, h11), i8.setPipelineState(b5), i8.submitDrawMesh(s9, m17, i8.quadMesh), this._unbind();
  }
  _getOrCreateResourcesRecord(e9) {
    let t11 = this._resources.get(e9);
  ...
  _bind(e9, t11, r7) {
    ...
    const { context: s9, state: i8, pixelRatio: n14 } = e9, o13 = s9.getBoundFramebufferObject(), u13 = s9.getViewport();
    ...
    const { width: l7, height: p16 } = u13, f12 = m11(g7(r7, i8), n14), _9 = l7 * f12, w10 = p16 * f12, b10 = t11.ensureAccumulateFBO(s9, _9, w10);
...
var et = class extends B5 {
  ...
  clipLabel(t11, e9, o13) {
    const s9 = e9.multiply(Q2), l7 = Kt(this.view.rotation.subtract(s9)), a6 = Ue(new _3(360).subtract(l7), l7);
    let r7 = new _3(0);
  ...
  vertex(t11, e9) {
    const i8 = v2(t11.bitset, F2), s9 = new _3(1).subtract(i8);
    let l7 = t11.fontSize, a6 = l7.divide(A);
    ...
    if (this.isLabel) {
      ...
      const e10 = t11.referenceSymbol, i9 = e10.xy, s10 = e10.z, l8 = this._unpackDirection(e10.w), a7 = l3(this, t11.id, s10).divide(2), r8 = l8.multiply(a7.add(L3));
      j7 = i9.add(r8), u13 = u13.add(j7);
    } else {
      m17 = l3(this, t11.id, t11.referenceSize).divide(t11.referenceSize), l7 = l7.multiply(m17), a6 = a6.multiply(m17), u13 = u13.multiply(m17), c8 = u3(this, t11.id), u13 = c8.multiply(new X(u13, 0)).xy;
    }
    ...
    O3 = this.isBackgroundPass ? O3.add(s9.multiply(2)) : O3.add(i8.multiply(2));
    let M5 = new _3(0);
    if (this.textRenderPassType === X2.Outline) {
      O3 = O3.add(zt(Ut(t11.outlineAndHaloSize.x, new _3(0)), new _3(2), new _3(0)));
      M5 = new _3(t11.outlineAndHaloSize.x).divide(a6).divide(G2);
    }
    if (this.textRenderPassType === X2.Halo) {
      const e10 = t11.outlineAndHaloSize.x, i9 = new _3(t11.outlineAndHaloSize.y);
      O3 = O3.add(zt(Ut(i9, new _3(0)), new _3(2), new _3(0)));
      M5 = i9.add(e10).divide(a6).divide(G2);
    }
    const L9 = this.isLabel ? Ht(Yt(O3, new _3(1)), Xt(n14, new _3(0))) : new J(false);
    return { glPosition: new Y(d10.xy.add(C8.xy), O3, 1), color: p16, size: a6, textureUV: t11.textureUV.divide(this.mosaicInfo.size), antialiasingWidth: new _3(0.105 * A).divide(l7).divide(this.view.pixelRatio), outlineDistanceOffset: M5, ...this.maybeRunHittest(t11, e9, { vvSizeAdjustment: m17, vvRotation: c8, labelOffset: j7, labelClipped: L9 }) };
  }
  _getViewRotationMatrix(t11) {
    const e9 = this.view.displayViewMat3, i8 = this.view.displayMat3, o13 = new _3(1).subtract(t11);
    return e9.multiply(t11).add(i8.multiply(o13));
  }
  fragment(t11) {
    const e9 = new _3(2 / 8), i8 = new _3(1).subtract(e9), o13 = pn(this.mosaicInfo.texture, t11.textureUV).a;
    let s9 = i8.subtract(t11.outlineDistanceOffset);
    this.highlight && (s9 = s9.divide(2));
    const l7 = t11.antialiasingWidth, a6 = cn(s9.subtract(l7), s9.add(l7), o13);
    return this.getFragmentOutput(t11.color.multiply(a6), t11);
  }
  hittest(t11, e9, { vvSizeAdjustment: i8, vvRotation: o13, labelOffset: s9, labelClipped: l7 }) {
    let a6, r7, n14;
    this.isLabel ? (a6 = new X(t11.offset.add(s9), 0), r7 = new X(e9.offsetNextVertex1.add(s9), 0), n14 = new X(e9.offsetNextVertex2.add(s9), 0)) : (a6 = o13.multiply(new X(t11.offset.multiply(i8), 0)), r7 = o13.multiply(new X(e9.offsetNextVertex1.multiply(i8), 0)), n14 = o13.multiply(new X(e9.offsetNextVertex2.multiply(i8), 0)));
    const { viewMat3: p16, tileMat3: d10 } = this.view, u13 = p16.multiply(d10).multiply(new X(t11.pos, 1)), y6 = u13.add(d10.multiply(a6)).xy, m17 = u13.add(d10.multiply(r7)).xy, c8 = u13.add(d10.multiply(n14)).xy, f12 = P3(this.hittestRequest.position, y6.xy, m17.xy, c8.xy);
    return this.isLabel ? zt(l7, q4(this.hittestRequest), f12) : f12;
  }
  _unpackDirection(t11) {
    const e9 = new W(t11), i8 = Rt(e9, new W(2)), o13 = Pt(e9, new W(3));
    return new C3(new _3(i8).subtract(1), new _3(o13).subtract(1));
  }
  _getVertexColor(t11) {
    let e9 = t11.color;
    if (this.visualVariableColor) {
      const i8 = this.storage.getColorValue(t11.id);
      e9 = this.visualVariableColor.getColor(i8, t11.color, new J(false));
    }
    if (this.visualVariableOpacity) {
      const i8 = this.storage.getOpacityValue(t11.id), o13 = this.visualVariableOpacity.getOpacity(i8);
      e9 = e9.multiply(o13);
    }
    return e9;
  }
...
var G7 = class extends P {
};
r([g(_3)], G7.prototype, "isColorPass", void 0);
var I5 = class extends _7 {
  constructor() {
    super(...arguments), this.type = "GradientStrokeShader";
  }
  vertex(t11, e9) {
    const { totalLength: i8, gradientSize: o13, segmentDirection: s9, tlbr: r7 } = t11, p16 = L8(this, t11), m17 = v2(t11.bitset, e4.isAlongLine), c8 = i8.divide(this.view.displayZoomFactor), h11 = zt(h4(t11.bitset, e4.isAbsoluteSize), () => {
  ...
  fragment(t11) {
    const { isAlongLine: e9, isDiscrete: i8, relativePositionAlongLine: o13, relativeGradientSize: s9, normal: r7, tlbr: l7 } = t11, g10 = D5(t11, this.antialiasingControls.blur), v8 = new _3(0.5).multiply(r7.y).add(new _3(0.5)), f12 = zt(Yt(e9, new _3(0.5)), o13, v8), w10 = zt(Yt(i8, new _3(0.5)), s9.subtract(1), new _3(0)), b10 = D4(f12.add(w10).divide(s9)), x8 = _e(l7.xy, l7.zw, new C3(ce(b10, new _3(0), new _3(1)), 0.5)), S7 = pn(this.mosaicInfo.texture, x8), L9 = t11.opacity.multiply(g10), A6 = this.getFragmentOutput(S7.multiply(L9), t11), D7 = sn(new _3(0.5), this.technique.isColorPass).multiply(has("gradient-depth-epsilon")), F10 = sn(new _3(0), r7.y).multiply(new _3(has("gradient-depth-bias")).subtract(D7));
    return A6.glFragDepth = ce(Me(r7).add(F10), new _3(0), new _3(1)), A6;
  }
};
r([g(p4)], I5.prototype, "mosaicInfo", void 0), r([g(G7)], I5.prototype, "technique", void 0), r([e(0, m3(F8)), e(1, m3(q3))], I5.prototype, "vertex", null);
...
var d6 = class extends t9 {
  ...
  _getShaderOptions(e9, t11, a6) {
    const { context: n14, painter: p16, pixelRatio: c8 } = e9, l7 = t11.instance.getInput();
    return { shader: this.shaders.geometry, uniforms: { ...m2(e9, t11.target, l7.uniforms), ...h2(e9, t11.target), antialiasingControls: n8(c8), mosaicInfo: p16.textureManager.getMosaicInfo(n14, t11.textureKey), technique: { isColorPass: a6 } }, defines: { ...y(e9) }, optionalAttributes: l7.optionalAttributes, useComputeBuffer: f(e9) };
  }
  render(e9, t11) {
    const { painter: s9 } = e9;
    if (f(e9) || p2(e9)) {
    ...
    const i8 = { color: { write: [true, true, true, true], blendMode: "composite" }, depth: { write: false, test: O.LEQUAL }, stencil: { write: false, test: { ref: (e10) => e10.stencilRef, compare: O.EQUAL, mask: 255, op: { fail: I.KEEP, zFail: I.KEEP, zPass: I.KEEP } } } };
    s9.setShader(this._getShaderOptions(e9, t11, 1)), s9.setPipelineState(i8), s9.submitDraw(e9, t11);
  }
};
...
var p9 = class extends t9 {
  ...
  render(e9, t11) {
    ...
    a6.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e9, t11.target, p16.uniforms), ...h2(e9, t11.target), antialiasingControls: n8(u13) }, defines: { ...y(e9) }, optionalAttributes: p16.optionalAttributes, useComputeBuffer: f(e9) }), a6.setPipelineState(M(e9)), a6.submitDraw(e9, t11);
  }
};
...
var H6 = class extends _7 {
  ...
  _getSDFAlpha(t11) {
    const { halfWidth: e9, normal: i8, tlbr: a6, patternSize: r7, accumulatedDistance: l7, offsetAlongLine: x8, dashToPx: v8, capType: D7 } = t11, S7 = r7.x.divide(t3).multiply(v8), j7 = Ee(l7.add(x8).divide(S7)), A6 = _e(a6.xy, a6.zw, new C3(j7, 0.5)), z6 = B4(pn(this.mosaicInfo.texture, A6)).multiply(2).subtract(1).multiply(c).multiply(v8), F10 = i8.y.multiply(e9), T4 = Tt([Ut(D7, new _3(1)), z6.subtract(e9)], [Ut(D7, new _3(2)), un(Le(qe(z6, new _3(0)), new _3(2)).add(F10.multiply(F10))).subtract(e9)], [true, z6]), _9 = ce(new _3(0.25).subtract(T4), new _3(0), new _3(1));
    return new Y(_9);
  }
  _getPatternColor(t11) {
    const { halfWidth: e9, normal: i8, color: s9, accumulatedDistance: o13, patternSize: a6, sampleAlphaOnly: r7, tlbr: l7 } = t11, n14 = a6.y.multiply(new _3(2).multiply(e9).divide(a6.x)), y6 = Ee(o13.divide(n14)), h11 = new _3(0.5).multiply(i8.y).add(new _3(0.5)), f12 = _e(l7.xy, l7.zw, new C3(h11, y6));
    let w10 = pn(this.mosaicInfo.texture, f12);
    return null != this.visualVariableColor && (w10 = zt(Yt(r7, new _3(0.5)), new Y(s9.a), s9)), w10;
  }
  vertex(t11, e9) {
    const { segmentDirection: i8, tlbr: s9, bitset: o13 } = t11, a6 = L8(this, t11), r7 = t11.accumulatedDistance.divide(this.view.displayZoomFactor).add(pe(i8, a6.scaledOffset)), l7 = new C3(s9.z.subtract(s9.x), s9.w.subtract(s9.y)), n14 = s9.divide(this.mosaicInfo.size.xyxy), c8 = v2(o13, E2), m17 = v2(o13, q), d10 = zt(Yt(c8, new _3(0.5)), this._getDistanceRatio(t11, a6.scaledHalfWidth), new _3(1));
    return { ...a6, tlbr: n14, patternSize: l7, accumulatedDistance: r7, isSDF: c8, sampleAlphaOnly: m17, dashToPx: d10, offsetAlongLine: t11.offsetAlongLine, capType: t11.capType, ...this.maybeRunHittest(t11, e9, a6.halfWidth) };
  }
  fragment(t11) {
    const { color: e9, opacity: i8, isSDF: s9 } = t11, o13 = D5(t11, this.antialiasingControls.blur), a6 = zt(Yt(s9, new _3(0.5)), this._getSDFAlpha(t11), this._getPatternColor(t11)), r7 = e9.multiply(i8).multiply(o13).multiply(a6);
...
var p10 = class extends t9 {
  ...
  render(e9, t11) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e9, t11.target, f12.uniforms), ...h2(e9, t11.target), antialiasingControls: n8(p16), mosaicInfo: m17.textureManager.getMosaicInfo(a6, t11.textureKey) }, defines: { ...y(e9) }, optionalAttributes: f12.optionalAttributes, useComputeBuffer: f(e9) }), m17.setPipelineState(M(e9)), m17.submitDraw(e9, t11);
  }
};
...
function $2(t11, e9, i8, o13) {
  return e9.multiply(t11.x).add(i8.multiply(t11.y)).add(o13.multiply(t11.z));
}
function tt2(t11) {
...
var et2 = class extends B5 {
  ...
  vertex(t11, e9) {
    const i8 = tt2(t11.sizing.x), o13 = tt2(t11.sizing.y), s9 = tt2(t11.sizing.z), l7 = t11.placementAngle, r7 = v2(t11.bitset, o2.bitset.isSDF), y6 = v2(t11.bitset, o2.bitset.isMapAligned), h11 = v2(t11.bitset, o2.bitset.scaleSymbolsProportionally), c8 = h4(t11.bitset, o2.bitset.colorLocked), x8 = n6(this, t11.id), v8 = r5(this, t11.id, t11.color, c8).multiply(x8), f12 = this.view.displayViewScreenMat3.multiply(new X(t11.pos.xy, 1)), V4 = l3(this, t11.id, s9).divide(s9), w10 = i8.multiply(V4), S7 = t11.offset.xy.multiply(V4);
    let b10 = o13.multiply(h11.multiply(V4.subtract(1)).add(1));
    b10 = Ue(b10, qe(w10.subtract(0.99), new _3(0)));
    const g10 = qe(b10, new _3(1)), C8 = Ue(b10, new _3(1)), z6 = rt.fromRotation(l7.multiply(c2)), _9 = u3(this, t11.id), j7 = this._getViewRotationMatrix(y6).multiply(_9).multiply(z6).multiply(new X(S7.xy, 0)), U4 = this.clip(t11.id, t11.zoomRange), N = new Y(f12.xy.add(j7.xy), U4, 1), D7 = t11.textureUV.divide(this.mosaicInfo.size), F10 = t11.outlineColor.multiply(C8), k4 = v2(t11.bitset, o2.bitset.overrideOutlineColor), I7 = t11.sdfDecodeCoeff.multiply(w10);
  ...
  _getViewScreenMatrix(t11) {
    const e9 = this.view.viewMat3.multiply(this.view.tileMat3), i8 = this.view.tileMat3, o13 = new _3(1).subtract(t11);
    return e9.multiply(t11).add(i8.multiply(o13));
  }
  _getColor(t11, e9) {
  ...
  _getSDFColor(t11, e9) {
    const i8 = pn(this.mosaicInfo.texture, t11), o13 = new _3(0.5).subtract(B4(i8)).multiply(e9.distanceToPx).multiply(o3), s9 = ce(new _3(0.5).subtract(o13), new _3(0), new _3(1)), l7 = e9.color.multiply(s9);
    ...
    return new _3(1).subtract(m17.a).multiply(l7).add(m17);
  }
  _hittestSmallMarker(t11, e9, i8) {
    const { position: o13, distance: s9, smallSymbolDistance: l7 } = this.hittestRequest, r7 = s9.subtract(l7), { viewMat3: p16, tileMat3: n14 } = this.view, u13 = p16.multiply(n14).multiply(new X(i8.pos, 1)).xy, d10 = i8.size.multiply(0.5);
    return fe(u13, o13).subtract(d10).add(r7);
  }
  _hittestMarker(t11, e9, i8) {
    const { pos: o13, sizeCorrection: s9, isMapAligned: l7 } = i8, r7 = new X(t11.offset.multiply(s9), 0), p16 = new X(e9.offsetNextVertex1.multiply(s9), 0), n14 = new X(e9.offsetNextVertex2.multiply(s9), 0), { viewMat3: u13, tileMat3: d10 } = this.view, m17 = u13.multiply(d10).multiply(new X(o13, 1)), h11 = this._getViewScreenMatrix(l7).multiply(i8.vvRotationMat3).multiply(i8.placementMat3), c8 = m17.add(h11.multiply(r7)).xy, x8 = m17.add(h11.multiply(p16)).xy, v8 = m17.add(h11.multiply(n14)).xy, f12 = this.hittestRequest.position, V4 = this.hittestRequest.distance, w10 = P3(f12, c8, x8, v8);
    return zt(Yt(w10, V4), w10, this._hittestSamples(c8, x8, v8, t11, e9, i8));
  }
  _hittestSamples(t11, e9, i8, o13, s9, l7) {
    const { outlineSize: r7, isSDF: a6, distanceToPx: p16 } = l7, n14 = this.hittestRequest.position, d10 = this.hittestRequest.distance, y6 = h6(n14.add(new C3(xt(d10), xt(d10))), t11, e9, i8), h11 = h6(n14.add(new C3(0, xt(d10))), t11, e9, i8), c8 = h6(n14.add(new C3(d10, xt(d10))), t11, e9, i8), x8 = h6(n14.add(new C3(xt(d10), 0)), t11, e9, i8), v8 = h6(n14, t11, e9, i8), f12 = h6(n14.add(new C3(d10, 0)), t11, e9, i8), V4 = h6(n14.add(new C3(xt(d10), d10)), t11, e9, i8), w10 = h6(n14.add(new C3(0, d10)), t11, e9, i8), S7 = h6(n14.add(new C3(d10, d10)), t11, e9, i8), M5 = o13.textureUV.divide(this.mosaicInfo.size), z6 = s9.textureUVNextVertex1.divide(this.mosaicInfo.size), _9 = s9.textureUVNextVertex2.divide(this.mosaicInfo.size), j7 = { color: new Y(1), outlineColor: new Y(1), overrideOutlineColor: new _3(1), outlineSize: r7, distanceToPx: p16, isSDF: a6 };
    let R6 = new _3(0);
...
`;
    ...
    return i8 += this.vertexShader, s9 += this.fragmentShader, new a2(i8, s9, this.renamedLocationsMap, this.locationInfo, this._getUniformBindings(o13), this._transformFeedbackBindings);
  }
  _getUniformBindings(t11) {
    ...
    for (const o13 in t11) {
      const i8 = this.options[o13];
      if (t11[o13]) for (const t12 in i8) {
        const s9 = i8[t12];
...
var h8 = class extends t9 {
  ...
  render(e9, t11) {
    var _a, _b;
    const { painter: u13 } = e9, { instance: n14, target: h11 } = t11, m17 = this.shaders.geometry, l7 = n14.getInput(), f12 = l7.uniforms.numberOfFields, S7 = f(e9), V4 = h2(e9, h11), d10 = y(e9);
    m17.setNumberOfFields(f12), u13.setShader({ shader: m17, uniforms: { ...m2(e9, t11.target, l7.uniforms.shader), ...V4.storage, ...V4.view, hittestUniforms: V4.hittestRequest ? { hittestDist: (_a = V4.hittestRequest) == null ? void 0 : _a.distance, hittestPos: (_b = V4.hittestRequest) == null ? void 0 : _b.position } : null }, defines: { VV_SIZE_MIN_MAX_VALUE: !!l7.uniforms.shader.visualVariableSizeMinMaxValue, VV_SIZE_SCALE_STOPS: !!l7.uniforms.shader.visualVariableSizeScaleStops, VV_SIZE_FIELD_STOPS: !!l7.uniforms.shader.visualVariableSizeStops, VV_SIZE_UNIT_VALUE: !!l7.uniforms.shader.visualVariableSizeUnitValue, VV_OPACITY: !!l7.uniforms.shader.visualVariableOpacity, HITTEST: S7, highlight: V4.highlight ? 1 : 0, ...d10, numberOfFields: f12 }, optionalAttributes: {}, useComputeBuffer: S7 }), u13.setPipelineState(M(e9)), u13.submitDraw(e9, t11);
  }
};
...
function u9(e9) {
  return e9.map((e10) => a3(e10) ? i5(e10.clone()) : e10);
}
function a3(e9) {
...
function c4(e9, o13) {
  const [t11, ...l7] = o13, n14 = l7.pop(), u13 = l7[0].value, a6 = l7[l7.length - 1].value, i8 = (a6 - u13) / s7, c8 = [];
  for (let s9 = u13; s9 < a6; s9 += i8) {
    let t12 = 0;
    for (; s9 >= l7[t12].value; ) t12++;
    const n15 = l7[t12], u14 = o13[t12 - 1], a7 = s9 - u14.value, i9 = n15.value === u14.value ? 1 : a7 / (n15.value - u14.value);
    if ("color" === e9) {
      const e10 = l7[t12], r7 = o13[t12 - 1], n16 = e10.color.clone();
      n16.r = p12(r7.color.r, n16.r, i9), n16.g = p12(r7.color.g, n16.g, i9), n16.b = p12(r7.color.b, n16.b, i9), n16.a = p12(r7.color.a, n16.a, i9), c8.push({ value: s9, color: n16, label: e10.label });
    } else if ("size" === e9) {
      const e10 = l7[t12], n16 = o13[t12 - 1], u15 = o(e10.size), a8 = p12(o(n16.size), u15, i9);
      c8.push({ value: s9, size: a8, label: e10.label });
    } else {
      const e10 = l7[t12], r7 = p12(o13[t12 - 1].opacity, e10.opacity, i9);
...
function f8(e9) {
  ...
  for (; r7.length > s7; ) {
    ...
    for (let t12 = 1; t12 < r7.length; t12++) {
      const l7 = r7[t12 - 1], s9 = r7[t12], n14 = Math.abs(s9.value - l7.value);
...
function b6(e9, o13) {
  return o13.length <= l5 ? o13 : (n12().warn(`Found ${o13.length} Visual Variable stops, but MapView only supports ${l5}. Displayed stops will be simplified.`), o13.length > 2 * l5 ? c4(e9, o13) : f8(o13));
}
function g8() {
...
function p13(e9) {
  ...
  const a6 = e9.stops.sort((e10, a7) => e10.value - a7.value), i8 = n11(a6, 8), l7 = i8.map(({ value: e10 }) => e10), s9 = i8.map(({ color: e10 }) => t10(e10));
  return { values: l7, colors: s9 };
}
function v5(e9) {
  var _a;
  if (!((_a = e9.stops) == null ? void 0 : _a.length)) return null;
  const a6 = e9.stops.sort((e10, a7) => e10.value - a7.value), i8 = n11(a6, 8);
...
function f9(a6) {
  ...
  if (a6.stops.some((e9) => e9.useMaxValue || e9.useMinValue)) return (i9, s10) => {
    const r7 = i9.statisticsByLevel.get(s10.key.level), n14 = a6.stops.map((i10) => {
      var _a2, _b;
      return { value: i10.useMaxValue ? ((_a2 = r7 == null ? void 0 : r7.get(a6.field)) == null ? void 0 : _a2.maxValue) ?? 0 : i10.useMinValue ? ((_b = r7 == null ? void 0 : r7.get(a6.field)) == null ? void 0 : _b.minValue) ?? 0 : i10.value, size: i10.size ? u(i10.size) : D2 };
    }).sort((e9, a7) => e9.value - a7.value), u13 = n11(n14, 8);
    return { values: u13.map(({ value: e9 }) => e9), sizes: u13.map(({ size: e9 }) => e9) };
  };
  const i8 = a6.stops.sort((e9, a7) => e9.value - a7.value), s9 = n11(i8, 8);
...
function S5(e9, a6) {
  const i8 = a6.length;
  if (e9 < a6[0].value || 1 === i8) return a6[0].size;
  for (let l7 = 1; l7 < i8; l7++) if (e9 < a6[l7].value) {
    const i9 = (e9 - a6[l7 - 1].value) / (a6[l7].value - a6[l7 - 1].value);
    return a6[l7 - 1].size + i9 * (a6[l7].size - a6[l7 - 1].size);
  }
  return a6[i8 - 1].size;
}
function b7(a6) {
  const { minDataValue: i8, maxDataValue: l7, minSize: s9, maxSize: t11 } = a6;
  if ("object" == typeof s9 && "object" == typeof t11) return (a7, r7) => {
    const n14 = a7.state.scale, u13 = u(S5(n14, s9.stops)), o13 = u(S5(n14, t11.stops));
    return { minMaxValueAndSize: [i8, l7, u13, o13] };
  };
  if ("object" == typeof s9 || "object" == typeof t11) throw new Error("InternalError: Found a partial VisualVariableSizeMinMaxValue");
  return { minMaxValueAndSize: [i8, l7, u(s9), u(t11)] };
}
...
function x6(e9, a6 = c5, i8 = u10) {
  if (e9.visualVariableSizeMinMaxValue) return e9.visualVariableSizeMinMaxValue instanceof Function ? o10 : Math.max(e9.visualVariableSizeMinMaxValue.minMaxValueAndSize[3] * i8, a6);
  if (e9.visualVariableSizeScaleStops) {
    if (e9.visualVariableSizeScaleStops instanceof Function) return o10;
    const l7 = e9.visualVariableSizeScaleStops.sizes;
    return Math.max(l7[l7.length - 1] * i8, a6);
  }
  if (e9.visualVariableSizeStops) {
    if (e9.visualVariableSizeStops instanceof Function) return o10;
    const l7 = e9.visualVariableSizeStops.sizes;
    return Math.max(l7[l7.length - 1] * i8, a6);
  }
...
function h9(e9) {
  ...
  for (const i8 of u9(e9.visualVariables)) switch (i8.type) {
    case "color":
      a6.visualVariableColor = p13(i8);
      break;
    case "opacity":
      a6.visualVariableOpacity = v5(i8);
      break;
    case "rotation":
      a6.visualVariableRotation = V2(i8);
      break;
    case "size":
      switch (M3(i8)) {
        case "field-stops":
          a6.visualVariableSizeStops = f9(i8);
          break;
        case "scale-stops":
          "outline" === i8.target ? a6.visualVariableSizeOutlineScaleStops = f9(i8) : a6.visualVariableSizeScaleStops = f9(i8);
          break;
        case "min-max":
          a6.visualVariableSizeMinMaxValue = b7(i8);
          break;
        case "unit-value":
          a6.visualVariableSizeUnitValue = m14(i8);
      }
      break;
  }
  return a6;
...
function s8(e9) {
  ...
  if (Array.isArray(e9)) {
    const [a6, i8, t11, l7] = e9;
    return [a6, i8, t11, 255 * l7];
  }
  return "string" == typeof e9 ? e9 : { ...e9, defaultValue: s8(e9 == null ? void 0 : e9.defaultValue) };
}
async function c6(a6, i8) {
  const { cimResourceManager: t11, cimAnalyzer: l7, scaleExpression: r7 } = i8.schemaOptions;
  await Promise.all(te.fetchResources(a6.symbol, t11, []));
  const o13 = l7.analyzeSymbolReference(a6, false), s9 = { scaleInfo: n13(a6), scaleExpression: r7 }, c8 = [];
  for (const e9 of o13) switch (e9.type) {
    case "marker":
      c8.push(...f10(e9, i8, s9));
      break;
    case "fill":
      c8.push(...b8(e9, i8, s9));
      break;
...
function f10(e9, a6, i8) {
  ...
  if (e9.animationParams) {
    return u11(n14.ensureInstance(j6.animatedMarker, { uniforms: s9, optionalAttributes: { zoomRange: true } }), e9, z4, i8);
  }
  return p14(n14.ensureInstance(j6.marker, { uniforms: s9, optionalAttributes: { zoomRange: !!i8.scaleInfo } }), e9, r7, i8);
}
function u11(e9, a6, t11, l7) {
  if (!a6.animationParams) return [];
  return [e9.createMeshInfo({ pixelDimensions: a6.pixelDimensions, texelDimensions: a6.texelDimensions, effects: a6.effects ? { type: "cim-effect-infos", effectInfos: a6.effects } : null, sprite: a6.spriteRasterizationParam, animations: a6.animationParams, scaleInfo: l7.scaleInfo, scaleSymbolsProportionally: a6.scaleSymbolsProportionally, strokeWidth: a6.outlineWidth, isMapAligned: a6.alignment === i.MAP, colorLocked: a6.colorLocked, isStroke: a6.isStroke, baseSize: a6.baseSize, referenceSize: a6.referenceSize, angleToLine: !!a6.markerPlacement && (a6.markerPlacement.placement && "angleToLine" in a6.markerPlacement.placement && a6.markerPlacement.placement.angleToLine), sizeRatio: a6.sizeRatio })];
}
function p14(e9, i8, t11, { scaleInfo: l7, scaleExpression: n14 }) {
  const c8 = a4(t11);
  return [e9.createMeshInfo({ size: i8.size, scaleX: i8.scaleX, anchorX: i8.anchorPoint.x, anchorY: i8.anchorPoint.y, angle: i8.rotation, color: s8(i8.color) ?? [0, 0, 0, 0], colorLocked: i8.colorLocked, frameHeight: i8.frameHeight, widthRatio: i8.widthRatio, scaleInfo: l7, offsetX: i8.offsetX, offsetY: i8.offsetY, outlineColor: s8(i8.outlineColor) ?? [0, 0, 0, 0], outlineSize: i8.outlineWidth, referenceSize: i8.referenceSize || n2.CIMVectorMarker.size, rotateClockwise: i8.rotateClockwise, scaleFactor: n14 ?? 1, sizeRatio: i8.sizeRatio, alignment: i8.alignment, isAbsoluteAnchorPoint: i8.isAbsoluteAnchorPoint, scaleSymbolsProportionally: i8.scaleSymbolsProportionally, sprite: i8.spriteRasterizationParam, hasSizeVV: c8, placement: i8.markerPlacement, effects: i8.effects ? { type: "cim-effect-infos", effectInfos: i8.effects } : null, transforms: i8.transform, minPixelBuffer: x6(t11) })];
}
function m15(e9, a6, i8) {
  const { uniforms: l7, schemaOptions: r7 } = a6, { store: o13 } = r7;
  return S6(o13.ensureInstance(j6.fill, { uniforms: { visualVariableColor: e9.colorLocked ? null : l7.visualVariableColor, visualVariableOpacity: l7.visualVariableOpacity }, optionalAttributes: { zoomRange: !!i8.scaleInfo } }), e9, i8);
}
function S6(e9, a6, { scaleInfo: i8 }) {
  return [e9.createMeshInfo({ color: s8(a6.color) ?? [0, 0, 0, 0], scaleInfo: i8, effects: a6.effects ? { type: "cim-effect-infos", effectInfos: a6.effects } : null })];
}
function b8(e9, a6, i8) {
  if (!e9.spriteRasterizationParam) return m15(e9, a6, i8);
  const { uniforms: l7, schemaOptions: r7 } = a6, { store: o13 } = r7;
  return V3(o13.ensureInstance(j6.complexFill, { uniforms: { visualVariableColor: e9.colorLocked ? null : l7.visualVariableColor, visualVariableOpacity: l7.visualVariableOpacity }, optionalAttributes: { zoomRange: !!i8.scaleInfo } }), e9, null != l7.visualVariableColor, i8);
}
function V3(e9, a6, i8, { scaleInfo: t11 }) {
  if (!a6.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const l7 = !!a6.hasUnresolvedReplacementColor && (!i8 || a6.colorLocked), r7 = a6.sampleAlphaOnly && !l7, o13 = a6.spriteRasterizationParam;
...
function z5(e9, a6, i8) {
  const { uniforms: l7, schemaOptions: r7 } = a6, { store: o13 } = r7;
  return h10(o13.ensureInstance(j6.gradientFill, { uniforms: { visualVariableColor: null, visualVariableOpacity: l7.visualVariableOpacity }, optionalAttributes: { zoomRange: !!i8.scaleInfo } }), e9, i8);
}
function h10(e9, a6, { scaleInfo: i8 }) {
  if (!a6.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const t11 = a6.spriteRasterizationParam;
  return [e9.createMeshInfo({ color: s8(a6.color) ?? [0, 0, 0, 0], angle: a6.angle, gradientMethod: a6.gradientMethod, gradientSize: a6.gradientSize, gradientSizeUnits: a6.gradientSizeUnits, gradientType: a6.gradientType, sprite: t11, scaleInfo: i8, effects: a6.effects ? { type: "cim-effect-infos", effectInfos: a6.effects } : null })];
}
function d8(e9, a6, i8) {
  const { uniforms: r7, schemaOptions: o13 } = a6, { store: n14 } = o13, s9 = e9.isOutline ? { ...z4, visualVariableSizeScaleStops: r7.visualVariableSizeOutlineScaleStops } : { visualVariableColor: e9.colorLocked ? null : r7.visualVariableColor, visualVariableOpacity: r7.visualVariableOpacity, visualVariableSizeMinMaxValue: r7.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: r7.visualVariableSizeScaleStops, visualVariableSizeStops: r7.visualVariableSizeStops, visualVariableSizeUnitValue: r7.visualVariableSizeUnitValue }, c8 = { uniforms: s9, optionalAttributes: { zoomRange: !!i8.scaleInfo } }, f12 = !!(s9.visualVariableSizeMinMaxValue || s9.visualVariableSizeScaleStops || s9.visualVariableSizeStops || s9.visualVariableSizeUnitValue);
  if (!e9.spriteRasterizationParam) {
    return y4(n14.ensureInstance(j6.line, c8), e9, f12, i8);
  }
  return g9(n14.ensureInstance(j6.texturedLine, c8), e9, f12, i8);
}
function v6(e9, a6, { scaleInfo: i8 }) {
  return { color: s8(e9.color) ?? [0, 0, 0, 0], width: e9.width, referenceWidth: e9.referenceWidth, capType: e9.cap, joinType: e9.join, miterLimit: e9.miterLimit, scaleInfo: i8, hasSizeVV: a6, effects: e9.effects ? { type: "cim-effect-infos", effectInfos: e9.effects } : null };
}
function y4(e9, a6, i8, t11) {
  if (a6.spriteRasterizationParam) throw new Error("InternalError: Sprite should not be defined");
  const l7 = v6(a6, i8, t11);
  return [e9.createMeshInfo(l7)];
}
function g9(e9, a6, i8, t11) {
  const { spriteRasterizationParam: l7, scaleDash: r7, sampleAlphaOnly: o13 } = a6;
  if (!l7) throw new Error("InternalError: Sprite should be defined");
  return [e9.createMeshInfo({ ...v6(a6, i8, t11), offsetAlongLine: a6.offsetAlongLine ?? 0, shouldScaleDash: r7 ?? false, shouldSampleAlphaOnly: o13, isSDF: "CIMPictureStroke" !== l7.resource.type && "CIMGradientStroke" !== l7.resource.type, sprite: l7 })];
}
function I6(e9, a6, i8) {
  const { uniforms: r7, schemaOptions: o13 } = a6, { store: n14 } = o13;
  return M4(n14.ensureInstance(j6.gradientStroke, { uniforms: e9.isOutline ? { ...z4, visualVariableSizeScaleStops: r7.visualVariableSizeOutlineScaleStops } : { visualVariableColor: null, visualVariableOpacity: r7.visualVariableOpacity, visualVariableSizeMinMaxValue: r7.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: r7.visualVariableSizeScaleStops, visualVariableSizeStops: r7.visualVariableSizeStops, visualVariableSizeUnitValue: r7.visualVariableSizeUnitValue }, optionalAttributes: { zoomRange: !!i8.scaleInfo } }), e9, i8);
}
function M4(e9, a6, i8) {
  if (!a6.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const t11 = a6.spriteRasterizationParam;
  return [e9.createMeshInfo({ ...v6(a6, false, i8), gradientMethod: a6.gradientMethod, gradientSize: a6.gradientSize, gradientSizeUnits: a6.gradientSizeUnits, gradientType: a6.gradientType, sprite: t11, effects: a6.effects ? { type: "cim-effect-infos", effectInfos: a6.effects } : null })];
}
function R5(e9, a6, i8) {
  const { uniforms: l7, schemaOptions: r7 } = a6, { store: o13 } = r7;
  return P7(o13.ensureInstance(j6.text, { uniforms: { visualVariableColor: e9.colorLocked ? null : l7.visualVariableColor, visualVariableOpacity: l7.visualVariableOpacity, visualVariableRotation: l7.visualVariableRotation, visualVariableSizeMinMaxValue: l7.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: l7.visualVariableSizeScaleStops, visualVariableSizeStops: l7.visualVariableSizeStops, visualVariableSizeUnitValue: l7.visualVariableSizeUnitValue }, optionalAttributes: { zoomRange: !!i8.scaleInfo, referenceSymbol: false, clipAngle: false } }), e9, l7, i8);
}
function P7(e9, a6, i8, { scaleInfo: t11, scaleExpression: l7 }) {
  return [e9.createMeshInfo({ boxBackgroundColor: s8(a6.backgroundColor), boxBorderLineColor: s8(a6.borderLineColor), boxBorderLineSize: a6.borderLineWidth ?? 0, color: s8(a6.color) ?? [0, 0, 0, 0], offsetX: a6.offsetX, offsetY: a6.offsetY, postAngle: a6.angle, fontSize: a6.size, referenceSize: a6.referenceSize, decoration: a6.decoration, haloColor: s8(a6.haloColor) ?? [0, 0, 0, 0], haloSize: a6.haloSize ?? 0, outlineColor: s8(a6.outlineColor) ?? [0, 0, 0, 0], outlineSize: a6.outlineSize, lineWidth: a6.lineWidth || 512, lineHeightRatio: 1, horizontalAlignment: a6.horizontalAlignment ?? "center", verticalAlignment: a6.verticalAlignment ?? "baseline", useCIMAngleBehavior: false, glyphs: a6.textRasterizationParam, scaleInfo: t11, effects: a6.effects ? { type: "cim-effect-infos", effectInfos: a6.effects } : null, placement: a6.markerPlacement, transforms: a6.transform, scaleFactor: l7 ?? 1, minPixelBuffer: x6(i8), repeatLabel: null, repeatLabelDistance: null, allowOverrun: null, labelPosition: null })];
}
...
function a5(e9, i8) {
  return { type: "simple", filters: i8, capabilities: { maxTextureSize: t5().maxTextureSize }, bindings: u12(e9) };
}
function o12(e9, n14) {
  const t11 = t5();
...
function c7(e9) {
  const i8 = [];
  for (const r7 of e9.attributes) i8.push({ binding: i8.length, expression: r7.valueExpression, field: r7.field });
  return i8;
}
function p15(e9) {
  const i8 = d9(e9);
  let r7 = 4;
  for (const n14 of e9.attributes) i8.push({ binding: r7++, expression: n14.valueExpression, field: n14.field });
  return i8;
}
function f11({ valueExpression: e9, field: i8 }) {
  return e9 || i8 ? [{ binding: 0, expression: e9, field: i8 }] : [];
}
function d9(i8) {
  var _a;
  if (!("visualVariables" in i8) || !((_a = i8.visualVariables) == null ? void 0 : _a.length)) return [];
  return u9(i8.visualVariables).map((e9) => y5(e9)).filter(G);
}
function m16(e9) {
  return "$view.scale" === e9.valueExpression ? null : { binding: l6(e9.type), field: e9.field, normalizationField: e9.normalizationField, expression: e9.valueExpression, valueRepresentation: e9.valueRepresentation };
}
function b9(e9) {
  return { binding: l6(e9.type), field: e9.field, normalizationField: e9.normalizationField, expression: e9.valueExpression };
}
function x7(e9) {
  return { binding: l6(e9.type), field: e9.field, normalizationField: e9.normalizationField, expression: e9.valueExpression };
}
function v7(e9) {
  return { binding: l6(e9.type), expression: e9.valueExpression, field: e9.field };
}
function y5(e9) {
  switch (e9.type) {
    case "size":
...
//# sourceMappingURL=chunk-UC6VC22C.js.map
